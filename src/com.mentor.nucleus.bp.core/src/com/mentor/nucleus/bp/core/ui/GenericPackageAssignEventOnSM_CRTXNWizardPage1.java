...
//====================================================================
//
// File:    GenericPackageAssignEventOnSM_CRTXNWizardPage1.java
//
...
public class GenericPackageAssignEventOnSM_CRTXNWizardPage1
		extends
	...
	/**
	 * Constructors for GenericPackageAssignEventOnSM_CRTXNWizardPage1.
	 */
	public GenericPackageAssignEventOnSM_CRTXNWizardPage1() {
		super("");
		init();
	}

	public GenericPackageAssignEventOnSM_CRTXNWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((GenericPackageAssignEventOnSM_CRTXNWizard) getWizard())
						.getSelection());

		// cache for context
		CreationTransition_c v_ctxn = ((GenericPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_ctxn;
		...
		for (eventInstCount = 0; eventInstCount < v_eventInstances.length; eventInstCount++) {
			...
			if (User_c.Selectone(selected.getSmevt_id())
					&& v_stateMachine.Canassignevent(selected.getSmevt_id(),
							selected.getSm_id(), true)
					&& v_dest_state.Notalreadyassigned(true,
	...
	public void updateSelectedEvent() {
		...
		((GenericPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_event = this.Event;
	}
	...
	public IWizardPage getNextPage() {
		((GenericPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_event = Event;
