...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnC_ASAction.java
//
...
public class MoveDownOnC_ASAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnC_ASAction.
	 */
	public MoveDownOnC_ASAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_AS_MoveDown(structuredSelection);
	...
	private void C_AS_MoveDown(IStructuredSelection selection) {
		...
		InterfaceSignal_c v_item = (InterfaceSignal_c) context;
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Signal Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Interface Signal Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnC_ASAction
