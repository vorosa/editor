...
//====================================================================
//
// File:    PackageFunctionFormalizeOnMSG_SMWizardPage3.java
//
...
public class PackageFunctionFormalizeOnMSG_SMWizardPage3 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for PackageFunctionFormalizeOnMSG_SMWizardPage3.
	 */
	public PackageFunctionFormalizeOnMSG_SMWizardPage3() {
		super("");
		init();
	}

	public PackageFunctionFormalizeOnMSG_SMWizardPage3(String name) {
		super(name);
		init();
	}
	...
	public void updateSelectedMessage() {
		...
		((PackageFunctionFormalizeOnMSG_SMWizard) getWizard()).v_Message = this.Message;
	}
	...
	public IWizardPage getNextPage() {
		((PackageFunctionFormalizeOnMSG_SMWizard) getWizard()).v_Message = Message;
