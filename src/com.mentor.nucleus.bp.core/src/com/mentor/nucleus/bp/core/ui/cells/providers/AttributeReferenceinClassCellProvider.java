//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/AttributeReferenceinClassCellProvider.java
//
...
public class AttributeReferenceinClassCellProvider implements ICellProvider {

    
	@Override
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Is_Cstrd")) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Is_Cstrd"))
        {
            ...
            if ( new_val != ((AttributeReferenceInClass_c) element).getIs_cstrd() )
            {
                ((AttributeReferenceInClass_c) element).setIs_cstrd(new_val);
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((AttributeReferenceInClass_c) element).getDescrip()) )
            {
                ((AttributeReferenceInClass_c) element).setDescrip(value.toString());
            }
        }
