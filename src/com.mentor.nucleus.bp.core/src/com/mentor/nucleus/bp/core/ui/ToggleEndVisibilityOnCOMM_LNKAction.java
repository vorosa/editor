...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ToggleEndVisibilityOnCOMM_LNKAction.java
//
...
// creates new Toggle End Visibilitys.
//
...
public class ToggleEndVisibilityOnCOMM_LNKAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ToggleEndVisibilityOnCOMM_LNKAction.
	 */
	public ToggleEndVisibilityOnCOMM_LNKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		COMM_LNK_ToggleEndVisibility(structuredSelection);
	...
	private void COMM_LNK_ToggleEndVisibility(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Communication Link Toggle End Visibility");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			CommunicationLink_c v_link = null;
			for (int i9650 = 0; i9650 < v_links.length; i9650++) {
				v_link = v_links[i9650];

				if (v_link != null) {
					v_link.Togglevisibility(End_c.End);
				} else {
			...
			CorePlugin
					.logError(
							"Transaction: Communication Link Toggle End Visibility failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end ToggleEndVisibilityOnCOMM_LNKAction
