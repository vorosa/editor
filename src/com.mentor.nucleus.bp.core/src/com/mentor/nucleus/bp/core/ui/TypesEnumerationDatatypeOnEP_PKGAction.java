...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/TypesEnumerationDatatypeOnEP_PKGAction.java
//
...
// creates new Enumeration DataTypes.
//
...
public class TypesEnumerationDatatypeOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for TypesEnumerationDatatypeOnEP_PKGAction.
	 */
	public TypesEnumerationDatatypeOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_TypesEnumerationDatatype(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"EnumerationDataType_c", false));
	}
	private void EP_PKG_TypesEnumerationDatatype(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Types Enumeration DataType");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newenumeration();
			} else {
			...
			NonRootModelElement[] children = EnumerationDataType_c
			...
			CorePlugin.logError(
					"Transaction: Types Enumeration DataType failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end TypesEnumerationDatatypeOnEP_PKGAction
