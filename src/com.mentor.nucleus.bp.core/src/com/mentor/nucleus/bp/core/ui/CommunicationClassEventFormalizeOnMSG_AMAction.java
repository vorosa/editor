...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationClassEventFormalizeOnMSG_AMAction.java
//
...
public class CommunicationClassEventFormalizeOnMSG_AMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationClassEventFormalizeOnMSG_AMAction.
	 */
	public CommunicationClassEventFormalizeOnMSG_AMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_AM_CommunicationClassEventFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_AM_CommunicationClassEventFormalize(
			IStructuredSelection selection) {
		CommunicationClassEventFormalizeOnMSG_AMWizard wizard = new CommunicationClassEventFormalizeOnMSG_AMWizard();
...
} // end CommunicationClassEventFormalizeOnMSG_AMAction
