...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakeProtectedOnCNST_CSPAction.java
//
...
public class MakeProtectedOnCNST_CSPAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakeProtectedOnCNST_CSPAction.
	 */
	public MakeProtectedOnCNST_CSPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CNST_CSP_MakeProtected(structuredSelection);
	...
	private void CNST_CSP_MakeProtected(IStructuredSelection selection) {
		...
		ConstantSpecification_c v_const = (ConstantSpecification_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_const
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Constant Specification Make Protected");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			PackageableElement_c v_pe = PackageableElement_c
					.getOnePE_PEOnR8001(v_const);
			...
			CorePlugin
					.logError(
							"Transaction: Constant Specification Make Protected failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakeProtectedOnCNST_CSPAction
