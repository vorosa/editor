...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewOperationOnC_IAction.java
//
...
public class NewOperationOnC_IAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewOperationOnC_IAction.
	 */
	public NewOperationOnC_IAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_I_NewOperation(structuredSelection);
	...
	private void C_I_NewOperation(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Operation");
		...
		try {
			...
			if (((v_interface != null))) {
				...
				java.util.UUID v_discardUuid = v_interface
						.Newexecutableproperty(false);

			}

			NonRootModelElement[] children = InterfaceOperation_c
			...
			CorePlugin.logError("Transaction: New Operation failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
