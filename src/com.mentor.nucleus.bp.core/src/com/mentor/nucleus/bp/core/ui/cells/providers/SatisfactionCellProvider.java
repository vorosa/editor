//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SatisfactionCellProvider.java
//
...
public class SatisfactionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Satisfaction_c) element).getDescrip()) )
            {
                ((Satisfaction_c) element).setDescrip(value.toString());
            }
        }
