...
//====================================================================
//
// File:    SpecializedPackageAssignEventOnSM_TXNWizard.java
//
...
/**
 * SpecializedPackageAssignEventOnSM_TXNWizard class
 */
public class SpecializedPackageAssignEventOnSM_TXNWizard extends Wizard {
	...
	// wizard pages
	SpecializedPackageAssignEventOnSM_TXNWizardPage1 SM_TXN_SpecializedPackageAssignEventPage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_TXN_SPECIALIZEDPACKAGEASSIGNEVENT0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for SpecializedPackageAssignEventOnSM_TXNWizard.
	 */
	public SpecializedPackageAssignEventOnSM_TXNWizard() {
		super();
	}
	...
	public void addPages() {
		SM_TXN_SpecializedPackageAssignEventPage1 = new SpecializedPackageAssignEventOnSM_TXNWizardPage1(
				"SpecializedPackageAssignEventOnSM_TXNWizardPage1");
		addPage(SM_TXN_SpecializedPackageAssignEventPage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_TXN_SpecializedPackageAssignEventPage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_TXN_SPECIALIZEDPACKAGEASSIGNEVENT0_WIZARD_STATE :
				return null;
		}
		return null;
	}
