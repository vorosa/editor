//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActivityPartitionCellProvider.java
//
...
public class ActivityPartitionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ActivityPartition_c) element).getName()) )
            {
                ((ActivityPartition_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ActivityPartition_c) element).getDescrip()) )
            {
                ((ActivityPartition_c) element).setDescrip(value.toString());
            }
        }
