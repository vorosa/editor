//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActivityCellProvider.java
//
...
public class ActivityCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Activity_c) element).getName()) )
            {
                ((Activity_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Activity_c) element).getDescrip()) )
            {
                ((Activity_c) element).setDescrip(value.toString());
            }
        }
