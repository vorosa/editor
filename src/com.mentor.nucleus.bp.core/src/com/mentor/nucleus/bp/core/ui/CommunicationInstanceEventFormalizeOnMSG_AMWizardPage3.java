...
//====================================================================
//
// File:    CommunicationInstanceEventFormalizeOnMSG_AMWizardPage3.java
//
...
public class CommunicationInstanceEventFormalizeOnMSG_AMWizardPage3
		extends
	...
	/**
	 * Constructors for CommunicationInstanceEventFormalizeOnMSG_AMWizardPage3.
	 */
	public CommunicationInstanceEventFormalizeOnMSG_AMWizardPage3() {
		super("");
		init();
	}

	public CommunicationInstanceEventFormalizeOnMSG_AMWizardPage3(String name) {
		super(name);
		init();
	}
