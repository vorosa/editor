...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationInstanceOperationFormalizeOnMSG_SMAction.java
//
...
public class CommunicationInstanceOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationInstanceOperationFormalizeOnMSG_SMAction.
	 */
	public CommunicationInstanceOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationInstanceOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationInstanceOperationFormalize(
			IStructuredSelection selection) {
		CommunicationInstanceOperationFormalizeOnMSG_SMWizard wizard = new CommunicationInstanceOperationFormalizeOnMSG_SMWizard();
...
} // end CommunicationInstanceOperationFormalizeOnMSG_SMAction
