...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ActivitySendSignalActionOnEP_PKGAction.java
//
...
// creates new Send Signal Actions.
//
...
public class ActivitySendSignalActionOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ActivitySendSignalActionOnEP_PKGAction.
	 */
	public ActivitySendSignalActionOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ActivitySendSignalAction(structuredSelection);
	...
	private void EP_PKG_ActivitySendSignalAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Activity Send Signal Action");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newsendsignalaction();
			} else {
			...
			NonRootModelElement[] children = SendSignal_c
			...
			CorePlugin.logError(
					"Transaction: Activity Send Signal Action failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ActivitySendSignalActionOnEP_PKGAction
