...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnS_MBRAction.java
//
...
public class SetTypeOnS_MBRAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnS_MBRAction.
	 */
	public SetTypeOnS_MBRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_MBR_SetType(structuredSelection);
	}
	/**
	...
	public static void S_MBR_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      StructureMember_c v_element = (StructureMember_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR45(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(DataType_c.getOneS_DTOnR17(StructuredDataType_c.getOneS_SDTOnR44(v_element)));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (StructureMember_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR45(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR45From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR45To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(StructureMember_c v_element) {
  ...
  } // end getElements(StructureMember_c) 
} // end SetTypeOnS_MBRAction
