...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnCNST_CSPAction.java
//
...
public class MakePublicOnCNST_CSPAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnCNST_CSPAction.
	 */
	public MakePublicOnCNST_CSPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CNST_CSP_MakePublic(structuredSelection);
	...
	private void CNST_CSP_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Constant Specification Make Public");
		try {
			...
			CorePlugin
					.logError(
							"Transaction: Constant Specification Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnCNST_CSPAction
