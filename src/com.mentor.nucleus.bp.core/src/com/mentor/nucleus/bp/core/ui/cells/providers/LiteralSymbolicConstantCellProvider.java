//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/LiteralSymbolicConstantCellProvider.java
//
...
public class LiteralSymbolicConstantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Value"))
        {
            if ( ! value.toString().equals(((LiteralSymbolicConstant_c) element).getValue()) )
            {
                ((LiteralSymbolicConstant_c) element).setValue(value.toString());
            }
        }
