...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/RemoveSignalOnSM_TXNAction.java
//
...
public class RemoveSignalOnSM_TXNAction implements IObjectActionDelegate {

	/**
	 * Constructor for RemoveSignalOnSM_TXNAction.
	 */
	public RemoveSignalOnSM_TXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_TXN_RemoveSignal(structuredSelection);
	...
	private void SM_TXN_RemoveSignal(IStructuredSelection selection) {
		...
		Transition_c v_txn = (Transition_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_txn
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Transition Remove Signal");
		try {
			...
			CorePlugin.logError(
					"Transaction: Transition Remove Signal failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end RemoveSignalOnSM_TXNAction
