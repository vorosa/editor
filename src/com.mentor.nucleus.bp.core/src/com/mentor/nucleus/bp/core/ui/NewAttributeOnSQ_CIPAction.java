...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewAttributeOnSQ_CIPAction.java
//
...
public class NewAttributeOnSQ_CIPAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewAttributeOnSQ_CIPAction.
	 */
	public NewAttributeOnSQ_CIPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_CIP_NewAttribute(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"InstanceAttributeValue_c", false));
	}
	private void SQ_CIP_NewAttribute(IStructuredSelection selection) {
		...
		try {
			...
			if (((v_cip != null))) {
				...
				if (v_cip != null) {
					v_cip.Newinstanceattributevalue();
				} else {
			...
			NonRootModelElement[] children = InstanceAttributeValue_c
					.getManySQ_AVsOnR936(v_cip)
...
} // end NewAttributeOnSQ_CIPAction
