...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/RemoveEventOnSM_TXNAction.java
//
...
public class RemoveEventOnSM_TXNAction implements IObjectActionDelegate {

	/**
	 * Constructor for RemoveEventOnSM_TXNAction.
	 */
	public RemoveEventOnSM_TXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_TXN_RemoveEvent(structuredSelection);
	...
	private void SM_TXN_RemoveEvent(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Transition Remove Event");
		try {
			...
			CorePlugin.logError(
					"Transaction: Transition Remove Event failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end RemoveEventOnSM_TXNAction
