//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/TimeSpanCellProvider.java
//
...
public class TimeSpanCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((TimeSpan_c) element).getName()) )
            {
                ((TimeSpan_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((TimeSpan_c) element).getDescrip()) )
            {
                ((TimeSpan_c) element).setDescrip(value.toString());
            }
        }
