//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/CoreDataTypeCellProvider.java
//
...
public class CoreDataTypeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Core_Typ"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((CoreDataType_c) element).getCore_typ() )
            {
                ((CoreDataType_c) element).setCore_typ(new_val);
            }
        }
