...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewStructuredDatatypeOnS_DPKAction.java
//
...
// creates new Structured DataTypes.
//
...
public class NewStructuredDatatypeOnS_DPKAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewStructuredDatatypeOnS_DPKAction.
	 */
	public NewStructuredDatatypeOnS_DPKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_DPK_NewStructuredDatatype(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"StructuredDataType_c", false));
	}
	private void S_DPK_NewStructuredDatatype(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Structured DataType");
		try {
			...
			CorePlugin.logError(
					"Transaction: New Structured DataType failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewStructuredDatatypeOnS_DPKAction
