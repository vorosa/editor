...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ClassUnformalizeOnSQ_CPAction.java
//
...
public class ClassUnformalizeOnSQ_CPAction implements IObjectActionDelegate {

	/**
	 * Constructor for ClassUnformalizeOnSQ_CPAction.
	 */
	public ClassUnformalizeOnSQ_CPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_CP_ClassUnformalize(structuredSelection);
	...
	private void SQ_CP_ClassUnformalize(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Class Unformalize");
		try {
			...
			CorePlugin.logError("Transaction: Class Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end ClassUnformalizeOnSQ_CPAction
