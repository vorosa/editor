//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ComponentParticipantCellProvider.java
//
...
public class ComponentParticipantCellProvider implements ICellProvider {

    
	@Override
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("InformalComponentName")) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("InformalComponentName"))
        {
            if ( ! value.toString().equals(((ComponentParticipant_c) element).getInformalcomponentname()) )
            {
                ((ComponentParticipant_c) element).setInformalcomponentname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ComponentParticipant_c) element).getDescrip()) )
            {
                ((ComponentParticipant_c) element).setDescrip(value.toString());
            }
        }
