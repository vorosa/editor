//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/FunctionPackageParticipantCellProvider.java
//
...
public class FunctionPackageParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((FunctionPackageParticipant_c) element).getInformalname()) )
            {
                ((FunctionPackageParticipant_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((FunctionPackageParticipant_c) element).getDescrip()) )
            {
                ((FunctionPackageParticipant_c) element).setDescrip(value.toString());
            }
        }
