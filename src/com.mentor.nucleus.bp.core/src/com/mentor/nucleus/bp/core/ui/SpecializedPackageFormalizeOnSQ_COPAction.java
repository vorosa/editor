...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageFormalizeOnSQ_COPAction.java
//
...
public class SpecializedPackageFormalizeOnSQ_COPAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageFormalizeOnSQ_COPAction.
	 */
	public SpecializedPackageFormalizeOnSQ_COPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SQ_COP_SpecializedPackageFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog SQ_COP_SpecializedPackageFormalize(
			IStructuredSelection selection) {
		SpecializedPackageFormalizeOnSQ_COPWizard wizard = new SpecializedPackageFormalizeOnSQ_COPWizard();
...
} // end SpecializedPackageFormalizeOnSQ_COPAction
