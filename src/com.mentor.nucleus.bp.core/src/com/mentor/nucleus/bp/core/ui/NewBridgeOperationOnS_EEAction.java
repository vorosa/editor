...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewBridgeOperationOnS_EEAction.java
//
...
public class NewBridgeOperationOnS_EEAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewBridgeOperationOnS_EEAction.
	 */
	public NewBridgeOperationOnS_EEAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_EE_NewBridgeOperation(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor("Bridge_c",
				false));
	}
	private void S_EE_NewBridgeOperation(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Bridge Operation");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_ee != null) {
				v_ee.Newbridgeoperation();
			} else {
			...
			NonRootModelElement[] children = Bridge_c.getManyS_BRGsOnR19(v_ee)
			...
			CorePlugin.logError("Transaction: New Bridge Operation failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end NewBridgeOperationOnS_EEAction
