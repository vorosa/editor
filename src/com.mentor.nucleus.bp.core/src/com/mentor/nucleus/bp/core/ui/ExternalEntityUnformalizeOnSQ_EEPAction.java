...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ExternalEntityUnformalizeOnSQ_EEPAction.java
//
...
public class ExternalEntityUnformalizeOnSQ_EEPAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ExternalEntityUnformalizeOnSQ_EEPAction.
	 */
	public ExternalEntityUnformalizeOnSQ_EEPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_EEP_ExternalEntityUnformalize(structuredSelection);
	...
	private void SQ_EEP_ExternalEntityUnformalize(IStructuredSelection selection) {
		...
		ExternalEntityParticipant_c v_eep = (ExternalEntityParticipant_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_eep
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("External Entity Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: External Entity Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end ExternalEntityUnformalizeOnSQ_EEPAction
