...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewParameterOnSM_EVTAction.java
//
...
public class NewParameterOnSM_EVTAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewParameterOnSM_EVTAction.
	 */
	public NewParameterOnSM_EVTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_EVT_NewParameter(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"StateMachineEventDataItem_c", false));
	}
	private void SM_EVT_NewParameter(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Parameter");
		...
		try {
			...
			NonRootModelElement[] children = StateMachineEventDataItem_c
			...
			CorePlugin.logError("Transaction: New Parameter failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end NewParameterOnSM_EVTAction
