...
//====================================================================
//
// File:    ClassOperationFormalizeOnMSG_SMWizard.java
//
...
/**
 * ClassOperationFormalizeOnMSG_SMWizard class
 */
public class ClassOperationFormalizeOnMSG_SMWizard extends Wizard {
	...
	// wizard pages
	ClassOperationFormalizeOnMSG_SMWizardPage2 MSG_SM_ClassOperationFormalizePage2;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int MSG_SM_CLASSOPERATIONFORMALIZE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for ClassOperationFormalizeOnMSG_SMWizard.
	 */
	public ClassOperationFormalizeOnMSG_SMWizard() {
		super();
	}
	...
	public void addPages() {
		MSG_SM_ClassOperationFormalizePage2 = new ClassOperationFormalizeOnMSG_SMWizardPage2(
				"ClassOperationFormalizeOnMSG_SMWizardPage2");
		addPage(MSG_SM_ClassOperationFormalizePage2);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& MSG_SM_ClassOperationFormalizePage2.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case MSG_SM_CLASSOPERATIONFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Class Operation Formalize"); //$NON-NLS-1$
			...
			CorePlugin.logError(
					"Transaction: Class Operation Formalize failed", e);//$NON-NLS-1$
