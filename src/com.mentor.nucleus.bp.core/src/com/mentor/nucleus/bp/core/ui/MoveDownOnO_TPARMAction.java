...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnO_TPARMAction.java
//
...
public class MoveDownOnO_TPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnO_TPARMAction.
	 */
	public MoveDownOnO_TPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_TPARM_MoveDown(structuredSelection);
	...
	private void O_TPARM_MoveDown(IStructuredSelection selection) {
		...
		OperationParameter_c v_item = (OperationParameter_c) context;
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Operation Parameter Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Operation Parameter Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnO_TPARMAction
