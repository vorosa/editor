//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SubsystemCellProvider.java
//
...
public class SubsystemCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Subsystem_c) element).getName()) )
            {
                ((Subsystem_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Subsystem_c) element).getDescrip()) )
            {
                ((Subsystem_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Prefix"))
        {
            if ( ! value.toString().equals(((Subsystem_c) element).getPrefix()) )
            {
                ((Subsystem_c) element).setPrefix(value.toString());
            }
        }
        if(data.getName().equals("Num_Rng"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Subsystem_c) element).getNum_rng() )
            {
                ((Subsystem_c) element).setNum_rng(new_val);
            }
        }
