...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnS_ENUMAction.java
//
...
public class MoveDownOnS_ENUMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnS_ENUMAction.
	 */
	public MoveDownOnS_ENUMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_ENUM_MoveDown(structuredSelection);
	...
	private void S_ENUM_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Enumerator Move Down");
		try {
			...
			CorePlugin.logError("Transaction: Enumerator Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnS_ENUMAction
