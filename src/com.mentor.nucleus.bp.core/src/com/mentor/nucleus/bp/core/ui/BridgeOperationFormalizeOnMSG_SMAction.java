...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/BridgeOperationFormalizeOnMSG_SMAction.java
//
...
public class BridgeOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for BridgeOperationFormalizeOnMSG_SMAction.
	 */
	public BridgeOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_BridgeOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_BridgeOperationFormalize(
...
} // end BridgeOperationFormalizeOnMSG_SMAction
