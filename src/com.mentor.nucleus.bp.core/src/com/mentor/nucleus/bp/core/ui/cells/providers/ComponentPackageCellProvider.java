//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ComponentPackageCellProvider.java
//
...
public class ComponentPackageCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ComponentPackage_c) element).getName()) )
            {
                ((ComponentPackage_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ComponentPackage_c) element).getDescrip()) )
            {
                ((ComponentPackage_c) element).setDescrip(value.toString());
            }
        }
