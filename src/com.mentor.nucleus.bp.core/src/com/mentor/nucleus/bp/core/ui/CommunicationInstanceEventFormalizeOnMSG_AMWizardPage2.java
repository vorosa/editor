...
//====================================================================
//
// File:    CommunicationInstanceEventFormalizeOnMSG_AMWizardPage2.java
//
...
public class CommunicationInstanceEventFormalizeOnMSG_AMWizardPage2
		extends
	...
	/**
	 * Constructors for CommunicationInstanceEventFormalizeOnMSG_AMWizardPage2.
	 */
	public CommunicationInstanceEventFormalizeOnMSG_AMWizardPage2() {
		super("");
		init();
	}

	public CommunicationInstanceEventFormalizeOnMSG_AMWizardPage2(String name) {
		super(name);
		init();
	}
