...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ComponentsComponentOnEP_PKGAction.java
//
...
public class ComponentsComponentOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for ComponentsComponentOnEP_PKGAction.
	 */
	public ComponentsComponentOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ComponentsComponent(structuredSelection);
	...
	private void EP_PKG_ComponentsComponent(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Components Component");
		...
		try {
			...
			CorePlugin.logError("Transaction: Components Component failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ComponentsComponentOnEP_PKGAction
