...
//====================================================================
//
// File:    SpecializedPackageCantHappenInStateOnSM_EVTWizard.java
//
...
/**
 * SpecializedPackageCantHappenInStateOnSM_EVTWizard class
 */
public class SpecializedPackageCantHappenInStateOnSM_EVTWizard extends Wizard {
	...
	// wizard pages
	SpecializedPackageCantHappenInStateOnSM_EVTWizardPage1 SM_EVT_SpecializedPackageCantHappenInStatePage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_EVT_SPECIALIZEDPACKAGECANTHAPPENINSTATE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for SpecializedPackageCantHappenInStateOnSM_EVTWizard.
	 */
	public SpecializedPackageCantHappenInStateOnSM_EVTWizard() {
		super();
	}
	...
	public void addPages() {
		SM_EVT_SpecializedPackageCantHappenInStatePage1 = new SpecializedPackageCantHappenInStateOnSM_EVTWizardPage1(
				"SpecializedPackageCantHappenInStateOnSM_EVTWizardPage1");
		addPage(SM_EVT_SpecializedPackageCantHappenInStatePage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_EVT_SpecializedPackageCantHappenInStatePage1
						.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_EVT_SPECIALIZEDPACKAGECANTHAPPENINSTATE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Specialized Package Cant Happen in State"); //$NON-NLS-1$
			...
			CorePlugin
					.logError(
							"Transaction: Specialized Package Cant Happen in State failed", e);//$NON-NLS-1$
