...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageAssignComponentOnCL_ICAction.java
//
...
public class SpecializedPackageAssignComponentOnCL_ICAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageAssignComponentOnCL_ICAction.
	 */
	public SpecializedPackageAssignComponentOnCL_ICAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = CL_IC_SpecializedPackageAssignComponent(structuredSelection);
		wd.open();
	...
	public WizardDialog CL_IC_SpecializedPackageAssignComponent(
			IStructuredSelection selection) {
		SpecializedPackageAssignComponentOnCL_ICWizard wizard = new SpecializedPackageAssignComponentOnCL_ICWizard();
...
} // end SpecializedPackageAssignComponentOnCL_ICAction
