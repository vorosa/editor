...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionClassOnEP_PKGAction.java
//
...
public class InteractionClassOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for InteractionClassOnEP_PKGAction.
	 */
	public InteractionClassOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionClass(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ClassParticipant_c", false));
	}
	private void EP_PKG_InteractionClass(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction Class");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newclassparticipant();
			} else {
			...
			NonRootModelElement[] children = ClassParticipant_c
			...
			CorePlugin.logError("Transaction: Interaction Class failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionClassOnEP_PKGAction
