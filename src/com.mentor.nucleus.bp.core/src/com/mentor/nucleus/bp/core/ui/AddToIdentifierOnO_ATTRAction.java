...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/AddToIdentifierOnO_ATTRAction.java
//
...
// creates new Add to Identifiers.
//
...
public class AddToIdentifierOnO_ATTRAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for AddToIdentifierOnO_ATTRAction.
	 */
	public AddToIdentifierOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = O_ATTR_AddToIdentifier(structuredSelection);
		wd.open();
	...
	public WizardDialog O_ATTR_AddToIdentifier(IStructuredSelection selection) {
		AddToIdentifierOnO_ATTRWizard wizard = new AddToIdentifierOnO_ATTRWizard();
...
} // end AddToIdentifierOnO_ATTRAction
