...
//====================================================================
//
// File:    SpecializedPackageAssignEventOnSM_CRTXNWizardPage1.java
//
...
public class SpecializedPackageAssignEventOnSM_CRTXNWizardPage1
		extends
	...
	/**
	 * Constructors for SpecializedPackageAssignEventOnSM_CRTXNWizardPage1.
	 */
	public SpecializedPackageAssignEventOnSM_CRTXNWizardPage1() {
		super("");
		init();
	}

	public SpecializedPackageAssignEventOnSM_CRTXNWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((SpecializedPackageAssignEventOnSM_CRTXNWizard) getWizard())
						.getSelection());

		// cache for context
		CreationTransition_c v_ctxn = ((SpecializedPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_ctxn;
	...
	public void updateSelectedEvent() {
		...
		((SpecializedPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_event = this.Event;
	}
	...
	public IWizardPage getNextPage() {
		((SpecializedPackageAssignEventOnSM_CRTXNWizard) getWizard()).v_event = Event;
