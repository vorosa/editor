...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CombineWithOnO_ATTRAction.java
//
...
public class CombineWithOnO_ATTRAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CombineWithOnO_ATTRAction.
	 */
	public CombineWithOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = O_ATTR_CombineWith(structuredSelection);
		wd.open();
	...
	public WizardDialog O_ATTR_CombineWith(IStructuredSelection selection) {
		CombineWithOnO_ATTRWizard wizard = new CombineWithOnO_ATTRWizard();
