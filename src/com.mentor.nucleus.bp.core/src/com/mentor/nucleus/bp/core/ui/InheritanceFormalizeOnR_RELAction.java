...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InheritanceFormalizeOnR_RELAction.java
//
...
public class InheritanceFormalizeOnR_RELAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for InheritanceFormalizeOnR_RELAction.
	 */
	public InheritanceFormalizeOnR_RELAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = R_REL_InheritanceFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog R_REL_InheritanceFormalize(
			IStructuredSelection selection) {
		InheritanceFormalizeOnR_RELWizard wizard = new InheritanceFormalizeOnR_RELWizard();
...
} // end InheritanceFormalizeOnR_RELAction
