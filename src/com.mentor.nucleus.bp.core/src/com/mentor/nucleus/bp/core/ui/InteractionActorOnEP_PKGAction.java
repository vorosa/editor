...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionActorOnEP_PKGAction.java
//
...
public class InteractionActorOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for InteractionActorOnEP_PKGAction.
	 */
	public InteractionActorOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionActor(structuredSelection);
	...
	private void EP_PKG_InteractionActor(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction Actor");
		...
		try {
			...
			NonRootModelElement[] children = ActorParticipant_c
			...
			CorePlugin.logError("Transaction: Interaction Actor failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionActorOnEP_PKGAction
