...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageInstanceFormalizeOnSQ_CIPAction.java
//
...
public class SpecializedPackageInstanceFormalizeOnSQ_CIPAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageInstanceFormalizeOnSQ_CIPAction.
	 */
	public SpecializedPackageInstanceFormalizeOnSQ_CIPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SQ_CIP_SpecializedPackageInstanceFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog SQ_CIP_SpecializedPackageInstanceFormalize(
			IStructuredSelection selection) {
		SpecializedPackageInstanceFormalizeOnSQ_CIPWizard wizard = new SpecializedPackageInstanceFormalizeOnSQ_CIPWizard();
...
} // end SpecializedPackageInstanceFormalizeOnSQ_CIPAction
