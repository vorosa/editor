...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetFromProviderOnC_IOAction.java
//
...
// creates new Set From Providers.
//
...
public class SetFromProviderOnC_IOAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetFromProviderOnC_IOAction.
	 */
	public SetFromProviderOnC_IOAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_IO_SetFromProvider(structuredSelection);
	...
	private void C_IO_SetFromProvider(IStructuredSelection selection) {
		...
		InterfaceOperation_c v_io = (InterfaceOperation_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_io
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Operation Set From Provider");
		try {
			...
			if (((v_io != null))) {
				...
				if (v_io != null) {
					v_io.setDirection(Ifdirectiontype_c.ServerClient);
				} else {
			...
			CorePlugin
					.logError(
							"Transaction: Interface Operation Set From Provider failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetFromProviderOnC_IOAction
