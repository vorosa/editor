//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/CommunicationCellProvider.java
//
...
public class CommunicationCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Communication_c) element).getName()) )
            {
                ((Communication_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Communication_c) element).getDescrip()) )
            {
                ((Communication_c) element).setDescrip(value.toString());
            }
        }
