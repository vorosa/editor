//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActivityFinalNodeCellProvider.java
//
...
public class ActivityFinalNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ActivityFinalNode_c) element).getDescrip()) )
            {
                ((ActivityFinalNode_c) element).setDescrip(value.toString());
            }
        }
