...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/PackageParticipantUnformalizeOnSQ_PPAction.java
//
...
public class PackageParticipantUnformalizeOnSQ_PPAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for PackageParticipantUnformalizeOnSQ_PPAction.
	 */
	public PackageParticipantUnformalizeOnSQ_PPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_PP_PackageParticipantUnformalize(structuredSelection);
	...
	private void SQ_PP_PackageParticipantUnformalize(
		...
		PackageParticipant_c v_pp = (PackageParticipant_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_pp
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Package Participant Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Package Participant Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end PackageParticipantUnformalizeOnSQ_PPAction
