...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionInstanceOnEP_PKGAction.java
//
...
public class InteractionInstanceOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for InteractionInstanceOnEP_PKGAction.
	 */
	public InteractionInstanceOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionInstance(structuredSelection);
	...
	private void EP_PKG_InteractionInstance(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction Instance");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newclassinstance();
			} else {
			...
			NonRootModelElement[] children = ClassInstanceParticipant_c
			...
			CorePlugin.logError("Transaction: Interaction Instance failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionInstanceOnEP_PKGAction
