...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ActivityObjectNodeOnEP_PKGAction.java
//
...
public class ActivityObjectNodeOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for ActivityObjectNodeOnEP_PKGAction.
	 */
	public ActivityObjectNodeOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ActivityObjectNode(structuredSelection);
	...
	private void EP_PKG_ActivityObjectNode(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Activity Object Node");
		...
		try {
			...
			NonRootModelElement[] children = ObjectNode_c
			...
			CorePlugin.logError("Transaction: Activity Object Node failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ActivityObjectNodeOnEP_PKGAction
