//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ReturnMessageCellProvider.java
//
...
public class ReturnMessageCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("ReturnValue"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getReturnvalue()) )
            {
                ((ReturnMessage_c) element).setReturnvalue(value.toString());
            }
        }
        if(data.getName().equals("ResultTarget"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getResulttarget()) )
            {
                ((ReturnMessage_c) element).setResulttarget(value.toString());
            }
        }
        if(data.getName().equals("GuardCondition"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getGuardcondition()) )
            {
                ((ReturnMessage_c) element).setGuardcondition(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getDescrip()) )
            {
                ((ReturnMessage_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getName()) )
            {
                ((ReturnMessage_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("SequenceNumb"))
        {
            if ( ! value.toString().equals(((ReturnMessage_c) element).getSequencenumb()) )
            {
                ((ReturnMessage_c) element).setSequencenumb(value.toString());
            }
        }
