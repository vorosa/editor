...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionPackageParticipantOnEP_PKGAction.java
//
...
// creates new Package Participants.
//
...
public class InteractionPackageParticipantOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for InteractionPackageParticipantOnEP_PKGAction.
	 */
	public InteractionPackageParticipantOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionPackageParticipant(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"PackageParticipant_c", false));
	}
	private void EP_PKG_InteractionPackageParticipant(
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction Package Participant");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newpackageparticipant();
			} else {
			...
			NonRootModelElement[] children = PackageParticipant_c
			...
			CorePlugin.logError(
					"Transaction: Interaction Package Participant failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionPackageParticipantOnEP_PKGAction
