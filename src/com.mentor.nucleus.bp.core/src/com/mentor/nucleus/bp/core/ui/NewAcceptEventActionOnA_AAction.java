...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewAcceptEventActionOnA_AAction.java
//
...
public class NewAcceptEventActionOnA_AAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewAcceptEventActionOnA_AAction.
	 */
	public NewAcceptEventActionOnA_AAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		A_A_NewAcceptEventAction(structuredSelection);
	...
	private void A_A_NewAcceptEventAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Accept Event Action");
		try {
			...
			CorePlugin.logError(
					"Transaction: New Accept Event Action failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewAcceptEventActionOnA_AAction
