...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePrivateOnS_SDTAction.java
//
...
public class MakePrivateOnS_SDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePrivateOnS_SDTAction.
	 */
	public MakePrivateOnS_SDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SDT_MakePrivate(structuredSelection);
	...
	private void S_SDT_MakePrivate(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Structured Data Type Make Private");
		try {
			...
			CorePlugin.logError(
					"Transaction: Structured Data Type Make Private failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePrivateOnS_SDTAction
