...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageFormalizeOnC_RAction.java
//
...
public class GenericPackageFormalizeOnC_RAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for GenericPackageFormalizeOnC_RAction.
	 */
	public GenericPackageFormalizeOnC_RAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_R_GenericPackageFormalize(structuredSelection);
	}
	/**
	...
	public static void C_R_GenericPackageFormalize(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      Requirement_c v_element = (Requirement_c)context;
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (Requirement_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
,true ) ;
  ...
  CorePlugin.logError("Attempted to call an operation on a null instance.", t);
	...
	public static Interface_c[] getElements(Requirement_c v_element) {
  ...
  } // end getElements(Requirement_c) 
} // end GenericPackageFormalizeOnC_RAction
