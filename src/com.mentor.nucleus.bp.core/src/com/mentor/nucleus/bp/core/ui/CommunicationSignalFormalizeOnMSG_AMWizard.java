...
//====================================================================
//
// File:    CommunicationSignalFormalizeOnMSG_AMWizard.java
//
...
/**
 * CommunicationSignalFormalizeOnMSG_AMWizard class
 */
public class CommunicationSignalFormalizeOnMSG_AMWizard extends Wizard {
	...
	// wizard pages
	CommunicationSignalFormalizeOnMSG_AMWizardPage4 MSG_AM_CommunicationSignalFormalizePage4;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int MSG_AM_COMMUNICATIONSIGNALFORMALIZE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for CommunicationSignalFormalizeOnMSG_AMWizard.
	 */
	public CommunicationSignalFormalizeOnMSG_AMWizard() {
		super();
	}
	...
	public void addPages() {
		MSG_AM_CommunicationSignalFormalizePage4 = new CommunicationSignalFormalizeOnMSG_AMWizardPage4(
				"CommunicationSignalFormalizeOnMSG_AMWizardPage4");
		addPage(MSG_AM_CommunicationSignalFormalizePage4);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& MSG_AM_CommunicationSignalFormalizePage4.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case MSG_AM_COMMUNICATIONSIGNALFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Communication Signal Formalize"); //$NON-NLS-1$
				...
				if (((v_cop != null))) {
					...
					if (((v_comp != null))) {
						...
						if (((v_Signal != null))) {
							...
							if (v_asyncMessage != null) {
								v_asyncMessage.Formalizewithsignal(v_Signal
										.getId());
							} else {
								Throwable t = new Throwable();
								t.fillInStackTrace();
			...
			CorePlugin.logError(
					"Transaction: Communication Signal Formalize failed", e);//$NON-NLS-1$
