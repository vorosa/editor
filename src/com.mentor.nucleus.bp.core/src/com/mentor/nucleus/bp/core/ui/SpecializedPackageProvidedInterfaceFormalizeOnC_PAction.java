...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageProvidedInterfaceFormalizeOnC_PAction.java
//
...
public class SpecializedPackageProvidedInterfaceFormalizeOnC_PAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageProvidedInterfaceFormalizeOnC_PAction.
	 */
	public SpecializedPackageProvidedInterfaceFormalizeOnC_PAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = C_P_SpecializedPackageProvidedInterfaceFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog C_P_SpecializedPackageProvidedInterfaceFormalize(
			IStructuredSelection selection) {
		SpecializedPackageProvidedInterfaceFormalizeOnC_PWizard wizard = new SpecializedPackageProvidedInterfaceFormalizeOnC_PWizard();
...
} // end SpecializedPackageProvidedInterfaceFormalizeOnC_PAction
