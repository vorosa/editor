//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/IncludeCellProvider.java
//
...
public class IncludeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Include_c) element).getDescrip()) )
            {
                ((Include_c) element).setDescrip(value.toString());
            }
        }
