//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/FlowFinalNodeCellProvider.java
//
...
public class FlowFinalNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((FlowFinalNode_c) element).getDescrip()) )
            {
                ((FlowFinalNode_c) element).setDescrip(value.toString());
            }
        }
