...
//====================================================================
//
// File:    FunctionFormalizeOnMSG_SMWizardPage1.java
//
...
public class FunctionFormalizeOnMSG_SMWizardPage1 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for FunctionFormalizeOnMSG_SMWizardPage1.
	 */
	public FunctionFormalizeOnMSG_SMWizardPage1() {
		super("");
		init();
	}

	public FunctionFormalizeOnMSG_SMWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		...
		Function_c v_Message = ((FunctionFormalizeOnMSG_SMWizard) getWizard()).v_Message;
