...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewClassParticipantOnSQ_SAction.java
//
...
// creates new Class Participants.
//
...
public class NewClassParticipantOnSQ_SAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewClassParticipantOnSQ_SAction.
	 */
	public NewClassParticipantOnSQ_SAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_S_NewClassParticipant(structuredSelection);
	...
	private void SQ_S_NewClassParticipant(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Class Participant");
		try {
			...
			if (((v_sequence != null))) {
				...
				if (v_sequence != null) {
					v_sequence.Newclassparticipant();
				} else {
...
} // end NewClassParticipantOnSQ_SAction
