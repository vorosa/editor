...
//====================================================================
//
// File:    LinkedFormalizeOnR_ASSRWizardPage1.java
//
...
public class LinkedFormalizeOnR_ASSRWizardPage1 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for LinkedFormalizeOnR_ASSRWizardPage1.
	 */
	public LinkedFormalizeOnR_ASSRWizardPage1() {
		super("");
		init();
	}

	public LinkedFormalizeOnR_ASSRWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((LinkedFormalizeOnR_ASSRWizard) getWizard())
						.getSelection());

		// cache for context
		ClassAsLink_c v_assr = ((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_assr;

		LinkedAssociation_c v_a_rel = LinkedAssociation_c
				.getOneR_ASSOCOnR211(v_assr);
	...
	public void createControl(Composite parent) {
		...
		One_idPrefix.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent arg0) {
				((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_one_idPrefix = LinkedFormalizeOnR_ASSRWizardPage1.this.One_idPrefix
						.getText();
			}
		});
		...
		Oth_idPrefix.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent arg0) {
				((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_oth_idPrefix = LinkedFormalizeOnR_ASSRWizardPage1.this.Oth_idPrefix
						.getText();
			}
		});
	...
	public void updateSelectedOne_id() {
		...
		((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_one_id = this.One_id;
	}
	// public for unit tests
	public void updateSelectedOth_id() {
		this.Oth_id = Oth_idInstances[Oth_idCombo.getSelectionIndex()];
		((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_oth_id = this.Oth_id;
	}
	...
	public IWizardPage getNextPage() {
		((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_one_id = One_id;
		((LinkedFormalizeOnR_ASSRWizard) getWizard()).v_oth_id = Oth_id;
