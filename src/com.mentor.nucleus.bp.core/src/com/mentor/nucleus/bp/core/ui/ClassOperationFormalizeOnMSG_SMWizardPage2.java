...
//====================================================================
//
// File:    ClassOperationFormalizeOnMSG_SMWizardPage2.java
//
...
public class ClassOperationFormalizeOnMSG_SMWizardPage2 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for ClassOperationFormalizeOnMSG_SMWizardPage2.
	 */
	public ClassOperationFormalizeOnMSG_SMWizardPage2() {
		super("");
		init();
	}

	public ClassOperationFormalizeOnMSG_SMWizardPage2(String name) {
		super(name);
		init();
	}
	...
	public void updateSelectedMessage() {
		...
		((ClassOperationFormalizeOnMSG_SMWizard) getWizard()).v_Message = this.Message;
	}
	...
	public IWizardPage getNextPage() {
		((ClassOperationFormalizeOnMSG_SMWizard) getWizard()).v_Message = Message;
