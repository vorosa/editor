...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/RequiredInterfaceUnformalizeOnC_RAction.java
//
...
public class RequiredInterfaceUnformalizeOnC_RAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for RequiredInterfaceUnformalizeOnC_RAction.
	 */
	public RequiredInterfaceUnformalizeOnC_RAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_R_RequiredInterfaceUnformalize(structuredSelection);
	...
	private void C_R_RequiredInterfaceUnformalize(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      Requirement_c v_requirement = (Requirement_c)context;
      PersistableModelComponent.ensureCoreDataTypesAvailable(v_requirement.getModelRoot());
        

	TransactionUtil.TransactionGroup transactionGroup = 
		TransactionUtil.startTransactionsOnSelectedModelRoots("Required Interface Unformalize");
    try {
        // Ensure that actions take place between Verifier Activity executions
		Ooaofooa.beginSaveOperation();
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_requirement = (Requirement_c) iterator.next();
	if ( (  (v_requirement != null)) )
{

if (v_requirement != null) {
v_requirement.Unformalize(			    
true ) ;
}
else {
  ...
  CorePlugin.logError("Attempted to call an operation on a null instance.", t);
	...
	// catch all exceptions and cancel the transactions
    	...
    	CorePlugin.logError("Transaction: Required Interface Unformalize failed", e);//$NON-NLS-1$
	}
	      TransactionUtil.endTransactions(transactionGroup);

  }
} // end RequiredInterfaceUnformalizeOnC_RAction
