...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnS_EDTAction.java
//
...
public class MakePublicOnS_EDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnS_EDTAction.
	 */
	public MakePublicOnS_EDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_EDT_MakePublic(structuredSelection);
	...
	private void S_EDT_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Enumeration Data Type Make Public");
		try {
			...
			CorePlugin.logError(
					"Transaction: Enumeration Data Type Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnS_EDTAction
