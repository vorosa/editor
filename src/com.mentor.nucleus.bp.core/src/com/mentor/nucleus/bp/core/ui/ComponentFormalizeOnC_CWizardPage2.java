...
//====================================================================
//
// File:    ComponentFormalizeOnC_CWizardPage2.java
//
...
public class ComponentFormalizeOnC_CWizardPage2 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for ComponentFormalizeOnC_CWizardPage2.
	 */
	public ComponentFormalizeOnC_CWizardPage2() {
		super("");
		init();
	}

	public ComponentFormalizeOnC_CWizardPage2(String name) {
		super(name);
		init();
	}
