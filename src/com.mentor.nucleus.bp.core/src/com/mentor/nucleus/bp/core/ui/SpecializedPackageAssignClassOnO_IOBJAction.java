...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageAssignClassOnO_IOBJAction.java
//
...
public class SpecializedPackageAssignClassOnO_IOBJAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageAssignClassOnO_IOBJAction.
	 */
	public SpecializedPackageAssignClassOnO_IOBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = O_IOBJ_SpecializedPackageAssignClass(structuredSelection);
		wd.open();
	...
	public WizardDialog O_IOBJ_SpecializedPackageAssignClass(
			IStructuredSelection selection) {
		SpecializedPackageAssignClassOnO_IOBJWizard wizard = new SpecializedPackageAssignClassOnO_IOBJWizard();
...
} // end SpecializedPackageAssignClassOnO_IOBJAction
