...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewParameterOnS_BRGAction.java
//
...
public class NewParameterOnS_BRGAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewParameterOnS_BRGAction.
	 */
	public NewParameterOnS_BRGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_BRG_NewParameter(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"BridgeParameter_c", false));
	}
	private void S_BRG_NewParameter(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = BridgeParameter_c
