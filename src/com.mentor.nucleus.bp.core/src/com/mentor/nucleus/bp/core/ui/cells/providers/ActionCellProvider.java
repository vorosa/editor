//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActionCellProvider.java
//
...
public class ActionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Suc_Pars"))
        {
            ...
            if ( new_val != ((Action_c) element).getSuc_pars() )
            {
                ((Action_c) element).setSuc_pars(new_val);
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Action_c) element).getDescrip()) )
            {
                ((Action_c) element).setDescrip(value.toString());
            }
        }
