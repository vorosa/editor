...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageCantHappenEventOnSM_STATEAction.java
//
...
// creates new Cant Happen Events.
//
...
public class SpecializedPackageCantHappenEventOnSM_STATEAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageCantHappenEventOnSM_STATEAction.
	 */
	public SpecializedPackageCantHappenEventOnSM_STATEAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_STATE_SpecializedPackageCantHappenEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_STATE_SpecializedPackageCantHappenEvent(
			IStructuredSelection selection) {
		SpecializedPackageCantHappenEventOnSM_STATEWizard wizard = new SpecializedPackageCantHappenEventOnSM_STATEWizard();
...
} // end SpecializedPackageCantHappenEventOnSM_STATEAction
