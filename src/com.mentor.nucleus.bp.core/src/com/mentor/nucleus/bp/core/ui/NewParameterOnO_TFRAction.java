...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewParameterOnO_TFRAction.java
//
...
public class NewParameterOnO_TFRAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewParameterOnO_TFRAction.
	 */
	public NewParameterOnO_TFRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_TFR_NewParameter(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"OperationParameter_c", false));
	}
	private void O_TFR_NewParameter(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = OperationParameter_c
