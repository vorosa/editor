//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/MessageArgumentCellProvider.java
//
...
public class MessageArgumentCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Value"))
        {
            if ( ! value.toString().equals(((MessageArgument_c) element).getValue()) )
            {
                ((MessageArgument_c) element).setValue(value.toString());
            }
        }
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((MessageArgument_c) element).getInformalname()) )
            {
                ((MessageArgument_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((MessageArgument_c) element).getDescrip()) )
            {
                ((MessageArgument_c) element).setDescrip(value.toString());
            }
        }
