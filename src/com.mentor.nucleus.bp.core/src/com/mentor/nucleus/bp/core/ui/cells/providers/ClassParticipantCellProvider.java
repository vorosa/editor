//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ClassParticipantCellProvider.java
//
...
public class ClassParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((ClassParticipant_c) element).getInformalname()) )
            {
                ((ClassParticipant_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ClassParticipant_c) element).getDescrip()) )
            {
                ((ClassParticipant_c) element).setDescrip(value.toString());
            }
        }
