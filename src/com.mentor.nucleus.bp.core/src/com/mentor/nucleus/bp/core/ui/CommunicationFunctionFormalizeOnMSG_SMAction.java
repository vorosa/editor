...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationFunctionFormalizeOnMSG_SMAction.java
//
...
public class CommunicationFunctionFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationFunctionFormalizeOnMSG_SMAction.
	 */
	public CommunicationFunctionFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationFunctionFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationFunctionFormalize(
			IStructuredSelection selection) {
		CommunicationFunctionFormalizeOnMSG_SMWizard wizard = new CommunicationFunctionFormalizeOnMSG_SMWizard();
...
} // end CommunicationFunctionFormalizeOnMSG_SMAction
