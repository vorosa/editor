//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/StateMachineEventDataItemCellProvider.java
//
...
public class StateMachineEventDataItemCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((StateMachineEventDataItem_c) element).getName()) )
            {
                ((StateMachineEventDataItem_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((StateMachineEventDataItem_c) element).getDescrip()) )
            {
                ((StateMachineEventDataItem_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Dimensions"))
        {
            if ( ! value.toString().equals(((StateMachineEventDataItem_c) element).getDimensions()) )
            {
                Vector dims = DimensionsUtil.getDimensionsData(value.toString(),(StateMachineEventDataItem_c) element);
                if (dims.size() > 0) {
                    for (int i = 0; i < dims.size(); i++) {
                        int numElements = ((Integer)dims.get(i)).intValue();
                        ((StateMachineEventDataItem_c) element).Resizedimensions(i, numElements, dims.size());
                    }
                } else {
                    ((StateMachineEventDataItem_c) element).Resizedimensions(0, 0, 0);
                }
                ((StateMachineEventDataItem_c) element).setDimensions(value.toString());
            }
        }
