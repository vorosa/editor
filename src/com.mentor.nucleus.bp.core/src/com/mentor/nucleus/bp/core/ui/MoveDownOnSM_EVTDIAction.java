...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnSM_EVTDIAction.java
//
...
public class MoveDownOnSM_EVTDIAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnSM_EVTDIAction.
	 */
	public MoveDownOnSM_EVTDIAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_EVTDI_MoveDown(structuredSelection);
	...
	private void SM_EVTDI_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("State Machine Event Data Item Move Down");
		try {
			...
			CorePlugin
					.logError(
							"Transaction: State Machine Event Data Item Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnSM_EVTDIAction
