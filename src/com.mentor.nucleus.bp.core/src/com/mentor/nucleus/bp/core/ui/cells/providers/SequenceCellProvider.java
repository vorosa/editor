//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SequenceCellProvider.java
//
...
public class SequenceCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Sequence_c) element).getName()) )
            {
                ((Sequence_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Sequence_c) element).getDescrip()) )
            {
                ((Sequence_c) element).setDescrip(value.toString());
            }
        }
