...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakeProtectedOnS_EDTAction.java
//
...
public class MakeProtectedOnS_EDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakeProtectedOnS_EDTAction.
	 */
	public MakeProtectedOnS_EDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_EDT_MakeProtected(structuredSelection);
	...
	private void S_EDT_MakeProtected(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Enumeration Data Type Make Protected");
		try {
			...
			CorePlugin
					.logError(
							"Transaction: Enumeration Data Type Make Protected failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakeProtectedOnS_EDTAction
