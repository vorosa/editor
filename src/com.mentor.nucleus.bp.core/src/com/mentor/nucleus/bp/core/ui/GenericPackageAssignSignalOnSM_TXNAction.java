...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageAssignSignalOnSM_TXNAction.java
//
...
public class GenericPackageAssignSignalOnSM_TXNAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageAssignSignalOnSM_TXNAction.
	 */
	public GenericPackageAssignSignalOnSM_TXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_TXN_GenericPackageAssignSignal(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_TXN_GenericPackageAssignSignal(
			IStructuredSelection selection) {
		GenericPackageAssignSignalOnSM_TXNWizard wizard = new GenericPackageAssignSignalOnSM_TXNWizard();
...
} // end GenericPackageAssignSignalOnSM_TXNAction
