//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ComponentCellProvider.java
//
...
public class ComponentCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(Component_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((Component_c) element));
                	return editor;
                }
                if(data.getName().equals("isRealized")) {
                	CellEditor editor = new BooleanCellEditor(parent);
                	return editor;
                }
                if(data.getName().equals("Realized_Class_Path")) {
	                CellEditor editor = new TextCellEditor(parent);
	                return editor;
	            }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Component_c) element).getName()) )
            {
                ((Component_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Component_c) element).getDescrip()) )
            {
                ((Component_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Mult"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Component_c) element).getMult() )
            {
                ((Component_c) element).setMult(new_val);
            }
        }
        if(data.getName().equals("isRealized"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((Component_c) element).getIsrealized() )
            {
                ((Component_c) element).setIsrealized(new_val);
            }
        }
        if(data.getName().equals("Realized_Class_Path"))
        {
            if ( ! value.toString().equals(((Component_c) element).getRealized_class_path()) )
            {
                ((Component_c) element).setRealized_class_path(value.toString());
            }
        }
        if(data.getName().equals("Visibility"))
        {
