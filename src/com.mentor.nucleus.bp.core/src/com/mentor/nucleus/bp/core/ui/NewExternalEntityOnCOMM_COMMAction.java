...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewExternalEntityOnCOMM_COMMAction.java
//
...
public class NewExternalEntityOnCOMM_COMMAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewExternalEntityOnCOMM_COMMAction.
	 */
	public NewExternalEntityOnCOMM_COMMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		COMM_COMM_NewExternalEntity(structuredSelection);
	...
	private void COMM_COMM_NewExternalEntity(IStructuredSelection selection) {
		...
		try {
			...
			if (((v_comm != null))) {
				...
				if (v_comm != null) {
					v_comm.Newexternalentityparticipant();
				} else {
...
} // end NewExternalEntityOnCOMM_COMMAction
