...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UnformalizeOnR_RELAction.java
//
...
public class UnformalizeOnR_RELAction implements IObjectActionDelegate {

	/**
	 * Constructor for UnformalizeOnR_RELAction.
	 */
	public UnformalizeOnR_RELAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		R_REL_Unformalize(structuredSelection);
	...
	private void R_REL_Unformalize(IStructuredSelection selection) {
		...
		Association_c v_rel = (Association_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_rel
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Association Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Association Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end UnformalizeOnR_RELAction
