...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageIgnoreInStateOnSM_EVTAction.java
//
...
public class GenericPackageIgnoreInStateOnSM_EVTAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageIgnoreInStateOnSM_EVTAction.
	 */
	public GenericPackageIgnoreInStateOnSM_EVTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_EVT_GenericPackageIgnoreInState(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_EVT_GenericPackageIgnoreInState(
			IStructuredSelection selection) {
		GenericPackageIgnoreInStateOnSM_EVTWizard wizard = new GenericPackageIgnoreInStateOnSM_EVTWizard();
...
} // end GenericPackageIgnoreInStateOnSM_EVTAction
