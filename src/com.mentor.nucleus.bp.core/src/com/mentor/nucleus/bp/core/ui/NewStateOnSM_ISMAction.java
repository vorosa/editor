...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewStateOnSM_ISMAction.java
//
...
public class NewStateOnSM_ISMAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewStateOnSM_ISMAction.
	 */
	public NewStateOnSM_ISMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_ISM_NewState(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"StateMachineState_c", false));
	}
	private void SM_ISM_NewState(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New State");
		...
		try {
			...
			NonRootModelElement[] children = StateMachineState_c
			...
			CorePlugin.logError("Transaction: New State failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
