//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/DecisionMergeNodeCellProvider.java
//
...
public class DecisionMergeNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((DecisionMergeNode_c) element).getName()) )
            {
                ((DecisionMergeNode_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((DecisionMergeNode_c) element).getDescrip()) )
            {
                ((DecisionMergeNode_c) element).setDescrip(value.toString());
            }
        }
