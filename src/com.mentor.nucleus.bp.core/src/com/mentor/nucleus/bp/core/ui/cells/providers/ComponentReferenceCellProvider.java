//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ComponentReferenceCellProvider.java
//
...
public class ComponentReferenceCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(ComponentReference_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((ComponentReference_c) element));
                	return editor;
                }
                if(data.getName().equals("ClassifierName")) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Mult"))
        {
            ...
            if ( new_val != ((ComponentReference_c) element).getMult() )
            {
                ((ComponentReference_c) element).setMult(new_val);
            }
        }
        if(data.getName().equals("ClassifierName"))
        {
            if ( ! value.toString().equals(((ComponentReference_c) element).getClassifiername()) )
            {
                ((ComponentReference_c) element).setClassifiername(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ComponentReference_c) element).getDescrip()) )
            {
                ((ComponentReference_c) element).setDescrip(value.toString());
            }
        }
