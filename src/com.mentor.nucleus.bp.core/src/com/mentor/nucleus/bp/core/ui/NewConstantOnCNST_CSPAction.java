...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewConstantOnCNST_CSPAction.java
//
...
public class NewConstantOnCNST_CSPAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewConstantOnCNST_CSPAction.
	 */
	public NewConstantOnCNST_CSPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CNST_CSP_NewConstant(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"LiteralSymbolicConstant_c", false));
	}
	private void CNST_CSP_NewConstant(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Constant");
		...
		try {
			...
			NonRootModelElement[] children = LiteralSymbolicConstant_c
...
} // end NewConstantOnCNST_CSPAction
