//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/PortCellProvider.java
//
...
public class PortCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(Port_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("DoNotShowPortOnCanvas")) {
                	CellEditor editor = new BooleanCellEditor(parent);
                	return editor;
                }
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((Port_c) element));
                	return editor;
                }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Port_c) element).getName()) )
            {
                ((Port_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("DoNotShowPortOnCanvas"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((Port_c) element).getDonotshowportoncanvas() )
            {
                ((Port_c) element).setDonotshowportoncanvas(new_val);
            }
        }
        if(data.getName().equals("Mult"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Port_c) element).getMult() )
            {
                ((Port_c) element).setMult(new_val);
            }
        }
