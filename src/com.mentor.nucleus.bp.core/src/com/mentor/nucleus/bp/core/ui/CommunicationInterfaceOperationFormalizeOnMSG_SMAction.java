...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationInterfaceOperationFormalizeOnMSG_SMAction.java
//
...
public class CommunicationInterfaceOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationInterfaceOperationFormalizeOnMSG_SMAction.
	 */
	public CommunicationInterfaceOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationInterfaceOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationInterfaceOperationFormalize(
			IStructuredSelection selection) {
		CommunicationInterfaceOperationFormalizeOnMSG_SMWizard wizard = new CommunicationInterfaceOperationFormalizeOnMSG_SMWizard();
...
} // end CommunicationInterfaceOperationFormalizeOnMSG_SMAction
