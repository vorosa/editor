...
//====================================================================
//
// File:    InstanceEventFormalizeOnMSG_AMWizardPage2.java
//
...
public class InstanceEventFormalizeOnMSG_AMWizardPage2 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for InstanceEventFormalizeOnMSG_AMWizardPage2.
	 */
	public InstanceEventFormalizeOnMSG_AMWizardPage2() {
		super("");
		init();
	}

	public InstanceEventFormalizeOnMSG_AMWizardPage2(String name) {
		super(name);
		init();
	}
			...
			for (MessageInstCount = 0; MessageInstCount < v_MessageInstances.length; MessageInstCount++) {
				...
				if (User_c.Selectone(selected.getSmevt_id())
						&& ((v_stateMachine.Canassignevent(
								...
								false)) && (!selected.getSmevt_id().equals(
								v_existingId)))) {
					MessageResultCount++;
				}
			}
	...
	public void updateSelectedMessage() {
		...
		((InstanceEventFormalizeOnMSG_AMWizard) getWizard()).v_Message = this.Message;
	}
	...
	public IWizardPage getNextPage() {
		((InstanceEventFormalizeOnMSG_AMWizard) getWizard()).v_Message = Message;
