...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/LinkedFormalizeOnR_RELAction.java
//
...
public class LinkedFormalizeOnR_RELAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for LinkedFormalizeOnR_RELAction.
	 */
	public LinkedFormalizeOnR_RELAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = R_REL_LinkedFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog R_REL_LinkedFormalize(IStructuredSelection selection) {
		LinkedFormalizeOnR_RELWizard wizard = new LinkedFormalizeOnR_RELWizard();
...
} // end LinkedFormalizeOnR_RELAction
