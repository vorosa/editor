...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/LinkFormalizeOnCOMM_LNKAction.java
//
...
public class LinkFormalizeOnCOMM_LNKAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for LinkFormalizeOnCOMM_LNKAction.
	 */
	public LinkFormalizeOnCOMM_LNKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = COMM_LNK_LinkFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog COMM_LNK_LinkFormalize(IStructuredSelection selection) {
...
} // end LinkFormalizeOnCOMM_LNKAction
