...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnC_PPAction.java
//
...
public class SetTypeOnC_PPAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnC_PPAction.
	 */
	public SetTypeOnC_PPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_PP_SetType(structuredSelection);
	}
	/**
	...
	public static void C_PP_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      PropertyParameter_c v_element = (PropertyParameter_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR4007(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(Interface_c.getOneC_IOnR4003(ExecutableProperty_c.getOneC_EPOnR4006(v_element)));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (PropertyParameter_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR4007(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR4007From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR4007To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(PropertyParameter_c v_element) {
  ...
  } // end getElements(PropertyParameter_c) 
} // end SetTypeOnC_PPAction
