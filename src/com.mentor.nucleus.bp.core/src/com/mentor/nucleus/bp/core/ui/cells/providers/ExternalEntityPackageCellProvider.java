//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ExternalEntityPackageCellProvider.java
//
...
public class ExternalEntityPackageCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ExternalEntityPackage_c) element).getName()) )
            {
                ((ExternalEntityPackage_c) element).setName(value.toString());
            }
        }
