//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ClassAsDerivedOtherSideCellProvider.java
//
...
public class ClassAsDerivedOtherSideCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(ClassAsDerivedOtherSide_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((ClassAsDerivedOtherSide_c) element));
                	return editor;
                }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Mult"))
        {
            ...
            if ( new_val != ((ClassAsDerivedOtherSide_c) element).getMult() )
            {
                ((ClassAsDerivedOtherSide_c) element).setMult(new_val);
            }
        }
        if(data.getName().equals("Cond"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((ClassAsDerivedOtherSide_c) element).getCond() )
            {
                ((ClassAsDerivedOtherSide_c) element).setCond(new_val);
            }
        }
        if(data.getName().equals("Txt_Phrs"))
        {
            if ( ! value.toString().equals(((ClassAsDerivedOtherSide_c) element).getTxt_phrs()) )
            {
                ((ClassAsDerivedOtherSide_c) element).setTxt_phrs(value.toString());
            }
        }
