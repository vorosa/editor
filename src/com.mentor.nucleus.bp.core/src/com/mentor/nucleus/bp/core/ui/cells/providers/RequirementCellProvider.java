//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/RequirementCellProvider.java
//
...
public class RequirementCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Requirement_c) element).getDescrip()) )
            {
                ((Requirement_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((Requirement_c) element).getInformalname()) )
            {
                ((Requirement_c) element).setInformalname(value.toString());
            }
        }
