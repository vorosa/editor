...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnS_BPARMAction.java
//
...
public class SetTypeOnS_BPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnS_BPARMAction.
	 */
	public SetTypeOnS_BPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_BPARM_SetType(structuredSelection);
	}
	/**
	...
	public static void S_BPARM_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      BridgeParameter_c v_element = (BridgeParameter_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR22(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ExternalEntity_c.getOneS_EEOnR19(Bridge_c.getOneS_BRGOnR21(v_element)));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (BridgeParameter_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR22(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR22From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR22To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(BridgeParameter_c v_element) {
  ...
  } // end getElements(BridgeParameter_c) 
} // end SetTypeOnS_BPARMAction
