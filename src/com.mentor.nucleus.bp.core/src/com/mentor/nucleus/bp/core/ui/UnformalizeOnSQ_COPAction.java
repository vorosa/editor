...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UnformalizeOnSQ_COPAction.java
//
...
public class UnformalizeOnSQ_COPAction implements IObjectActionDelegate {

	/**
	 * Constructor for UnformalizeOnSQ_COPAction.
	 */
	public UnformalizeOnSQ_COPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_COP_Unformalize(structuredSelection);
	...
	private void SQ_COP_Unformalize(IStructuredSelection selection) {
		...
		ComponentParticipant_c v_cop = (ComponentParticipant_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_cop
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Component Participant Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Component Participant Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end UnformalizeOnSQ_COPAction
