...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewClassStateMachineOnO_OBJAction.java
//
...
// creates new Class State Machines.
//
...
public class NewClassStateMachineOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewClassStateMachineOnO_OBJAction.
	 */
	public NewClassStateMachineOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_NewClassStateMachine(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ClassStateMachine_c", false));
	}
	private void O_OBJ_NewClassStateMachine(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Class State Machine");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			boolean v_ignore = v_clazz.Create_sm("ASM");
			...
			CorePlugin.logError(
					"Transaction: New Class State Machine failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewClassStateMachineOnO_OBJAction
