...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakeProtectedOnS_SDTAction.java
//
...
public class MakeProtectedOnS_SDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakeProtectedOnS_SDTAction.
	 */
	public MakeProtectedOnS_SDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SDT_MakeProtected(structuredSelection);
	...
	private void S_SDT_MakeProtected(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Structured Data Type Make Protected");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			PackageableElement_c v_pe = PackageableElement_c
					.getOnePE_PEOnR8001(DataType_c.getOneS_DTOnR17(v_sdt));
			...
			CorePlugin
					.logError(
							"Transaction: Structured Data Type Make Protected failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakeProtectedOnS_SDTAction
