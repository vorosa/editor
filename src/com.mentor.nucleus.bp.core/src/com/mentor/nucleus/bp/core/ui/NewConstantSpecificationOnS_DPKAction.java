...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewConstantSpecificationOnS_DPKAction.java
//
...
public class NewConstantSpecificationOnS_DPKAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewConstantSpecificationOnS_DPKAction.
	 */
	public NewConstantSpecificationOnS_DPKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_DPK_NewConstantSpecification(structuredSelection);
	...
	private void S_DPK_NewConstantSpecification(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Constant Specification");
		try {
			...
			if ((!(v_dPkg == null))) {
				...
				if (v_dPkg != null) {
					v_dPkg.Newconstantspecification();
				} else {
			...
			CorePlugin.logError(
					"Transaction: New Constant Specification failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewConstantSpecificationOnS_DPKAction
