...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnS_SPARMAction.java
//
...
public class MoveDownOnS_SPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnS_SPARMAction.
	 */
	public MoveDownOnS_SPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SPARM_MoveDown(structuredSelection);
	...
	private void S_SPARM_MoveDown(IStructuredSelection selection) {
		...
		FunctionParameter_c v_item = (FunctionParameter_c) context;
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Function Parameter Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Function Parameter Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnS_SPARMAction
