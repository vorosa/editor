...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewActorOnUC_UCCAction.java
//
...
public class NewActorOnUC_UCCAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewActorOnUC_UCCAction.
	 */
	public NewActorOnUC_UCCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		UC_UCC_NewActor(structuredSelection);
	...
	private void UC_UCC_NewActor(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Actor");
		try {
			...
			CorePlugin.logError("Transaction: New Actor failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewActorOnUC_UCCAction
