...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageAssignEventOnSM_CRTXNAction.java
//
...
public class SpecializedPackageAssignEventOnSM_CRTXNAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageAssignEventOnSM_CRTXNAction.
	 */
	public SpecializedPackageAssignEventOnSM_CRTXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_CRTXN_SpecializedPackageAssignEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_CRTXN_SpecializedPackageAssignEvent(
			IStructuredSelection selection) {
		SpecializedPackageAssignEventOnSM_CRTXNWizard wizard = new SpecializedPackageAssignEventOnSM_CRTXNWizard();
...
} // end SpecializedPackageAssignEventOnSM_CRTXNAction
