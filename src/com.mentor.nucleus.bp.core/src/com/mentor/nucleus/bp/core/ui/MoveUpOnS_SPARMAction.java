...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnS_SPARMAction.java
//
...
public class MoveUpOnS_SPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnS_SPARMAction.
	 */
	public MoveUpOnS_SPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SPARM_MoveUp(structuredSelection);
	...
	private void S_SPARM_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Function Parameter Move Up");
		try {
			...
			CorePlugin.logError(
					"Transaction: Function Parameter Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnS_SPARMAction
