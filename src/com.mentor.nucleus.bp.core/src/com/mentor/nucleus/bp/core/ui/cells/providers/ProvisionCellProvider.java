//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ProvisionCellProvider.java
//
...
public class ProvisionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Provision_c) element).getDescrip()) )
            {
                ((Provision_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((Provision_c) element).getInformalname()) )
            {
                ((Provision_c) element).setInformalname(value.toString());
            }
        }
