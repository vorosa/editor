...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageExternalEntityFormalizeOnSQ_EEPAction.java
//
...
public class SpecializedPackageExternalEntityFormalizeOnSQ_EEPAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageExternalEntityFormalizeOnSQ_EEPAction.
	 */
	public SpecializedPackageExternalEntityFormalizeOnSQ_EEPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SQ_EEP_SpecializedPackageExternalEntityFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog SQ_EEP_SpecializedPackageExternalEntityFormalize(
			IStructuredSelection selection) {
		SpecializedPackageExternalEntityFormalizeOnSQ_EEPWizard wizard = new SpecializedPackageExternalEntityFormalizeOnSQ_EEPWizard();
...
} // end SpecializedPackageExternalEntityFormalizeOnSQ_EEPAction
