...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewAttributeOnO_OBJAction.java
//
...
public class NewAttributeOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewAttributeOnO_OBJAction.
	 */
	public NewAttributeOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_NewAttribute(structuredSelection);
	...
	private void O_OBJ_NewAttribute(IStructuredSelection selection) {
		...
		try {
			...
			java.util.UUID v_newAttr_id = v_clazz.Newattribute();

			NonRootModelElement[] children = Attribute_c
					.getManyO_ATTRsOnR102(v_clazz)
