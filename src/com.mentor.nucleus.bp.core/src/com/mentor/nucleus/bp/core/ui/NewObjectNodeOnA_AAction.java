...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewObjectNodeOnA_AAction.java
//
...
public class NewObjectNodeOnA_AAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewObjectNodeOnA_AAction.
	 */
	public NewObjectNodeOnA_AAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		A_A_NewObjectNode(structuredSelection);
	...
	private void A_A_NewObjectNode(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Object Node");
		try {
			...
			CorePlugin.logError("Transaction: New Object Node failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewObjectNodeOnA_AAction
