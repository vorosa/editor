...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ComponentFormalizeOnC_CAction.java
//
...
public class ComponentFormalizeOnC_CAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for ComponentFormalizeOnC_CAction.
	 */
	public ComponentFormalizeOnC_CAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = C_C_ComponentFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog C_C_ComponentFormalize(IStructuredSelection selection) {
		ComponentFormalizeOnC_CWizard wizard = new ComponentFormalizeOnC_CWizard();
...
} // end ComponentFormalizeOnC_CAction
