...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageCantHappenInStateOnSM_EVTAction.java
//
...
public class GenericPackageCantHappenInStateOnSM_EVTAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageCantHappenInStateOnSM_EVTAction.
	 */
	public GenericPackageCantHappenInStateOnSM_EVTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_EVT_GenericPackageCantHappenInState(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_EVT_GenericPackageCantHappenInState(
			IStructuredSelection selection) {
		GenericPackageCantHappenInStateOnSM_EVTWizard wizard = new GenericPackageCantHappenInStateOnSM_EVTWizard();
...
} // end GenericPackageCantHappenInStateOnSM_EVTAction
