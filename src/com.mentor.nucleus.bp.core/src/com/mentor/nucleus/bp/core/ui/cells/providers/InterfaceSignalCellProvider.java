//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InterfaceSignalCellProvider.java
//
...
public class InterfaceSignalCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((InterfaceSignal_c) element).getName()) )
            {
                ((InterfaceSignal_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((InterfaceSignal_c) element).getDescrip()) )
            {
                ((InterfaceSignal_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Direction"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((InterfaceSignal_c) element).getDirection() )
            {
                ((InterfaceSignal_c) element).setDirection(new_val);
            }
        }
