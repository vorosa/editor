...
//====================================================================
//
// File:    CommunicationFunctionFormalizeOnMSG_SMWizardPage4.java
//
...
public class CommunicationFunctionFormalizeOnMSG_SMWizardPage4
		extends
	...
	/**
	 * Constructors for CommunicationFunctionFormalizeOnMSG_SMWizardPage4.
	 */
	public CommunicationFunctionFormalizeOnMSG_SMWizardPage4() {
		super("");
		init();
	}

	public CommunicationFunctionFormalizeOnMSG_SMWizardPage4(String name) {
		super(name);
		init();
	}
	...
	public void updateSelectedMessage() {
		...
		((CommunicationFunctionFormalizeOnMSG_SMWizard) getWizard()).v_Message = this.Message;
	}
	...
	public IWizardPage getNextPage() {
		((CommunicationFunctionFormalizeOnMSG_SMWizard) getWizard()).v_Message = Message;
