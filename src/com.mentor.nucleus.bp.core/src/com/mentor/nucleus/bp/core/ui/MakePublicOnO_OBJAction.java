...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnO_OBJAction.java
//
...
public class MakePublicOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnO_OBJAction.
	 */
	public MakePublicOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_MakePublic(structuredSelection);
	...
	private void O_OBJ_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Model Class Make Public");
		try {
			...
			CorePlugin.logError(
					"Transaction: Model Class Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnO_OBJAction
