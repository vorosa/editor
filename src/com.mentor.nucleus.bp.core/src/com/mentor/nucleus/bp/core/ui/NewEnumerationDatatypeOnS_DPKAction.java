...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewEnumerationDatatypeOnS_DPKAction.java
//
...
public class NewEnumerationDatatypeOnS_DPKAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewEnumerationDatatypeOnS_DPKAction.
	 */
	public NewEnumerationDatatypeOnS_DPKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_DPK_NewEnumerationDatatype(structuredSelection);
	...
	private void S_DPK_NewEnumerationDatatype(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Enumeration DataType");
		try {
			...
			CorePlugin.logError(
					"Transaction: New Enumeration DataType failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewEnumerationDatatypeOnS_DPKAction
