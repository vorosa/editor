...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetReturnTypeOnS_BRGAction.java
//
...
public class SetReturnTypeOnS_BRGAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetReturnTypeOnS_BRGAction.
	 */
	public SetReturnTypeOnS_BRGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_BRG_SetReturnType(structuredSelection);
	}
	/**
	...
	public static void S_BRG_SetReturnType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      Bridge_c v_element = (Bridge_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR20(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ExternalEntity_c.getOneS_EEOnR19(v_element));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (Bridge_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR20(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR20From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR20To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(Bridge_c v_element) {
  ...
  } // end getElements(Bridge_c) 
} // end SetReturnTypeOnS_BRGAction
