//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ClassAsAssociatedOneSideCellProvider.java
//
...
public class ClassAsAssociatedOneSideCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(ClassAsAssociatedOneSide_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((ClassAsAssociatedOneSide_c) element));
                	return editor;
                }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Mult"))
        {
            ...
            if ( new_val != ((ClassAsAssociatedOneSide_c) element).getMult() )
            {
                ((ClassAsAssociatedOneSide_c) element).setMult(new_val);
            }
        }
        if(data.getName().equals("Cond"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((ClassAsAssociatedOneSide_c) element).getCond() )
            {
                ((ClassAsAssociatedOneSide_c) element).setCond(new_val);
            }
        }
        if(data.getName().equals("Txt_Phrs"))
        {
            if ( ! value.toString().equals(((ClassAsAssociatedOneSide_c) element).getTxt_phrs()) )
            {
                ((ClassAsAssociatedOneSide_c) element).setTxt_phrs(value.toString());
            }
        }
