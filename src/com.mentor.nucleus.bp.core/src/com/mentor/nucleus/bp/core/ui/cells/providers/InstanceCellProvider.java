//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InstanceCellProvider.java
//
...
public class InstanceCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Instance_c) element).getName()) )
            {
                ((Instance_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Default_Name"))
        {
            if ( ! value.toString().equals(((Instance_c) element).getDefault_name()) )
            {
                ((Instance_c) element).setDefault_name(value.toString());
            }
        }
