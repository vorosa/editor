...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetFromProviderOnC_ASAction.java
//
...
public class SetFromProviderOnC_ASAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetFromProviderOnC_ASAction.
	 */
	public SetFromProviderOnC_ASAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_AS_SetFromProvider(structuredSelection);
	...
	private void C_AS_SetFromProvider(IStructuredSelection selection) {
		...
		InterfaceSignal_c v_is = (InterfaceSignal_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_is
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Signal Set From Provider");
		try {
			...
			if (((v_is != null))) {
				...
				if (v_is != null) {
					v_is.setDirection(Ifdirectiontype_c.ServerClient);
				} else {
			...
			CorePlugin
					.logError(
							"Transaction: Interface Signal Set From Provider failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetFromProviderOnC_ASAction
