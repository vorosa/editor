...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InterfaceOperationFormalizeOnMSG_SMAction.java
//
...
public class InterfaceOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for InterfaceOperationFormalizeOnMSG_SMAction.
	 */
	public InterfaceOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_InterfaceOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_InterfaceOperationFormalize(
			IStructuredSelection selection) {
		InterfaceOperationFormalizeOnMSG_SMWizard wizard = new InterfaceOperationFormalizeOnMSG_SMWizard();
...
} // end InterfaceOperationFormalizeOnMSG_SMAction
