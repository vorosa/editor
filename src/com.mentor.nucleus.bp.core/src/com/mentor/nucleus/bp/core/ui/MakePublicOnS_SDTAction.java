...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnS_SDTAction.java
//
...
public class MakePublicOnS_SDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnS_SDTAction.
	 */
	public MakePublicOnS_SDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SDT_MakePublic(structuredSelection);
	...
	private void S_SDT_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Structured Data Type Make Public");
		try {
			...
			CorePlugin.logError(
					"Transaction: Structured Data Type Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnS_SDTAction
