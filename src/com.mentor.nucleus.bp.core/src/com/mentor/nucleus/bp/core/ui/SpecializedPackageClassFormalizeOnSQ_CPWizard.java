...
//====================================================================
//
// File:    SpecializedPackageClassFormalizeOnSQ_CPWizard.java
//
...
/**
 * SpecializedPackageClassFormalizeOnSQ_CPWizard class
 */
public class SpecializedPackageClassFormalizeOnSQ_CPWizard extends Wizard {
	...
	// wizard pages
	SpecializedPackageClassFormalizeOnSQ_CPWizardPage1 SQ_CP_SpecializedPackageClassFormalizePage1;
	SpecializedPackageClassFormalizeOnSQ_CPWizardPage2 SQ_CP_SpecializedPackageClassFormalizePage2;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SQ_CP_SPECIALIZEDPACKAGECLASSFORMALIZE0_WIZARD_STATE = 0;
	protected static final int SQ_CP_SPECIALIZEDPACKAGECLASSFORMALIZE1_WIZARD_STATE = 1;
	// member
	...
	/**
	 * Constructor for SpecializedPackageClassFormalizeOnSQ_CPWizard.
	 */
	public SpecializedPackageClassFormalizeOnSQ_CPWizard() {
		super();
	}
	...
	public void addPages() {
		SQ_CP_SpecializedPackageClassFormalizePage1 = new SpecializedPackageClassFormalizeOnSQ_CPWizardPage1(
				"SpecializedPackageClassFormalizeOnSQ_CPWizardPage1");
		addPage(SQ_CP_SpecializedPackageClassFormalizePage1);
		SQ_CP_SpecializedPackageClassFormalizePage2 = new SpecializedPackageClassFormalizeOnSQ_CPWizardPage2(
				"SpecializedPackageClassFormalizeOnSQ_CPWizardPage2");
		addPage(SQ_CP_SpecializedPackageClassFormalizePage2);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SQ_CP_SpecializedPackageClassFormalizePage1.isPageComplete();
		pagesComplete = pagesComplete
				&& SQ_CP_SpecializedPackageClassFormalizePage2.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SQ_CP_SPECIALIZEDPACKAGECLASSFORMALIZE0_WIZARD_STATE :
				m_state = pages
						.indexOf(SQ_CP_SpecializedPackageClassFormalizePage2);
				SQ_CP_SpecializedPackageClassFormalizePage2.onPageEntry();
				return SQ_CP_SpecializedPackageClassFormalizePage2;

			case SQ_CP_SPECIALIZEDPACKAGECLASSFORMALIZE1_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Specialized Package Class Formalize"); //$NON-NLS-1$
			...
			if (((v_Subsystem != null))) {
				...
				if (((v_Class != null))) {
					...
					if (v_cp != null) {
						v_cp.Formalize(v_Class.getObj_id());
					} else {
			...
			CorePlugin
					.logError(
							"Transaction: Specialized Package Class Formalize failed", e);//$NON-NLS-1$
