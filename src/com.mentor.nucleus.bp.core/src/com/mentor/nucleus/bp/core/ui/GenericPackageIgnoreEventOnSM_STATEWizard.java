...
//====================================================================
//
// File:    GenericPackageIgnoreEventOnSM_STATEWizard.java
//
...
/**
 * GenericPackageIgnoreEventOnSM_STATEWizard class
 */
public class GenericPackageIgnoreEventOnSM_STATEWizard extends Wizard {
	...
	// wizard pages
	GenericPackageIgnoreEventOnSM_STATEWizardPage1 SM_STATE_GenericPackageIgnoreEventPage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_STATE_GENERICPACKAGEIGNOREEVENT0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for GenericPackageIgnoreEventOnSM_STATEWizard.
	 */
	public GenericPackageIgnoreEventOnSM_STATEWizard() {
		super();
	}
	...
	public void addPages() {
		SM_STATE_GenericPackageIgnoreEventPage1 = new GenericPackageIgnoreEventOnSM_STATEWizardPage1(
				"GenericPackageIgnoreEventOnSM_STATEWizardPage1");
		addPage(SM_STATE_GenericPackageIgnoreEventPage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_STATE_GenericPackageIgnoreEventPage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_STATE_GENERICPACKAGEIGNOREEVENT0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Generic Package Ignore Event"); //$NON-NLS-1$
			...
			CorePlugin.logError(
					"Transaction: Generic Package Ignore Event failed", e);//$NON-NLS-1$
