//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InterfacePackageCellProvider.java
//
...
public class InterfacePackageCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((InterfacePackage_c) element).getName()) )
            {
                ((InterfacePackage_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((InterfacePackage_c) element).getDescrip()) )
            {
                ((InterfacePackage_c) element).setDescrip(value.toString());
            }
        }
