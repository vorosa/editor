...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewUseCaseDiagramOnUC_UCCAction.java
//
...
public class NewUseCaseDiagramOnUC_UCCAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewUseCaseDiagramOnUC_UCCAction.
	 */
	public NewUseCaseDiagramOnUC_UCCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		UC_UCC_NewUseCaseDiagram(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"UseCaseDiagram_c", false));
	}
	private void UC_UCC_NewUseCaseDiagram(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Use Case diagram");
		try {
			...
			CorePlugin.logError("Transaction: New Use Case diagram failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewUseCaseDiagramOnUC_UCCAction
