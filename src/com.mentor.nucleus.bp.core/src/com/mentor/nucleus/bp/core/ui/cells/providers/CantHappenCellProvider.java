//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/CantHappenCellProvider.java
//
...
public class CantHappenCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((CantHappen_c) element).getDescrip()) )
            {
                ((CantHappen_c) element).setDescrip(value.toString());
            }
        }
