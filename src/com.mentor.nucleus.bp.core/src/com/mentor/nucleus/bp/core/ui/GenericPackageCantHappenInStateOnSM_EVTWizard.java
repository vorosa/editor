...
//====================================================================
//
// File:    GenericPackageCantHappenInStateOnSM_EVTWizard.java
//
...
/**
 * GenericPackageCantHappenInStateOnSM_EVTWizard class
 */
public class GenericPackageCantHappenInStateOnSM_EVTWizard extends Wizard {
	...
	// wizard pages
	GenericPackageCantHappenInStateOnSM_EVTWizardPage1 SM_EVT_GenericPackageCantHappenInStatePage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_EVT_GENERICPACKAGECANTHAPPENINSTATE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for GenericPackageCantHappenInStateOnSM_EVTWizard.
	 */
	public GenericPackageCantHappenInStateOnSM_EVTWizard() {
		super();
	}
	...
	public void addPages() {
		SM_EVT_GenericPackageCantHappenInStatePage1 = new GenericPackageCantHappenInStateOnSM_EVTWizardPage1(
				"GenericPackageCantHappenInStateOnSM_EVTWizardPage1");
		addPage(SM_EVT_GenericPackageCantHappenInStatePage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_EVT_GenericPackageCantHappenInStatePage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_EVT_GENERICPACKAGECANTHAPPENINSTATE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Generic Package Cant Happen in State"); //$NON-NLS-1$
			...
			CorePlugin
					.logError(
							"Transaction: Generic Package Cant Happen in State failed", e);//$NON-NLS-1$
