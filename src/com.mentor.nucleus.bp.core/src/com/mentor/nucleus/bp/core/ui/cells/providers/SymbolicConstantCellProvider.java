//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SymbolicConstantCellProvider.java
//
...
public class SymbolicConstantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((SymbolicConstant_c) element).getName()) )
            {
                ((SymbolicConstant_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((SymbolicConstant_c) element).getDescrip()) )
            {
                ((SymbolicConstant_c) element).setDescrip(value.toString());
            }
        }
