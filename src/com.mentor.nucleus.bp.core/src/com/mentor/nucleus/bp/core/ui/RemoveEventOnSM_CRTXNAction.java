...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/RemoveEventOnSM_CRTXNAction.java
//
...
public class RemoveEventOnSM_CRTXNAction implements IObjectActionDelegate {

	/**
	 * Constructor for RemoveEventOnSM_CRTXNAction.
	 */
	public RemoveEventOnSM_CRTXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_CRTXN_RemoveEvent(structuredSelection);
	...
	private void SM_CRTXN_RemoveEvent(IStructuredSelection selection) {
		...
		CreationTransition_c v_crtxn = (CreationTransition_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_crtxn
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Creation Transition Remove Event");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			Transition_c v_txn = Transition_c.getOneSM_TXNOnR507(v_crtxn);
			...
			CorePlugin.logError(
					"Transaction: Creation Transition Remove Event failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end RemoveEventOnSM_CRTXNAction
