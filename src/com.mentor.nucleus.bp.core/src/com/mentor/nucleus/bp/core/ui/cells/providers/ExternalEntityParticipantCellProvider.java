//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ExternalEntityParticipantCellProvider.java
//
...
public class ExternalEntityParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((ExternalEntityParticipant_c) element).getInformalname()) )
            {
                ((ExternalEntityParticipant_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ExternalEntityParticipant_c) element).getDescrip()) )
            {
                ((ExternalEntityParticipant_c) element).setDescrip(value.toString());
            }
        }
