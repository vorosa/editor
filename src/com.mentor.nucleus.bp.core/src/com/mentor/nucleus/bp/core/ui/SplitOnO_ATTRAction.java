...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SplitOnO_ATTRAction.java
//
...
public class SplitOnO_ATTRAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SplitOnO_ATTRAction.
	 */
	public SplitOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = O_ATTR_Split(structuredSelection);
		wd.open();
	...
	public WizardDialog O_ATTR_Split(IStructuredSelection selection) {
		SplitOnO_ATTRWizard wizard = new SplitOnO_ATTRWizard();
