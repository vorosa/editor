...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnC_ASAction.java
//
...
public class MoveUpOnC_ASAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnC_ASAction.
	 */
	public MoveUpOnC_ASAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_AS_MoveUp(structuredSelection);
	...
	private void C_AS_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Signal Move Up");
		try {
			...
			CorePlugin.logError(
					"Transaction: Interface Signal Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnC_ASAction
