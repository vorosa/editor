//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/OperationParameterCellProvider.java
//
...
public class OperationParameterCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((OperationParameter_c) element).getName()) )
            {
                ((OperationParameter_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("By_Ref"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((OperationParameter_c) element).getBy_ref() )
            {
                ((OperationParameter_c) element).setBy_ref(new_val);
            }
        }
        if(data.getName().equals("Dimensions"))
        {
            if ( ! value.toString().equals(((OperationParameter_c) element).getDimensions()) )
            {
                Vector dims = DimensionsUtil.getDimensionsData(value.toString(),(OperationParameter_c) element);
                if (dims.size() > 0) {
                    for (int i = 0; i < dims.size(); i++) {
                        int numElements = ((Integer)dims.get(i)).intValue();
                        ((OperationParameter_c) element).Resizedimensions(i, numElements, dims.size());
                    }
                } else {
                    ((OperationParameter_c) element).Resizedimensions(0, 0, 0);
                }
                ((OperationParameter_c) element).setDimensions(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((OperationParameter_c) element).getDescrip()) )
            {
                ((OperationParameter_c) element).setDescrip(value.toString());
            }
        }
