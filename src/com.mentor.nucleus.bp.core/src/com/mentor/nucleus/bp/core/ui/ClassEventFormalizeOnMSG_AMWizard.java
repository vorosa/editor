...
//====================================================================
//
// File:    ClassEventFormalizeOnMSG_AMWizard.java
//
...
/**
 * ClassEventFormalizeOnMSG_AMWizard class
 */
public class ClassEventFormalizeOnMSG_AMWizard extends Wizard {
	...
	// wizard pages
	ClassEventFormalizeOnMSG_AMWizardPage2 MSG_AM_ClassEventFormalizePage2;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int MSG_AM_CLASSEVENTFORMALIZE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for ClassEventFormalizeOnMSG_AMWizard.
	 */
	public ClassEventFormalizeOnMSG_AMWizard() {
		super();
	}
	...
	public void addPages() {
		MSG_AM_ClassEventFormalizePage2 = new ClassEventFormalizeOnMSG_AMWizardPage2(
				"ClassEventFormalizeOnMSG_AMWizardPage2");
		addPage(MSG_AM_ClassEventFormalizePage2);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& MSG_AM_ClassEventFormalizePage2.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case MSG_AM_CLASSEVENTFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() 
	{
		...
		try {
			transactionGroup = TransactionUtil.startTransactionsOnSelectedModelRoots(
				"Class Event Formalize"); //$NON-NLS-1$
...
v_Message.getSmevt_id() ) ;
  ...
  CorePlugin.logError("Attempted to call an operation on a null instance.", t);
    ...
    // catch all exceptions and cancel the transaction
			...
			CorePlugin.logError("Transaction: Class Event Formalize failed", e);//$NON-NLS-1$
