//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/LifespanCellProvider.java
//
...
public class LifespanCellProvider implements ICellProvider {
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("Destroyed")) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Lifespan_c) element).getDescrip()) )
            {
                ((Lifespan_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Destroyed"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((Lifespan_c) element).getDestroyed() )
            {
                ((Lifespan_c) element).setDestroyed(new_val);
            }
        }
