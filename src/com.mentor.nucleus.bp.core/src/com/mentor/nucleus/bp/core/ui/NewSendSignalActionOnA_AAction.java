...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewSendSignalActionOnA_AAction.java
//
...
public class NewSendSignalActionOnA_AAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewSendSignalActionOnA_AAction.
	 */
	public NewSendSignalActionOnA_AAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		A_A_NewSendSignalAction(structuredSelection);
	...
	private void A_A_NewSendSignalAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Send Signal Action");
		try {
			...
			CorePlugin
					.logError("Transaction: New Send Signal Action failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewSendSignalActionOnA_AAction
