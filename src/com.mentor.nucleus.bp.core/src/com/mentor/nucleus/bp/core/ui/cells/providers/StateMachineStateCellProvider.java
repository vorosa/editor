//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/StateMachineStateCellProvider.java
//
...
public class StateMachineStateCellProvider implements ICellProvider {
    private String[] Final_vals = { "Non-final state",
        "Final state" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("Final")) {
                	CellEditor editor = new EnumCellEditor(parent, Final_vals);
                	return editor;
                }
	...
	public String getValue(NonRootModelElement element, ObjectElement data) {
		if(data.getName().equals("Final")) {
	        Integer Final_value = (Integer) data.getValue();
			if(Final_value >= 0 && Final_value < Final_vals.length) {
				return Final_vals[Final_value];
			}
		}
		return null;
	}
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((StateMachineState_c) element).getName()) )
            {
                ((StateMachineState_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Numb"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((StateMachineState_c) element).getNumb() )
            {
                ((StateMachineState_c) element).setNumb(new_val);
            }
        }
        if(data.getName().equals("Final"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((StateMachineState_c) element).getFinal() )
            {
                ((StateMachineState_c) element).setFinal(new_val);
            }
        }
