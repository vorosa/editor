//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/DomainCellProvider.java
//
...
public class DomainCellProvider implements ICellProvider {
    private String[] Full_Der_vals = { "Partially Derived",
        "Fully Derived" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("Full_Der")) {
                	CellEditor editor = new EnumCellEditor(parent, Full_Der_vals);
                	return editor;
                }
	...
	public String getValue(NonRootModelElement element, ObjectElement data) {
		if(data.getName().equals("Full_Der")) {
	        Integer Full_Der_value = (Integer) data.getValue();
			if(Full_Der_value >= 0 && Full_Der_value < Full_Der_vals.length) {
				return Full_Der_vals[Full_Der_value];
			}
		}
		return null;
	}
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Domain_c) element).getName()) )
            {
                ((Domain_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Domain_c) element).getDescrip()) )
            {
                ((Domain_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Full_Der"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Domain_c) element).getFull_der() )
            {
                ((Domain_c) element).setFull_der(new_val);
            }
        }
