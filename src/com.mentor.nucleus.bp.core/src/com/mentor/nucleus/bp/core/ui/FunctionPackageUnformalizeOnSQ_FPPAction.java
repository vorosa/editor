...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/FunctionPackageUnformalizeOnSQ_FPPAction.java
//
...
public class FunctionPackageUnformalizeOnSQ_FPPAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for FunctionPackageUnformalizeOnSQ_FPPAction.
	 */
	public FunctionPackageUnformalizeOnSQ_FPPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_FPP_FunctionPackageUnformalize(structuredSelection);
	...
	private void SQ_FPP_FunctionPackageUnformalize(
		...
		FunctionPackageParticipant_c v_fpp = (FunctionPackageParticipant_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_fpp
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Function Package Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Function Package Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end FunctionPackageUnformalizeOnSQ_FPPAction
