...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationSignalFormalizeOnMSG_AMAction.java
//
...
public class CommunicationSignalFormalizeOnMSG_AMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationSignalFormalizeOnMSG_AMAction.
	 */
	public CommunicationSignalFormalizeOnMSG_AMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_AM_CommunicationSignalFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_AM_CommunicationSignalFormalize(
			IStructuredSelection selection) {
		CommunicationSignalFormalizeOnMSG_AMWizard wizard = new CommunicationSignalFormalizeOnMSG_AMWizard();
...
} // end CommunicationSignalFormalizeOnMSG_AMAction
