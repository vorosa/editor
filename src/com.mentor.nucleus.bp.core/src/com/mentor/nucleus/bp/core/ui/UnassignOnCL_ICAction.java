...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UnassignOnCL_ICAction.java
//
...
public class UnassignOnCL_ICAction implements IObjectActionDelegate {

	/**
	 * Constructor for UnassignOnCL_ICAction.
	 */
	public UnassignOnCL_ICAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CL_IC_Unassign(structuredSelection);
	...
	private void CL_IC_Unassign(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      ComponentReference_c v_icomp = (ComponentReference_c)context;
      PersistableModelComponent.ensureCoreDataTypesAvailable(v_icomp.getModelRoot());
        

	TransactionUtil.TransactionGroup transactionGroup = 
		TransactionUtil.startTransactionsOnSelectedModelRoots("Component Reference Unassign");
    try {
        // Ensure that actions take place between Verifier Activity executions
		Ooaofooa.beginSaveOperation();
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_icomp = (ComponentReference_c) iterator.next();
	if ( (  (v_icomp != null)) )
{
...
v_icomp.Unassign() ;
  ...
  CorePlugin.logError("Attempted to call an operation on a null instance.", t);
	...
	// catch all exceptions and cancel the transactions
    	...
    	CorePlugin.logError("Transaction: Component Reference Unassign failed", e);//$NON-NLS-1$
	}
	      TransactionUtil.endTransactions(transactionGroup);

  }
} // end UnassignOnCL_ICAction
