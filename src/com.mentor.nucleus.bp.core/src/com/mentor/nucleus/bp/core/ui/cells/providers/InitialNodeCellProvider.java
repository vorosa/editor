//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InitialNodeCellProvider.java
//
...
public class InitialNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((InitialNode_c) element).getDescrip()) )
            {
                ((InitialNode_c) element).setDescrip(value.toString());
            }
        }
