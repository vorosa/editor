...
//====================================================================
//
// File:    SpecializedPackageInstanceFormalizeOnSQ_CIPWizardPage1.java
//
...
public class SpecializedPackageInstanceFormalizeOnSQ_CIPWizardPage1
		extends
	...
	/**
	 * Constructors for SpecializedPackageInstanceFormalizeOnSQ_CIPWizardPage1.
	 */
	public SpecializedPackageInstanceFormalizeOnSQ_CIPWizardPage1() {
		super("");
		init();
	}

	public SpecializedPackageInstanceFormalizeOnSQ_CIPWizardPage1(String name) {
		super(name);
		init();
	}
	...
	private void init() {
		setTitle("Formalize");
		setDescription("Choose the class that this instance should represent");
	}

	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((SpecializedPackageInstanceFormalizeOnSQ_CIPWizard) getWizard())
						.getSelection());

		// cache for previous user selections
		ModelClass_c v_Class = ((SpecializedPackageInstanceFormalizeOnSQ_CIPWizard) getWizard()).v_Class;

		// cache for context
		ClassInstanceParticipant_c v_cip = ((SpecializedPackageInstanceFormalizeOnSQ_CIPWizard) getWizard()).v_cip;
	...
	public void updateSelectedSubsystem() {
		...
		((SpecializedPackageInstanceFormalizeOnSQ_CIPWizard) getWizard()).v_Subsystem = this.Subsystem;
	}
	...
	public IWizardPage getNextPage() {
		((SpecializedPackageInstanceFormalizeOnSQ_CIPWizard) getWizard()).v_Subsystem = Subsystem;
