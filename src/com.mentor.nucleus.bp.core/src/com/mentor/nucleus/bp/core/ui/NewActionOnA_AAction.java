...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewActionOnA_AAction.java
//
...
public class NewActionOnA_AAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewActionOnA_AAction.
	 */
	public NewActionOnA_AAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		A_A_NewAction(structuredSelection);
	...
	private void A_A_NewAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Action");
		try {
			...
			CorePlugin.logError("Transaction: New Action failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewActionOnA_AAction
