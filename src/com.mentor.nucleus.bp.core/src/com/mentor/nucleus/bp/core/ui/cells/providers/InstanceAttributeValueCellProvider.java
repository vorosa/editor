//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InstanceAttributeValueCellProvider.java
//
...
public class InstanceAttributeValueCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Value"))
        {
            if ( ! value.toString().equals(((InstanceAttributeValue_c) element).getValue()) )
            {
                ((InstanceAttributeValue_c) element).setValue(value.toString());
            }
        }
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((InstanceAttributeValue_c) element).getInformalname()) )
            {
                ((InstanceAttributeValue_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((InstanceAttributeValue_c) element).getDescrip()) )
            {
                ((InstanceAttributeValue_c) element).setDescrip(value.toString());
            }
        }
