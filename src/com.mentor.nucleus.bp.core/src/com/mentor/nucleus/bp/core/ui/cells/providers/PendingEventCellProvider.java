//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/PendingEventCellProvider.java
//
...
public class PendingEventCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("isExecuting"))
        {
            ...
            if ( new_val != ((PendingEvent_c) element).getIsexecuting() )
            {
                ((PendingEvent_c) element).setIsexecuting(new_val);
            }
        }
        if(data.getName().equals("isCreation"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((PendingEvent_c) element).getIscreation() )
            {
                ((PendingEvent_c) element).setIscreation(new_val);
            }
        }
