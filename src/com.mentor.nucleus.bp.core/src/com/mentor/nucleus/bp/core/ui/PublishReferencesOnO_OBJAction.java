...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/PublishReferencesOnO_OBJAction.java
//
...
// creates new Publish Referencess.
//
...
public class PublishReferencesOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for PublishReferencesOnO_OBJAction.
	 */
	public PublishReferencesOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_PublishReferences(structuredSelection);
	...
	private void O_OBJ_PublishReferences(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Model Class Publish References");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_clazz != null) {
				v_clazz.Newinstancereferencedatatype();
			} else {
			...
			CorePlugin.logError(
					"Transaction: Model Class Publish References failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end PublishReferencesOnO_OBJAction
