...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageRequiredInterfaceFormalizeOnC_RAction.java
//
...
public class SpecializedPackageRequiredInterfaceFormalizeOnC_RAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageRequiredInterfaceFormalizeOnC_RAction.
	 */
	public SpecializedPackageRequiredInterfaceFormalizeOnC_RAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = C_R_SpecializedPackageRequiredInterfaceFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog C_R_SpecializedPackageRequiredInterfaceFormalize(
			IStructuredSelection selection) {
		SpecializedPackageRequiredInterfaceFormalizeOnC_RWizard wizard = new SpecializedPackageRequiredInterfaceFormalizeOnC_RWizard();
...
} // end SpecializedPackageRequiredInterfaceFormalizeOnC_RAction
