...
//====================================================================
//
// File:    InstanceOperationFormalizeOnMSG_SMWizard.java
//
...
/**
 * InstanceOperationFormalizeOnMSG_SMWizard class
 */
public class InstanceOperationFormalizeOnMSG_SMWizard extends Wizard {
	...
	// wizard pages
	InstanceOperationFormalizeOnMSG_SMWizardPage2 MSG_SM_InstanceOperationFormalizePage2;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int MSG_SM_INSTANCEOPERATIONFORMALIZE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for InstanceOperationFormalizeOnMSG_SMWizard.
	 */
	public InstanceOperationFormalizeOnMSG_SMWizard() {
		super();
	}
	...
	public void addPages() {
		MSG_SM_InstanceOperationFormalizePage2 = new InstanceOperationFormalizeOnMSG_SMWizardPage2(
				"InstanceOperationFormalizeOnMSG_SMWizardPage2");
		addPage(MSG_SM_InstanceOperationFormalizePage2);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& MSG_SM_InstanceOperationFormalizePage2.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case MSG_SM_INSTANCEOPERATIONFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Instance Operation Formalize"); //$NON-NLS-1$
			...
			CorePlugin.logError(
					"Transaction: Instance Operation Formalize failed", e);//$NON-NLS-1$
