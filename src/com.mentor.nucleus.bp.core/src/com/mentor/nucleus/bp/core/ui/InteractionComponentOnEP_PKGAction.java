...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionComponentOnEP_PKGAction.java
//
...
public class InteractionComponentOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for InteractionComponentOnEP_PKGAction.
	 */
	public InteractionComponentOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionComponent(structuredSelection);
	...
	private void EP_PKG_InteractionComponent(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction Component");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newcomponentparticipant();
			} else {
			...
			NonRootModelElement[] children = ComponentParticipant_c
			...
			CorePlugin.logError("Transaction: Interaction Component failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionComponentOnEP_PKGAction
