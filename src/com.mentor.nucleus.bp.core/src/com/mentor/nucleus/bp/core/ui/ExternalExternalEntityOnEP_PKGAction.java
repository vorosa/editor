...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ExternalExternalEntityOnEP_PKGAction.java
//
...
public class ExternalExternalEntityOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ExternalExternalEntityOnEP_PKGAction.
	 */
	public ExternalExternalEntityOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ExternalExternalEntity(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ExternalEntity_c", false));
	}
	private void EP_PKG_ExternalExternalEntity(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("External External Entity");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newexternalentity();
			} else {
			...
			NonRootModelElement[] children = ExternalEntity_c
			...
			CorePlugin.logError(
					"Transaction: External External Entity failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ExternalExternalEntityOnEP_PKGAction
