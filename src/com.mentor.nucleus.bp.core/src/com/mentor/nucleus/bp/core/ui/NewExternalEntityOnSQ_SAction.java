...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewExternalEntityOnSQ_SAction.java
//
...
public class NewExternalEntityOnSQ_SAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewExternalEntityOnSQ_SAction.
	 */
	public NewExternalEntityOnSQ_SAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_S_NewExternalEntity(structuredSelection);
	...
	private void SQ_S_NewExternalEntity(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New External Entity");
		try {
			...
			if (((v_sequence != null))) {
				...
				if (v_sequence != null) {
					v_sequence.Newexternalentityparticipant();
				} else {
			...
			CorePlugin.logError("Transaction: New External Entity failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewExternalEntityOnSQ_SAction
