//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/DerivedBaseAttributeCellProvider.java
//
...
public class DerivedBaseAttributeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Suc_Pars"))
        {
            ...
            if ( new_val != ((DerivedBaseAttribute_c) element).getSuc_pars() )
            {
                ((DerivedBaseAttribute_c) element).setSuc_pars(new_val);
            }
        }
