//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/UserDataTypeCellProvider.java
//
...
public class UserDataTypeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Gen_Type"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((UserDataType_c) element).getGen_type() )
            {
                ((UserDataType_c) element).setGen_type(new_val);
            }
        }
        if(data.getName().equals("Visibility"))
        {
