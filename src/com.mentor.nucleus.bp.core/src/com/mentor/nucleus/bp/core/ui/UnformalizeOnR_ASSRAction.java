...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UnformalizeOnR_ASSRAction.java
//
...
public class UnformalizeOnR_ASSRAction implements IObjectActionDelegate {

	/**
	 * Constructor for UnformalizeOnR_ASSRAction.
	 */
	public UnformalizeOnR_ASSRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		R_ASSR_Unformalize(structuredSelection);
	...
	private void R_ASSR_Unformalize(IStructuredSelection selection) {
		...
		ClassAsLink_c v_assr = (ClassAsLink_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_assr
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Class As Link Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Class As Link Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end UnformalizeOnR_ASSRAction
