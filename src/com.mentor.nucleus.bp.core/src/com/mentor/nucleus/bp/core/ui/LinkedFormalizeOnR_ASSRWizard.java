...
//====================================================================
//
// File:    LinkedFormalizeOnR_ASSRWizard.java
//
...
/**
 * LinkedFormalizeOnR_ASSRWizard class
 */
public class LinkedFormalizeOnR_ASSRWizard extends Wizard {
	...
	// wizard pages
	LinkedFormalizeOnR_ASSRWizardPage1 R_ASSR_LinkedFormalizePage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int R_ASSR_LINKEDFORMALIZE0_WIZARD_STATE = 0;
	// member
	protected int m_state = INITIAL_WIZARD_STATE;
	// end wizard state

	// cache for contextual selections (public for use by unit tests)
	public ClassAsLink_c v_assr = null;
	...
	/**
	 * Constructor for LinkedFormalizeOnR_ASSRWizard.
	 */
	public LinkedFormalizeOnR_ASSRWizard() {
		super();
	}
	...
	public void addPages() {
		R_ASSR_LinkedFormalizePage1 = new LinkedFormalizeOnR_ASSRWizardPage1(
				"LinkedFormalizeOnR_ASSRWizardPage1");
		addPage(R_ASSR_LinkedFormalizePage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& R_ASSR_LinkedFormalizePage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case R_ASSR_LINKEDFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		ModelRoot modelRoot = v_assr.getModelRoot();
		try {
		...
		if (m_viewer != null) {
			if (m_viewer instanceof StructuredViewer) {
				((StructuredViewer) m_viewer).refresh(v_assr);
			} else {
				m_viewer.refresh();
			}
		}
