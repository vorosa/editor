...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationInstanceEventFormalizeOnMSG_AMAction.java
//
...
public class CommunicationInstanceEventFormalizeOnMSG_AMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationInstanceEventFormalizeOnMSG_AMAction.
	 */
	public CommunicationInstanceEventFormalizeOnMSG_AMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_AM_CommunicationInstanceEventFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_AM_CommunicationInstanceEventFormalize(
			IStructuredSelection selection) {
		CommunicationInstanceEventFormalizeOnMSG_AMWizard wizard = new CommunicationInstanceEventFormalizeOnMSG_AMWizard();
...
} // end CommunicationInstanceEventFormalizeOnMSG_AMAction
