//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ExtendCellProvider.java
//
...
public class ExtendCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Extend_c) element).getDescrip()) )
            {
                ((Extend_c) element).setDescrip(value.toString());
            }
        }
