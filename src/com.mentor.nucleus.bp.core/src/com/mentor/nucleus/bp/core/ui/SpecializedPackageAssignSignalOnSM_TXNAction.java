...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageAssignSignalOnSM_TXNAction.java
//
...
public class SpecializedPackageAssignSignalOnSM_TXNAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageAssignSignalOnSM_TXNAction.
	 */
	public SpecializedPackageAssignSignalOnSM_TXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_TXN_SpecializedPackageAssignSignal(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_TXN_SpecializedPackageAssignSignal(
			IStructuredSelection selection) {
		SpecializedPackageAssignSignalOnSM_TXNWizard wizard = new SpecializedPackageAssignSignalOnSM_TXNWizard();
...
} // end SpecializedPackageAssignSignalOnSM_TXNAction
