...
//====================================================================
//
// File:    GenericPackageCantHappenEventOnSM_STATEWizardPage1.java
//
...
public class GenericPackageCantHappenEventOnSM_STATEWizardPage1
		extends
	...
	/**
	 * Constructors for GenericPackageCantHappenEventOnSM_STATEWizardPage1.
	 */
	public GenericPackageCantHappenEventOnSM_STATEWizardPage1() {
		super("");
		init();
	}

	public GenericPackageCantHappenEventOnSM_STATEWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((GenericPackageCantHappenEventOnSM_STATEWizard) getWizard())
						.getSelection());

		// cache for context
		StateMachineState_c v_state = ((GenericPackageCantHappenEventOnSM_STATEWizard) getWizard()).v_state;
	...
	public void updateSelectedEvent() {
		...
		((GenericPackageCantHappenEventOnSM_STATEWizard) getWizard()).v_event = this.Event;
	}
	...
	public IWizardPage getNextPage() {
		((GenericPackageCantHappenEventOnSM_STATEWizard) getWizard()).v_event = Event;
