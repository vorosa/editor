...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewComponentReferenceOnC_CAction.java
//
...
public class NewComponentReferenceOnC_CAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewComponentReferenceOnC_CAction.
	 */
	public NewComponentReferenceOnC_CAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_C_NewComponentReference(structuredSelection);
	...
	private void C_C_NewComponentReference(IStructuredSelection selection) {
		...
		Component_c v_component = (Component_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_component
				.getModelRoot());
		PersistableModelComponent
				.ensureComponentCoreDataTypesAvailable(v_component);

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Component Reference");
		try {
			...
			if ((!(v_component == null))) {
				...
				if (v_component != null) {
					v_component.Newimportedcomponent();
				} else {
			...
			if (v_component.isInGenericPackage()) {
			...
			CorePlugin.logError(
					"Transaction: New Component Reference failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewComponentReferenceOnC_CAction
