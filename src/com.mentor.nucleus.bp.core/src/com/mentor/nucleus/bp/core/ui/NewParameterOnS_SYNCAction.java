...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewParameterOnS_SYNCAction.java
//
...
public class NewParameterOnS_SYNCAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewParameterOnS_SYNCAction.
	 */
	public NewParameterOnS_SYNCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SYNC_NewParameter(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"FunctionParameter_c", false));
	}
	private void S_SYNC_NewParameter(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = FunctionParameter_c
					.getManyS_SPARMsOnR24(v_fn)
...
} // end NewParameterOnS_SYNCAction
