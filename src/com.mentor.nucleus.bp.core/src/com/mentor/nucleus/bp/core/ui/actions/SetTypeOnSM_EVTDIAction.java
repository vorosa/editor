...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnSM_EVTDIAction.java
//
...
public class SetTypeOnSM_EVTDIAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnSM_EVTDIAction.
	 */
	public SetTypeOnSM_EVTDIAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_EVTDI_SetType(structuredSelection);
	}
	/**
	...
	public static void SM_EVTDI_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      StateMachineEventDataItem_c v_element = (StateMachineEventDataItem_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR524(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ModelClass_c.getOneO_OBJOnR519(ClassStateMachine_c.getOneSM_ASMOnR517(StateMachine_c.getOneSM_SMOnR516(v_element))));
	  if(pe == null) {
	  		pe = PackageableElement_c.getOnePE_PEOnR8001(ModelClass_c.getOneO_OBJOnR518(InstanceStateMachine_c.getOneSM_ISMOnR517(StateMachine_c.getOneSM_SMOnR516(v_element))));
	  }
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (StateMachineEventDataItem_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR524(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR524From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR524To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(StateMachineEventDataItem_c v_element) {
  ...
  } // end getElements(StateMachineEventDataItem_c) 
} // end SetTypeOnSM_EVTDIAction
