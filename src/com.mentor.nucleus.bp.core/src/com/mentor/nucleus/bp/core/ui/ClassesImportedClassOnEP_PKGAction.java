...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ClassesImportedClassOnEP_PKGAction.java
//
...
public class ClassesImportedClassOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ClassesImportedClassOnEP_PKGAction.
	 */
	public ClassesImportedClassOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ClassesImportedClass(structuredSelection);
	...
	private void EP_PKG_ClassesImportedClass(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Classes Imported Class");
		try {
			...
			CorePlugin
					.logError("Transaction: Classes Imported Class failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end ClassesImportedClassOnEP_PKGAction
