//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/FunctionPackageCellProvider.java
//
...
public class FunctionPackageCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((FunctionPackage_c) element).getName()) )
            {
                ((FunctionPackage_c) element).setName(value.toString());
            }
        }
