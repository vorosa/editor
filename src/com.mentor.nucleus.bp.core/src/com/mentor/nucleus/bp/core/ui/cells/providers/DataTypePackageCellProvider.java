//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/DataTypePackageCellProvider.java
//
...
public class DataTypePackageCellProvider implements ICellProvider {
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Name")) {
	                if (((DataTypePackage_c)element).Canrename()) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((DataTypePackage_c) element).getName()) )
            {
                ((DataTypePackage_c) element).setName(value.toString());
            }
        }
