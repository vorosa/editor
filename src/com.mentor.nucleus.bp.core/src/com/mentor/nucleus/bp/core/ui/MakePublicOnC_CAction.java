...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnC_CAction.java
//
...
public class MakePublicOnC_CAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnC_CAction.
	 */
	public MakePublicOnC_CAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_C_MakePublic(structuredSelection);
	...
	private void C_C_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Component Make Public");
		try {
			...
			CorePlugin.logError("Transaction: Component Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnC_CAction
