...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationBridgeOperationFormalizeOnMSG_SMAction.java
//
...
public class CommunicationBridgeOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationBridgeOperationFormalizeOnMSG_SMAction.
	 */
	public CommunicationBridgeOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationBridgeOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationBridgeOperationFormalize(
			IStructuredSelection selection) {
		CommunicationBridgeOperationFormalizeOnMSG_SMWizard wizard = new CommunicationBridgeOperationFormalizeOnMSG_SMWizard();
...
} // end CommunicationBridgeOperationFormalizeOnMSG_SMAction
