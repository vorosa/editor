//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/RequiredSignalCellProvider.java
//
...
public class RequiredSignalCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Suc_Pars"))
        {
            ...
            if ( new_val != ((RequiredSignal_c) element).getSuc_pars() )
            {
                ((RequiredSignal_c) element).setSuc_pars(new_val);
            }
        }
