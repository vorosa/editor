//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ObjectNodeCellProvider.java
//
...
public class ObjectNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ObjectNode_c) element).getName()) )
            {
                ((ObjectNode_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ObjectNode_c) element).getDescrip()) )
            {
                ((ObjectNode_c) element).setDescrip(value.toString());
            }
        }
