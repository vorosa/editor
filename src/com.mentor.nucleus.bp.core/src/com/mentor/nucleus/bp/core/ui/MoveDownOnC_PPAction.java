...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnC_PPAction.java
//
...
public class MoveDownOnC_PPAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnC_PPAction.
	 */
	public MoveDownOnC_PPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_PP_MoveDown(structuredSelection);
	...
	private void C_PP_MoveDown(IStructuredSelection selection) {
		...
		PropertyParameter_c v_item = (PropertyParameter_c) context;
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Property Parameter Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Property Parameter Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnC_PPAction
