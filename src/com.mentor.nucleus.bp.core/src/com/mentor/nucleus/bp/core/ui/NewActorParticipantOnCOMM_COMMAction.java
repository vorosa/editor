...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewActorParticipantOnCOMM_COMMAction.java
//
...
// creates new Actor Participants.
//
...
public class NewActorParticipantOnCOMM_COMMAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewActorParticipantOnCOMM_COMMAction.
	 */
	public NewActorParticipantOnCOMM_COMMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		COMM_COMM_NewActorParticipant(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ActorParticipant_c", false));
	}
	private void COMM_COMM_NewActorParticipant(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Actor Participant");
		try {
			...
			CorePlugin.logError("Transaction: New Actor Participant failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewActorParticipantOnCOMM_COMMAction
