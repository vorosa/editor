...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnO_ATTRAction.java
//
...
public class SetTypeOnO_ATTRAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnO_ATTRAction.
	 */
	public SetTypeOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_ATTR_SetType(structuredSelection);
	}
	/**
	...
	public static void O_ATTR_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      Attribute_c v_element = (Attribute_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR114(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ModelClass_c.getOneO_OBJOnR102(v_element));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (Attribute_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR114(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR114From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR114To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(Attribute_c v_element) {
  ...
  } // end getElements(Attribute_c) 
} // end SetTypeOnO_ATTRAction
