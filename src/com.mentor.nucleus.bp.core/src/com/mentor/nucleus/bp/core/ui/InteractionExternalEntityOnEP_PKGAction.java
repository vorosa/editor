...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InteractionExternalEntityOnEP_PKGAction.java
//
...
public class InteractionExternalEntityOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for InteractionExternalEntityOnEP_PKGAction.
	 */
	public InteractionExternalEntityOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_InteractionExternalEntity(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ExternalEntityParticipant_c", false));
	}
	private void EP_PKG_InteractionExternalEntity(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interaction External Entity");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newexternalentityparticipant();
			} else {
			...
			NonRootModelElement[] children = ExternalEntityParticipant_c
			...
			CorePlugin.logError(
					"Transaction: Interaction External Entity failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end InteractionExternalEntityOnEP_PKGAction
