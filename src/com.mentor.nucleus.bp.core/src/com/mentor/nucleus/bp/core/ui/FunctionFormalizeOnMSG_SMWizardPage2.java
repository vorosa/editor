...
//====================================================================
//
// File:    FunctionFormalizeOnMSG_SMWizardPage2.java
//
...
public class FunctionFormalizeOnMSG_SMWizardPage2 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for FunctionFormalizeOnMSG_SMWizardPage2.
	 */
	public FunctionFormalizeOnMSG_SMWizardPage2() {
		super("");
		init();
	}

	public FunctionFormalizeOnMSG_SMWizardPage2(String name) {
		super(name);
		init();
	}
