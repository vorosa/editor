...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageAssignEventOnSM_TXNAction.java
//
...
public class GenericPackageAssignEventOnSM_TXNAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageAssignEventOnSM_TXNAction.
	 */
	public GenericPackageAssignEventOnSM_TXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_TXN_GenericPackageAssignEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_TXN_GenericPackageAssignEvent(
			IStructuredSelection selection) {
		GenericPackageAssignEventOnSM_TXNWizard wizard = new GenericPackageAssignEventOnSM_TXNWizard();
...
} // end GenericPackageAssignEventOnSM_TXNAction
