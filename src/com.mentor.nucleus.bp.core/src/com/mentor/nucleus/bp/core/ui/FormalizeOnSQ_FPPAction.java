...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/FormalizeOnSQ_FPPAction.java
//
...
public class FormalizeOnSQ_FPPAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for FormalizeOnSQ_FPPAction.
	 */
	public FormalizeOnSQ_FPPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SQ_FPP_Formalize(structuredSelection);
		wd.open();
	...
	public WizardDialog SQ_FPP_Formalize(IStructuredSelection selection) {
		FormalizeOnSQ_FPPWizard wizard = new FormalizeOnSQ_FPPWizard();
