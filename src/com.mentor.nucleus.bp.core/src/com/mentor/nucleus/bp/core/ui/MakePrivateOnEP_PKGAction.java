...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePrivateOnEP_PKGAction.java
//
...
public class MakePrivateOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePrivateOnEP_PKGAction.
	 */
	public MakePrivateOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_MakePrivate(structuredSelection);
	...
	private void EP_PKG_MakePrivate(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Package Make Private");
		try {
			...
			CorePlugin.logError("Transaction: Package Make Private failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePrivateOnEP_PKGAction
