...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewEnumeratorOnS_EDTAction.java
//
...
public class NewEnumeratorOnS_EDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewEnumeratorOnS_EDTAction.
	 */
	public NewEnumeratorOnS_EDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_EDT_NewEnumerator(structuredSelection);
	...
	private void S_EDT_NewEnumerator(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Enumerator");
		...
		try {
			...
			NonRootModelElement[] children = Enumerator_c
					.getManyS_ENUMsOnR27(v_edt)
			...
			CorePlugin.logError("Transaction: New Enumerator failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end NewEnumeratorOnS_EDTAction
