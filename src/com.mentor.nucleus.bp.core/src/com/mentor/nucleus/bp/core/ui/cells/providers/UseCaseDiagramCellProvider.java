//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/UseCaseDiagramCellProvider.java
//
...
public class UseCaseDiagramCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((UseCaseDiagram_c) element).getName()) )
            {
                ((UseCaseDiagram_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((UseCaseDiagram_c) element).getDescrip()) )
            {
                ((UseCaseDiagram_c) element).setDescrip(value.toString());
            }
        }
