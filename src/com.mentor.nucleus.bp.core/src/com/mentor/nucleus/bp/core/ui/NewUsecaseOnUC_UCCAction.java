...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewUsecaseOnUC_UCCAction.java
//
...
public class NewUsecaseOnUC_UCCAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewUsecaseOnUC_UCCAction.
	 */
	public NewUsecaseOnUC_UCCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		UC_UCC_NewUsecase(structuredSelection);
	...
	private void UC_UCC_NewUsecase(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Usecase");
		try {
			...
			CorePlugin.logError("Transaction: New Usecase failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewUsecaseOnUC_UCCAction
