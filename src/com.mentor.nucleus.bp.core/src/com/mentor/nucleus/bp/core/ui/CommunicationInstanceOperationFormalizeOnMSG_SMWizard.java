...
//====================================================================
//
// File:    CommunicationInstanceOperationFormalizeOnMSG_SMWizard.java
//
...
/**
 * CommunicationInstanceOperationFormalizeOnMSG_SMWizard class
 */
public class CommunicationInstanceOperationFormalizeOnMSG_SMWizard
		extends
			Wizard {
	...
	// wizard pages
	CommunicationInstanceOperationFormalizeOnMSG_SMWizardPage4 MSG_SM_CommunicationInstanceOperationFormalizePage4;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int MSG_SM_COMMUNICATIONINSTANCEOPERATIONFORMALIZE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for CommunicationInstanceOperationFormalizeOnMSG_SMWizard.
	 */
	public CommunicationInstanceOperationFormalizeOnMSG_SMWizard() {
		super();
	}
	...
	public void addPages() {
		MSG_SM_CommunicationInstanceOperationFormalizePage4 = new CommunicationInstanceOperationFormalizeOnMSG_SMWizardPage4(
				"CommunicationInstanceOperationFormalizeOnMSG_SMWizardPage4");
		addPage(MSG_SM_CommunicationInstanceOperationFormalizePage4);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& MSG_SM_CommunicationInstanceOperationFormalizePage4
						.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case MSG_SM_COMMUNICATIONINSTANCEOPERATIONFORMALIZE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Communication Instance Operation Formalize"); //$NON-NLS-1$
			...
			CorePlugin
					.logError(
							"Transaction: Communication Instance Operation Formalize failed", e);//$NON-NLS-1$
