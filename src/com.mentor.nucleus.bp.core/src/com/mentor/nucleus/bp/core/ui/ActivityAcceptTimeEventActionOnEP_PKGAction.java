...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ActivityAcceptTimeEventActionOnEP_PKGAction.java
//
...
// creates new Accept Time Event Actions.
//
...
public class ActivityAcceptTimeEventActionOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ActivityAcceptTimeEventActionOnEP_PKGAction.
	 */
	public ActivityAcceptTimeEventActionOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ActivityAcceptTimeEventAction(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"AcceptTimeEventAction_c", false));
	}
	private void EP_PKG_ActivityAcceptTimeEventAction(
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Activity Accept Time Event Action");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newaccepttimeeventaction();
			} else {
			...
			NonRootModelElement[] children = AcceptTimeEventAction_c
			...
			CorePlugin.logError(
					"Transaction: Activity Accept Time Event Action failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ActivityAcceptTimeEventActionOnEP_PKGAction
