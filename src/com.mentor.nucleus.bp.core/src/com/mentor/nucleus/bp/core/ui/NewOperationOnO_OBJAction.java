...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewOperationOnO_OBJAction.java
//
...
public class NewOperationOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewOperationOnO_OBJAction.
	 */
	public NewOperationOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_NewOperation(structuredSelection);
	...
	private void O_OBJ_NewOperation(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = Operation_c
					.getManyO_TFRsOnR115(v_clazz)
