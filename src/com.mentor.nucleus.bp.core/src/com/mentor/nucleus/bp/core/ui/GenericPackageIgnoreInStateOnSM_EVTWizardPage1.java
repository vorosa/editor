...
//====================================================================
//
// File:    GenericPackageIgnoreInStateOnSM_EVTWizardPage1.java
//
...
public class GenericPackageIgnoreInStateOnSM_EVTWizardPage1
		extends
	...
	/**
	 * Constructors for GenericPackageIgnoreInStateOnSM_EVTWizardPage1.
	 */
	public GenericPackageIgnoreInStateOnSM_EVTWizardPage1() {
		super("");
		init();
	}

	public GenericPackageIgnoreInStateOnSM_EVTWizardPage1(String name) {
		super(name);
		init();
	}

	private void init() {
		setTitle("Ignore in State");
		setDescription("Select state where this event is ignored");
	}

	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((GenericPackageIgnoreInStateOnSM_EVTWizard) getWizard())
						.getSelection());

		// cache for context
		StateMachineEvent_c v_event = ((GenericPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_event;
		...
		for (stateInstCount = 0; stateInstCount < v_stateInstances.length; stateInstCount++) {
			...
			if (User_c.Selectone(selected.getSmstt_id())
					&& v_event.Canstateignoreorsaycanthappen(false,
	...
	public void updateSelectedState() {
		...
		((GenericPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_state = this.State;
	}
	...
	public IWizardPage getNextPage() {
		((GenericPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_state = State;
