...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageAssignEventOnSM_CRTXNAction.java
//
...
public class GenericPackageAssignEventOnSM_CRTXNAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageAssignEventOnSM_CRTXNAction.
	 */
	public GenericPackageAssignEventOnSM_CRTXNAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_CRTXN_GenericPackageAssignEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_CRTXN_GenericPackageAssignEvent(
			IStructuredSelection selection) {
		GenericPackageAssignEventOnSM_CRTXNWizard wizard = new GenericPackageAssignEventOnSM_CRTXNWizard();
...
} // end GenericPackageAssignEventOnSM_CRTXNAction
