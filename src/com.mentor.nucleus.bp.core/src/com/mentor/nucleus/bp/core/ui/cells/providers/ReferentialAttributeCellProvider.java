//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ReferentialAttributeCellProvider.java
//
...
public class ReferentialAttributeCellProvider implements ICellProvider {
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Ref_Mode")) {
                	CellEditor editor = new EnumCellEditor(parent, Ref_Mode_vals);
                	return editor;
                }
	...
	public String getValue(NonRootModelElement element, ObjectElement data) {
		if(data.getName().equals("Ref_Mode")) {
	        Integer Ref_Mode_value = (Integer) data.getValue();
			if(Ref_Mode_value >= 0 && Ref_Mode_value < Ref_Mode_vals.length) {
				return Ref_Mode_vals[Ref_Mode_value];
			}
		}
		return null;
	}
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Ref_Mode"))
        {
            ...
            if ( new_val != ((ReferentialAttribute_c) element).getRef_mode() )
            {
                ((ReferentialAttribute_c) element).setRef_mode(new_val);
            }
        }
