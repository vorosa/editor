//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ClassAsSimpleParticipantCellProvider.java
//
...
public class ClassAsSimpleParticipantCellProvider implements ICellProvider {
    private String[] Mult_vals = { "One",
        "Many" };
    private String[] validMult_vals(ClassAsSimpleParticipant_c element)
    {
        String [] onlyOne = { "One" };
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Mult")) {
                	CellEditor editor = new EnumCellEditor(parent, validMult_vals((ClassAsSimpleParticipant_c) element));
                	return editor;
                }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Mult"))
        {
            ...
            if ( new_val != ((ClassAsSimpleParticipant_c) element).getMult() )
            {
                ((ClassAsSimpleParticipant_c) element).setMult(new_val);
            }
        }
        if(data.getName().equals("Cond"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((ClassAsSimpleParticipant_c) element).getCond() )
            {
                ((ClassAsSimpleParticipant_c) element).setCond(new_val);
            }
        }
        if(data.getName().equals("Txt_Phrs"))
        {
            if ( ! value.toString().equals(((ClassAsSimpleParticipant_c) element).getTxt_phrs()) )
            {
                ((ClassAsSimpleParticipant_c) element).setTxt_phrs(value.toString());
            }
        }
