...
//====================================================================
//
// File:    RemoveFromIdentifierOnO_ATTRWizardPage1.java
//
...
public class RemoveFromIdentifierOnO_ATTRWizardPage1 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for RemoveFromIdentifierOnO_ATTRWizardPage1.
	 */
	public RemoveFromIdentifierOnO_ATTRWizardPage1() {
		super("");
		init();
	}

	public RemoveFromIdentifierOnO_ATTRWizardPage1(String name) {
		super(name);
		init();
	}

	private void init() {
		setTitle("Remove from Identifier");
		setDescription("Select identifier to remove this attribute from");
	}

	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((RemoveFromIdentifierOnO_ATTRWizard) getWizard())
						.getSelection());

		// cache for context
		Attribute_c v_attr = ((RemoveFromIdentifierOnO_ATTRWizard) getWizard()).v_attr;
	...
	public void updateSelectedIdentifier() {
		this.Identifier = IdentifierInstances[IdentifierCombo
				.getSelectionIndex()];
		((RemoveFromIdentifierOnO_ATTRWizard) getWizard()).v_Identifier = this.Identifier;
	}
	...
	public IWizardPage getNextPage() {
		((RemoveFromIdentifierOnO_ATTRWizard) getWizard()).v_Identifier = Identifier;
