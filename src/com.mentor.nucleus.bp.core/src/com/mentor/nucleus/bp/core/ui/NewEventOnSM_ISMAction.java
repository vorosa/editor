...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewEventOnSM_ISMAction.java
//
...
public class NewEventOnSM_ISMAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewEventOnSM_ISMAction.
	 */
	public NewEventOnSM_ISMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_ISM_NewEvent(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"StateMachineEvent_c", false));
	}
	private void SM_ISM_NewEvent(IStructuredSelection selection) {
		...
		InstanceStateMachine_c v_ism = (InstanceStateMachine_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_ism
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Event");
		...
		try {
			...
			NonRootModelElement[] children = StateMachineEvent_c
					.getManySM_EVTsOnR502(StateMachine_c
							.getManySM_SMsOnR517(v_ism))
			...
			CorePlugin.logError("Transaction: New Event failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
