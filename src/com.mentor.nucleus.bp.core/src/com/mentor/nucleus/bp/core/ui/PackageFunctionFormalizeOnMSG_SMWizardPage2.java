...
//====================================================================
//
// File:    PackageFunctionFormalizeOnMSG_SMWizardPage2.java
//
...
public class PackageFunctionFormalizeOnMSG_SMWizardPage2 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for PackageFunctionFormalizeOnMSG_SMWizardPage2.
	 */
	public PackageFunctionFormalizeOnMSG_SMWizardPage2() {
		super("");
		init();
	}

	public PackageFunctionFormalizeOnMSG_SMWizardPage2(String name) {
		super(name);
		init();
	}
