...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetReturnTypeOnC_IOAction.java
//
...
public class SetReturnTypeOnC_IOAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetReturnTypeOnC_IOAction.
	 */
	public SetReturnTypeOnC_IOAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_IO_SetReturnType(structuredSelection);
	}
	/**
	...
	public static void C_IO_SetReturnType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      InterfaceOperation_c v_element = (InterfaceOperation_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR4008(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(Interface_c.getOneC_IOnR4003(ExecutableProperty_c.getOneC_EPOnR4004(v_element)));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (InterfaceOperation_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR4008(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR4008From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR4008To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(InterfaceOperation_c v_element) {
  ...
  } // end getElements(InterfaceOperation_c) 
} // end SetReturnTypeOnC_IOAction
