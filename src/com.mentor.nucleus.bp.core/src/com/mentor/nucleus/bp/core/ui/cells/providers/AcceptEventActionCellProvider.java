//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/AcceptEventActionCellProvider.java
//
...
public class AcceptEventActionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((AcceptEventAction_c) element).getName()) )
            {
                ((AcceptEventAction_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((AcceptEventAction_c) element).getDescrip()) )
            {
                ((AcceptEventAction_c) element).setDescrip(value.toString());
            }
        }
