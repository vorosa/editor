...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/LinkedFormalizeOnR_ASSRAction.java
//
...
public class LinkedFormalizeOnR_ASSRAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for LinkedFormalizeOnR_ASSRAction.
	 */
	public LinkedFormalizeOnR_ASSRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = R_ASSR_LinkedFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog R_ASSR_LinkedFormalize(IStructuredSelection selection) {
		LinkedFormalizeOnR_ASSRWizard wizard = new LinkedFormalizeOnR_ASSRWizard();
...
} // end LinkedFormalizeOnR_ASSRAction
