...
//====================================================================
//
// File:    CommunicationClassOperationFormalizeOnMSG_SMWizardPage2.java
//
...
public class CommunicationClassOperationFormalizeOnMSG_SMWizardPage2
		extends
	...
	/**
	 * Constructors for CommunicationClassOperationFormalizeOnMSG_SMWizardPage2.
	 */
	public CommunicationClassOperationFormalizeOnMSG_SMWizardPage2() {
		super("");
		init();
	}

	public CommunicationClassOperationFormalizeOnMSG_SMWizardPage2(String name) {
		super(name);
		init();
	}
