...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageCantHappenEventOnSM_STATEAction.java
//
...
public class GenericPackageCantHappenEventOnSM_STATEAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageCantHappenEventOnSM_STATEAction.
	 */
	public GenericPackageCantHappenEventOnSM_STATEAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_STATE_GenericPackageCantHappenEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_STATE_GenericPackageCantHappenEvent(
			IStructuredSelection selection) {
		GenericPackageCantHappenEventOnSM_STATEWizard wizard = new GenericPackageCantHappenEventOnSM_STATEWizard();
...
} // end GenericPackageCantHappenEventOnSM_STATEAction
