...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewSignalOnC_IAction.java
//
...
public class NewSignalOnC_IAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewSignalOnC_IAction.
	 */
	public NewSignalOnC_IAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_I_NewSignal(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor("NewSignal",
				false));
	}
	private void C_I_NewSignal(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Signal");
		...
		try {
			...
			if (((v_interface != null))) {
				...
				java.util.UUID v_discardUuid = v_interface
						.Newexecutableproperty(true);

			}

			NonRootModelElement[] children = InterfaceSignal_c
			...
			CorePlugin.logError("Transaction: New Signal failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
