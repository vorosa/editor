...
//====================================================================
//
// File:    CommunicationFunctionFormalizeOnMSG_SMWizardPage2.java
//
...
public class CommunicationFunctionFormalizeOnMSG_SMWizardPage2
		extends
	...
	/**
	 * Constructors for CommunicationFunctionFormalizeOnMSG_SMWizardPage2.
	 */
	public CommunicationFunctionFormalizeOnMSG_SMWizardPage2() {
		super("");
		init();
	}

	public CommunicationFunctionFormalizeOnMSG_SMWizardPage2(String name) {
		super(name);
		init();
	}
