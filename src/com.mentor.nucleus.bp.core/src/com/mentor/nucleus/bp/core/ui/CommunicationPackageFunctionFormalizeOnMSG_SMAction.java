...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationPackageFunctionFormalizeOnMSG_SMAction.java
//
...
public class CommunicationPackageFunctionFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationPackageFunctionFormalizeOnMSG_SMAction.
	 */
	public CommunicationPackageFunctionFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationPackageFunctionFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationPackageFunctionFormalize(
			IStructuredSelection selection) {
		CommunicationPackageFunctionFormalizeOnMSG_SMWizard wizard = new CommunicationPackageFunctionFormalizeOnMSG_SMWizard();
...
} // end CommunicationPackageFunctionFormalizeOnMSG_SMAction
