...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePrivateOnS_UDTAction.java
//
...
public class MakePrivateOnS_UDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePrivateOnS_UDTAction.
	 */
	public MakePrivateOnS_UDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_UDT_MakePrivate(structuredSelection);
	...
	private void S_UDT_MakePrivate(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("User Data Type Make Private");
		try {
			...
			CorePlugin.logError(
					"Transaction: User Data Type Make Private failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePrivateOnS_UDTAction
