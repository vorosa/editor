//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ProvidedOperationCellProvider.java
//
...
public class ProvidedOperationCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Suc_Pars"))
        {
            ...
            if ( new_val != ((ProvidedOperation_c) element).getSuc_pars() )
            {
                ((ProvidedOperation_c) element).setSuc_pars(new_val);
            }
        }
