//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/InterfaceCellProvider.java
//
...
public class InterfaceCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Interface_c) element).getName()) )
            {
                ((Interface_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Interface_c) element).getDescrip()) )
            {
                ((Interface_c) element).setDescrip(value.toString());
            }
        }
