...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/BinaryFormalizeOnR_RELAction.java
//
...
public class BinaryFormalizeOnR_RELAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for BinaryFormalizeOnR_RELAction.
	 */
	public BinaryFormalizeOnR_RELAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = R_REL_BinaryFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog R_REL_BinaryFormalize(IStructuredSelection selection) {
		BinaryFormalizeOnR_RELWizard wizard = new BinaryFormalizeOnR_RELWizard();
...
} // end BinaryFormalizeOnR_RELAction
