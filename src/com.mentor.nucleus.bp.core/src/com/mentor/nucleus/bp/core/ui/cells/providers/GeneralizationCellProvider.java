//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/GeneralizationCellProvider.java
//
...
public class GeneralizationCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Generalization_c) element).getDescrip()) )
            {
                ((Generalization_c) element).setDescrip(value.toString());
            }
        }
