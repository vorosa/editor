...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakeProtectedOnEP_PKGAction.java
//
...
public class MakeProtectedOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakeProtectedOnEP_PKGAction.
	 */
	public MakeProtectedOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_MakeProtected(structuredSelection);
	...
	private void EP_PKG_MakeProtected(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Package Make Protected");
		try {
			...
			CorePlugin
					.logError("Transaction: Package Make Protected failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakeProtectedOnEP_PKGAction
