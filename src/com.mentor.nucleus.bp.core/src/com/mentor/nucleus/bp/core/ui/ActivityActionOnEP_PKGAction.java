...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ActivityActionOnEP_PKGAction.java
//
...
public class ActivityActionOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for ActivityActionOnEP_PKGAction.
	 */
	public ActivityActionOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ActivityAction(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ActivityDiagramAction_c", false));
	}
	private void EP_PKG_ActivityAction(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = ActivityDiagramAction_c
			...
			CorePlugin.logError("Transaction: Activity Action failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ActivityActionOnEP_PKGAction
