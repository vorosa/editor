//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/AcceptTimeEventActionCellProvider.java
//
...
public class AcceptTimeEventActionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((AcceptTimeEventAction_c) element).getName()) )
            {
                ((AcceptTimeEventAction_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((AcceptTimeEventAction_c) element).getDescrip()) )
            {
                ((AcceptTimeEventAction_c) element).setDescrip(value.toString());
            }
        }
