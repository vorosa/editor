//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ForkJoinNodeCellProvider.java
//
...
public class ForkJoinNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ForkJoinNode_c) element).getDescrip()) )
            {
                ((ForkJoinNode_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("GuardCondition"))
        {
            if ( ! value.toString().equals(((ForkJoinNode_c) element).getGuardcondition()) )
            {
                ((ForkJoinNode_c) element).setGuardcondition(value.toString());
            }
        }
