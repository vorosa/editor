...
//====================================================================
//
// File:    SpecializedPackageIgnoreInStateOnSM_EVTWizard.java
//
...
/**
 * SpecializedPackageIgnoreInStateOnSM_EVTWizard class
 */
public class SpecializedPackageIgnoreInStateOnSM_EVTWizard extends Wizard {
	...
	// wizard pages
	SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1 SM_EVT_SpecializedPackageIgnoreInStatePage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_EVT_SPECIALIZEDPACKAGEIGNOREINSTATE0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for SpecializedPackageIgnoreInStateOnSM_EVTWizard.
	 */
	public SpecializedPackageIgnoreInStateOnSM_EVTWizard() {
		super();
	}
	...
	public void addPages() {
		SM_EVT_SpecializedPackageIgnoreInStatePage1 = new SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1(
				"SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1");
		addPage(SM_EVT_SpecializedPackageIgnoreInStatePage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_EVT_SpecializedPackageIgnoreInStatePage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_EVT_SPECIALIZEDPACKAGEIGNOREINSTATE0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Specialized Package Ignore in State"); //$NON-NLS-1$
			...
			CorePlugin
					.logError(
							"Transaction: Specialized Package Ignore in State failed", e);//$NON-NLS-1$
