...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnS_BPARMAction.java
//
...
public class MoveDownOnS_BPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnS_BPARMAction.
	 */
	public MoveDownOnS_BPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_BPARM_MoveDown(structuredSelection);
	...
	private void S_BPARM_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Bridge Parameter Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Bridge Parameter Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnS_BPARMAction
