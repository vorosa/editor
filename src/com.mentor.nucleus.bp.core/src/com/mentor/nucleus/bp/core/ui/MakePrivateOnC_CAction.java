...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePrivateOnC_CAction.java
//
...
public class MakePrivateOnC_CAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePrivateOnC_CAction.
	 */
	public MakePrivateOnC_CAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_C_MakePrivate(structuredSelection);
	...
	private void C_C_MakePrivate(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Component Make Private");
		try {
			...
			CorePlugin
					.logError("Transaction: Component Make Private failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePrivateOnC_CAction
