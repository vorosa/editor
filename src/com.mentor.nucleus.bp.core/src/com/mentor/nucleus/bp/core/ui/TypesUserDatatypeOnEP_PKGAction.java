...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/TypesUserDatatypeOnEP_PKGAction.java
//
...
public class TypesUserDatatypeOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for TypesUserDatatypeOnEP_PKGAction.
	 */
	public TypesUserDatatypeOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_TypesUserDatatype(structuredSelection);
	...
	private void EP_PKG_TypesUserDatatype(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Types User DataType");
		...
		try {
			...
			NonRootModelElement[] children = UserDataType_c
			...
			CorePlugin.logError("Transaction: Types User DataType failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end TypesUserDatatypeOnEP_PKGAction
