...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnO_TPARMAction.java
//
...
public class SetTypeOnO_TPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnO_TPARMAction.
	 */
	public SetTypeOnO_TPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_TPARM_SetType(structuredSelection);
	}
	/**
	...
	public static void O_TPARM_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      OperationParameter_c v_element = (OperationParameter_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR118(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ModelClass_c.getOneO_OBJOnR115(Operation_c.getOneO_TFROnR117(v_element)));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (OperationParameter_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR118(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR118From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR118To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(OperationParameter_c v_element) {
  ...
  } // end getElements(OperationParameter_c) 
} // end SetTypeOnO_TPARMAction
