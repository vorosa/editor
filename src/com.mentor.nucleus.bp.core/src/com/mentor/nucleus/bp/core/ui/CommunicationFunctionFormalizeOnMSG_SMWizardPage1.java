...
//====================================================================
//
// File:    CommunicationFunctionFormalizeOnMSG_SMWizardPage1.java
//
...
public class CommunicationFunctionFormalizeOnMSG_SMWizardPage1
		extends
	...
	/**
	 * Constructors for CommunicationFunctionFormalizeOnMSG_SMWizardPage1.
	 */
	public CommunicationFunctionFormalizeOnMSG_SMWizardPage1() {
		super("");
		init();
	}

	public CommunicationFunctionFormalizeOnMSG_SMWizardPage1(String name) {
		super(name);
		init();
	}
