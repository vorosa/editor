...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetReturnTypeOnS_SYNCAction.java
//
...
public class SetReturnTypeOnS_SYNCAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetReturnTypeOnS_SYNCAction.
	 */
	public SetReturnTypeOnS_SYNCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SYNC_SetReturnType(structuredSelection);
	}
	/**
	...
	public static void S_SYNC_SetReturnType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      Function_c v_element = (Function_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR25(v_element);
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (Function_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalDT = DataType_c.getOneS_DTOnR25(v_element);
...
if (v_element != null) {
v_element.unrelateAcrossR25From(v_originalDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR25To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(Function_c v_element) {
  ...
  } // end getElements(Function_c) 
} // end SetReturnTypeOnS_SYNCAction
