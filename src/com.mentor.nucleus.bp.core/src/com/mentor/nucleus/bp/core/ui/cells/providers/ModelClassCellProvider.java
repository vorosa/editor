//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ModelClassCellProvider.java
//
...
public class ModelClassCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ModelClass_c) element).getName()) )
            {
                ((ModelClass_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Numb"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((ModelClass_c) element).getNumb() )
            {
                ((ModelClass_c) element).setNumb(new_val);
            }
        }
        if(data.getName().equals("Key_Lett"))
        {
            if ( ! value.toString().equals(((ModelClass_c) element).getKey_lett()) )
            {
                ((ModelClass_c) element).setKey_lett(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ModelClass_c) element).getDescrip()) )
            {
                ((ModelClass_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Visibility"))
        {
