...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewAcceptTimeEventActionOnA_AAction.java
//
...
public class NewAcceptTimeEventActionOnA_AAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewAcceptTimeEventActionOnA_AAction.
	 */
	public NewAcceptTimeEventActionOnA_AAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		A_A_NewAcceptTimeEventAction(structuredSelection);
	...
	private void A_A_NewAcceptTimeEventAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Accept Time Event Action");
		try {
			...
			if ((!(v_act == null))) {
				...
				if (v_act != null) {
					v_act.Newaccepttimeeventaction();
				} else {
			...
			CorePlugin.logError(
					"Transaction: New Accept Time Event Action failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewAcceptTimeEventActionOnA_AAction
