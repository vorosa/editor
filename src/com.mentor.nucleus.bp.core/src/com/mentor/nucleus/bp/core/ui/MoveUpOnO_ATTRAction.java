...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnO_ATTRAction.java
//
...
public class MoveUpOnO_ATTRAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnO_ATTRAction.
	 */
	public MoveUpOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_ATTR_MoveUp(structuredSelection);
	...
	private void O_ATTR_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Attribute Move Up");
		try {
			...
			CorePlugin.logError("Transaction: Attribute Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnO_ATTRAction
