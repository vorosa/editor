...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewComponentParticipantOnSQ_SAction.java
//
...
public class NewComponentParticipantOnSQ_SAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewComponentParticipantOnSQ_SAction.
	 */
	public NewComponentParticipantOnSQ_SAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_S_NewComponentParticipant(structuredSelection);
	...
	private void SQ_S_NewComponentParticipant(IStructuredSelection selection) {
		...
		try {
			...
			if (((v_sequence != null))) {
				...
				if (v_sequence != null) {
					v_sequence.Newcomponentparticipant();
				} else {
...
} // end NewComponentParticipantOnSQ_SAction
