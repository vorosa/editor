...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InstanceEventFormalizeOnMSG_AMAction.java
//
...
public class InstanceEventFormalizeOnMSG_AMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for InstanceEventFormalizeOnMSG_AMAction.
	 */
	public InstanceEventFormalizeOnMSG_AMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_AM_InstanceEventFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_AM_InstanceEventFormalize(
...
} // end InstanceEventFormalizeOnMSG_AMAction
