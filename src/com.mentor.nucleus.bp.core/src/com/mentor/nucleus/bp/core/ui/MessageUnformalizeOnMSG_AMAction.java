...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MessageUnformalizeOnMSG_AMAction.java
//
...
public class MessageUnformalizeOnMSG_AMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MessageUnformalizeOnMSG_AMAction.
	 */
	public MessageUnformalizeOnMSG_AMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		MSG_AM_MessageUnformalize(structuredSelection);
	...
	private void MSG_AM_MessageUnformalize(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Message Unformalize");
		try {
			...
			CorePlugin.logError("Transaction: Message Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MessageUnformalizeOnMSG_AMAction
