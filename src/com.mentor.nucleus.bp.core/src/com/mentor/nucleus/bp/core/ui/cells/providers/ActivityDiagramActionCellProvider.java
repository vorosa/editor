//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActivityDiagramActionCellProvider.java
//
...
public class ActivityDiagramActionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ActivityDiagramAction_c) element).getName()) )
            {
                ((ActivityDiagramAction_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ActivityDiagramAction_c) element).getDescrip()) )
            {
                ((ActivityDiagramAction_c) element).setDescrip(value.toString());
            }
        }
