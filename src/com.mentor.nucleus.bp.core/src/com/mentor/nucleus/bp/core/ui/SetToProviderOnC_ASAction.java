...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetToProviderOnC_ASAction.java
//
...
public class SetToProviderOnC_ASAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetToProviderOnC_ASAction.
	 */
	public SetToProviderOnC_ASAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_AS_SetToProvider(structuredSelection);
	...
	private void C_AS_SetToProvider(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Signal Set To Provider");
		try {
			...
			if (((v_is != null))) {
				...
				if (v_is != null) {
					v_is.setDirection(Ifdirectiontype_c.ClientServer);
				} else {
			...
			CorePlugin.logError(
					"Transaction: Interface Signal Set To Provider failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetToProviderOnC_ASAction
