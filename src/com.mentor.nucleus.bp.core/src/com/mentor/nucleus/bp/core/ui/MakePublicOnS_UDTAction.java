...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePublicOnS_UDTAction.java
//
...
public class MakePublicOnS_UDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePublicOnS_UDTAction.
	 */
	public MakePublicOnS_UDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_UDT_MakePublic(structuredSelection);
	...
	private void S_UDT_MakePublic(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("User Data Type Make Public");
		try {
			...
			CorePlugin.logError(
					"Transaction: User Data Type Make Public failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePublicOnS_UDTAction
