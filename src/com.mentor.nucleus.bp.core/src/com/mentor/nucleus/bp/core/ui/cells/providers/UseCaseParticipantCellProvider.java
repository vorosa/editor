//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/UseCaseParticipantCellProvider.java
//
...
public class UseCaseParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((UseCaseParticipant_c) element).getName()) )
            {
                ((UseCaseParticipant_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((UseCaseParticipant_c) element).getDescrip()) )
            {
                ((UseCaseParticipant_c) element).setDescrip(value.toString());
            }
        }
