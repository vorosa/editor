//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActivityEdgeCellProvider.java
//
...
public class ActivityEdgeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Guard"))
        {
            if ( ! value.toString().equals(((ActivityEdge_c) element).getGuard()) )
            {
                ((ActivityEdge_c) element).setGuard(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ActivityEdge_c) element).getDescrip()) )
            {
                ((ActivityEdge_c) element).setDescrip(value.toString());
            }
        }
