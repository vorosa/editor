...
//====================================================================
//
// File:    InheritanceFormalizeOnR_SUBWizardPage1.java
//
...
public class InheritanceFormalizeOnR_SUBWizardPage1 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for InheritanceFormalizeOnR_SUBWizardPage1.
	 */
	public InheritanceFormalizeOnR_SUBWizardPage1() {
		super("");
		init();
	}

	public InheritanceFormalizeOnR_SUBWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((InheritanceFormalizeOnR_SUBWizard) getWizard())
						.getSelection());

		// cache for context
		ClassAsSubtype_c v_r_sub = ((InheritanceFormalizeOnR_SUBWizard) getWizard()).v_r_sub;
	...
	public void updateSelectedIdentifier() {
		this.Identifier = IdentifierInstances[IdentifierCombo
				.getSelectionIndex()];
		((InheritanceFormalizeOnR_SUBWizard) getWizard()).v_Identifier = this.Identifier;
	}
	...
	public IWizardPage getNextPage() {
		((InheritanceFormalizeOnR_SUBWizard) getWizard()).v_Identifier = Identifier;
