...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnS_MBRAction.java
//
...
public class MoveDownOnS_MBRAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnS_MBRAction.
	 */
	public MoveDownOnS_MBRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_MBR_MoveDown(structuredSelection);
	...
	private void S_MBR_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Structure Member Move Down");
		try {
			...
			CorePlugin.logError(
					"Transaction: Structure Member Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnS_MBRAction
