//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/EnumeratorCellProvider.java
//
...
public class EnumeratorCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((Enumerator_c) element).getName()) )
            {
                ((Enumerator_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((Enumerator_c) element).getDescrip()) )
            {
                ((Enumerator_c) element).setDescrip(value.toString());
            }
        }
