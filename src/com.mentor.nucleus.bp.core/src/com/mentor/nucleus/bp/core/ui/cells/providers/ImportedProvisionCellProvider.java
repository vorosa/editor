//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ImportedProvisionCellProvider.java
//
...
public class ImportedProvisionCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ImportedProvision_c) element).getDescrip()) )
            {
                ((ImportedProvision_c) element).setDescrip(value.toString());
            }
        }
