//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ExternalEntityCellProvider.java
//
...
public class ExternalEntityCellProvider implements ICellProvider {
	...
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                ...
                if(data.getName().equals("Key_Lett")) {
	                CellEditor editor = new TextCellEditor(parent);
	                return editor;
	            }
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ExternalEntity_c) element).getName()) )
            {
                ((ExternalEntity_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ExternalEntity_c) element).getDescrip()) )
            {
                ((ExternalEntity_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("Key_Lett"))
        {
            if ( ! value.toString().equals(((ExternalEntity_c) element).getKey_lett()) )
            {
                ((ExternalEntity_c) element).setKey_lett(value.toString());
            }
        }
        if(data.getName().equals("Realized_Class_Path"))
        {
            if ( ! value.toString().equals(((ExternalEntity_c) element).getRealized_class_path()) )
            {
                ((ExternalEntity_c) element).setRealized_class_path(value.toString());
            }
        }
        if(data.getName().equals("isRealized"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((ExternalEntity_c) element).getIsrealized() )
            {
                ((ExternalEntity_c) element).setIsrealized(new_val);
            }
        }
