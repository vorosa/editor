...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ActivityAcceptEventActionOnEP_PKGAction.java
//
...
// creates new Accept Event Actions.
//
...
public class ActivityAcceptEventActionOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for ActivityAcceptEventActionOnEP_PKGAction.
	 */
	public ActivityAcceptEventActionOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_ActivityAcceptEventAction(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"AcceptEventAction_c", false));
	}
	private void EP_PKG_ActivityAcceptEventAction(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Activity Accept Event Action");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newaccepteventaction();
			} else {
			...
			NonRootModelElement[] children = AcceptEventAction_c
			...
			CorePlugin.logError(
					"Transaction: Activity Accept Event Action failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end ActivityAcceptEventActionOnEP_PKGAction
