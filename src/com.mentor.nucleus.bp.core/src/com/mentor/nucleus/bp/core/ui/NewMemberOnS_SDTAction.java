...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewMemberOnS_SDTAction.java
//
...
public class NewMemberOnS_SDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewMemberOnS_SDTAction.
	 */
	public NewMemberOnS_SDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SDT_NewMember(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"StructureMember_c", false));
	}
	private void S_SDT_NewMember(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Member");
		...
		try {
			...
			NonRootModelElement[] children = StructureMember_c
					.getManyS_MBRsOnR44(v_sdt)
			...
			CorePlugin.logError("Transaction: New Member failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
