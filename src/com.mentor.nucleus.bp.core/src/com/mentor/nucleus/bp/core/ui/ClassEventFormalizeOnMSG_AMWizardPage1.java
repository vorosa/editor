...
//====================================================================
//
// File:    ClassEventFormalizeOnMSG_AMWizardPage1.java
//
...
public class ClassEventFormalizeOnMSG_AMWizardPage1 extends PtWizardPage
		implements
			Listener {
	...
	/**
	 * Constructors for ClassEventFormalizeOnMSG_AMWizardPage1.
	 */
	public ClassEventFormalizeOnMSG_AMWizardPage1() {
		super("");
		init();
	}

	public ClassEventFormalizeOnMSG_AMWizardPage1(String name) {
		super(name);
		init();
	}
    ...
    StateMachineEvent_c v_Message = ((ClassEventFormalizeOnMSG_AMWizard)getWizard()).v_Message;
