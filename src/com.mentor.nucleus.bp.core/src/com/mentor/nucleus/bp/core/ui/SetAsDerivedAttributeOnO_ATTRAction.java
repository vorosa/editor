...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetAsDerivedAttributeOnO_ATTRAction.java
//
...
// creates new Set as Derived Attributes.
//
...
public class SetAsDerivedAttributeOnO_ATTRAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for SetAsDerivedAttributeOnO_ATTRAction.
	 */
	public SetAsDerivedAttributeOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_ATTR_SetAsDerivedAttribute(structuredSelection);
	...
	private void O_ATTR_SetAsDerivedAttribute(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Attribute Set as Derived Attribute");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_attr != null) {
				v_attr.Migratebasetoderived();
			} else {
			...
			CorePlugin
					.logError(
							"Transaction: Attribute Set as Derived Attribute failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetAsDerivedAttributeOnO_ATTRAction
