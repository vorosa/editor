...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UsecaseUsecaseOnEP_PKGAction.java
//
...
public class UsecaseUsecaseOnEP_PKGAction implements IObjectActionDelegate {

	/**
	 * Constructor for UsecaseUsecaseOnEP_PKGAction.
	 */
	public UsecaseUsecaseOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_UsecaseUsecase(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"UseCaseParticipant_c", false));
	}
	private void EP_PKG_UsecaseUsecase(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Usecase Usecase");
		...
		try {
			...
			NonRootModelElement[] children = UseCaseParticipant_c
			...
			CorePlugin.logError("Transaction: Usecase Usecase failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end UsecaseUsecaseOnEP_PKGAction
