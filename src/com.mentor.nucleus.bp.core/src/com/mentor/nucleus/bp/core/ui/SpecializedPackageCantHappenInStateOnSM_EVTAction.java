...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageCantHappenInStateOnSM_EVTAction.java
//
...
// creates new Cant Happen in States.
//
...
public class SpecializedPackageCantHappenInStateOnSM_EVTAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageCantHappenInStateOnSM_EVTAction.
	 */
	public SpecializedPackageCantHappenInStateOnSM_EVTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_EVT_SpecializedPackageCantHappenInState(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_EVT_SpecializedPackageCantHappenInState(
			IStructuredSelection selection) {
		SpecializedPackageCantHappenInStateOnSM_EVTWizard wizard = new SpecializedPackageCantHappenInStateOnSM_EVTWizard();
...
} // end SpecializedPackageCantHappenInStateOnSM_EVTAction
