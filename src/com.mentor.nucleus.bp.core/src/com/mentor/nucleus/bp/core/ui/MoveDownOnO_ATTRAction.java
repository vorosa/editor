...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnO_ATTRAction.java
//
...
public class MoveDownOnO_ATTRAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnO_ATTRAction.
	 */
	public MoveDownOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_ATTR_MoveDown(structuredSelection);
	...
	private void O_ATTR_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Attribute Move Down");
		try {
			...
			CorePlugin.logError("Transaction: Attribute Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnO_ATTRAction
