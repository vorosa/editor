...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetAsBaseAttributeOnO_ATTRAction.java
//
...
// creates new Set as Base Attributes.
//
...
public class SetAsBaseAttributeOnO_ATTRAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetAsBaseAttributeOnO_ATTRAction.
	 */
	public SetAsBaseAttributeOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_ATTR_SetAsBaseAttribute(structuredSelection);
	...
	private void O_ATTR_SetAsBaseAttribute(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Attribute Set as Base Attribute");
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_attr != null) {
				v_attr.Migratederivedtobase();
			} else {
			...
			CorePlugin.logError(
					"Transaction: Attribute Set as Base Attribute failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetAsBaseAttributeOnO_ATTRAction
