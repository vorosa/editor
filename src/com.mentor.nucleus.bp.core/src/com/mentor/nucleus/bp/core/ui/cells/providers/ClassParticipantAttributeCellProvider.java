//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ClassParticipantAttributeCellProvider.java
//
...
public class ClassParticipantAttributeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ClassParticipantAttribute_c) element).getName()) )
            {
                ((ClassParticipantAttribute_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Type"))
        {
            if ( ! value.toString().equals(((ClassParticipantAttribute_c) element).getType()) )
            {
                ((ClassParticipantAttribute_c) element).setType(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ClassParticipantAttribute_c) element).getDescrip()) )
            {
                ((ClassParticipantAttribute_c) element).setDescrip(value.toString());
            }
        }
