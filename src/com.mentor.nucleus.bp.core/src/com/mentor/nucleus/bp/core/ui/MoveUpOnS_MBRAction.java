...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnS_MBRAction.java
//
...
public class MoveUpOnS_MBRAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnS_MBRAction.
	 */
	public MoveUpOnS_MBRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_MBR_MoveUp(structuredSelection);
	...
	private void S_MBR_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Structure Member Move Up");
		try {
			...
			CorePlugin.logError(
					"Transaction: Structure Member Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnS_MBRAction
