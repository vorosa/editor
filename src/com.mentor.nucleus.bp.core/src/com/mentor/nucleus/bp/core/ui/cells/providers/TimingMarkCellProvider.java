//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/TimingMarkCellProvider.java
//
...
public class TimingMarkCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((TimingMark_c) element).getName()) )
            {
                ((TimingMark_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((TimingMark_c) element).getDescrip()) )
            {
                ((TimingMark_c) element).setDescrip(value.toString());
            }
        }
