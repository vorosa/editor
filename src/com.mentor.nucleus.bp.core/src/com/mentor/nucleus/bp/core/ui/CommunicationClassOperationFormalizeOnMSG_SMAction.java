...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/CommunicationClassOperationFormalizeOnMSG_SMAction.java
//
...
public class CommunicationClassOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for CommunicationClassOperationFormalizeOnMSG_SMAction.
	 */
	public CommunicationClassOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_CommunicationClassOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_CommunicationClassOperationFormalize(
			IStructuredSelection selection) {
		CommunicationClassOperationFormalizeOnMSG_SMWizard wizard = new CommunicationClassOperationFormalizeOnMSG_SMWizard();
...
} // end CommunicationClassOperationFormalizeOnMSG_SMAction
