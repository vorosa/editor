...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InstanceOperationFormalizeOnMSG_SMAction.java
//
...
public class InstanceOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for InstanceOperationFormalizeOnMSG_SMAction.
	 */
	public InstanceOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_InstanceOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_InstanceOperationFormalize(
...
} // end InstanceOperationFormalizeOnMSG_SMAction
