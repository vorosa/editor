//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/BinaryAssociationCellProvider.java
//
...
public class BinaryAssociationCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((BinaryAssociation_c) element).getDescrip()) )
            {
                ((BinaryAssociation_c) element).setDescrip(value.toString());
            }
        }
