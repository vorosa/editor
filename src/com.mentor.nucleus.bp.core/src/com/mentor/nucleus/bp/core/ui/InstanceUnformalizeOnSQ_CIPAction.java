...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InstanceUnformalizeOnSQ_CIPAction.java
//
...
public class InstanceUnformalizeOnSQ_CIPAction implements IObjectActionDelegate {

	/**
	 * Constructor for InstanceUnformalizeOnSQ_CIPAction.
	 */
	public InstanceUnformalizeOnSQ_CIPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SQ_CIP_InstanceUnformalize(structuredSelection);
	...
	private void SQ_CIP_InstanceUnformalize(IStructuredSelection selection) {
		...
		ClassInstanceParticipant_c v_cip = (ClassInstanceParticipant_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_cip
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Instance Unformalize");
		try {
			...
			CorePlugin.logError("Transaction: Instance Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end InstanceUnformalizeOnSQ_CIPAction
