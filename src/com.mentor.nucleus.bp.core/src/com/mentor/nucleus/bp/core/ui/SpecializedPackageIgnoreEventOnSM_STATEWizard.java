...
//====================================================================
//
// File:    SpecializedPackageIgnoreEventOnSM_STATEWizard.java
//
...
/**
 * SpecializedPackageIgnoreEventOnSM_STATEWizard class
 */
public class SpecializedPackageIgnoreEventOnSM_STATEWizard extends Wizard {
	...
	// wizard pages
	SpecializedPackageIgnoreEventOnSM_STATEWizardPage1 SM_STATE_SpecializedPackageIgnoreEventPage1;

	// wizard state
	// constants
	protected static final int INITIAL_WIZARD_STATE = -1;
	protected static final int SM_STATE_SPECIALIZEDPACKAGEIGNOREEVENT0_WIZARD_STATE = 0;
	// member
	...
	/**
	 * Constructor for SpecializedPackageIgnoreEventOnSM_STATEWizard.
	 */
	public SpecializedPackageIgnoreEventOnSM_STATEWizard() {
		super();
	}
	...
	public void addPages() {
		SM_STATE_SpecializedPackageIgnoreEventPage1 = new SpecializedPackageIgnoreEventOnSM_STATEWizardPage1(
				"SpecializedPackageIgnoreEventOnSM_STATEWizardPage1");
		addPage(SM_STATE_SpecializedPackageIgnoreEventPage1);
	}
	...
	public boolean canFinish() {
		...
		pagesComplete = pagesComplete
				&& SM_STATE_SpecializedPackageIgnoreEventPage1.isPageComplete();
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		switch (pages.indexOf(page)) {
			case SM_STATE_SPECIALIZEDPACKAGEIGNOREEVENT0_WIZARD_STATE :
				return null;
		}
		return null;
	}
	...
	public boolean performFinish() {
		...
		try {
			transactionGroup = TransactionUtil
					.startTransactionsOnSelectedModelRoots("Specialized Package Ignore Event"); //$NON-NLS-1$
			...
			CorePlugin.logError(
					"Transaction: Specialized Package Ignore Event failed", e);//$NON-NLS-1$
