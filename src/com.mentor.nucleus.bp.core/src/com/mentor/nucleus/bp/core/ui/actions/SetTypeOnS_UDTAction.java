...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnS_UDTAction.java
//
...
public class SetTypeOnS_UDTAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnS_UDTAction.
	 */
	public SetTypeOnS_UDTAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_UDT_SetType(structuredSelection);
	}
	/**
	...
	public static void S_UDT_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      UserDataType_c v_element = (UserDataType_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR18(v_element);
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(DataType_c.getOneS_DTOnR17(v_element));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (UserDataType_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
DataType_c v_originalCoreDT = DataType_c.getOneS_DTOnR18(v_element);


if ( (v_selectedDT != v_originalCoreDT) )
{

if (v_element != null) {
v_element.unrelateAcrossR18From(v_originalCoreDT);
}
else {
...
if (v_element != null) {
  v_element.relateAcrossR18To(v_selectedDT);
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Relate attempted on null left hand instance.", t);
	...
	public static DataType_c[] getElements(UserDataType_c v_element) {
  ...
  } // end getElements(UserDataType_c) 
} // end SetTypeOnS_UDTAction
