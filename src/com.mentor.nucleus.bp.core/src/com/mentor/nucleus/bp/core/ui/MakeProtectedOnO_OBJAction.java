...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakeProtectedOnO_OBJAction.java
//
...
public class MakeProtectedOnO_OBJAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakeProtectedOnO_OBJAction.
	 */
	public MakeProtectedOnO_OBJAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_OBJ_MakeProtected(structuredSelection);
	...
	private void O_OBJ_MakeProtected(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Model Class Make Protected");
		try {
			...
			CorePlugin.logError(
					"Transaction: Model Class Make Protected failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakeProtectedOnO_OBJAction
