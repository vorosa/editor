//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SendSignalCellProvider.java
//
...
public class SendSignalCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((SendSignal_c) element).getName()) )
            {
                ((SendSignal_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((SendSignal_c) element).getDescrip()) )
            {
                ((SendSignal_c) element).setDescrip(value.toString());
            }
        }
