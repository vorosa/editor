...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewComponentReferenceOnCP_CPAction.java
//
...
public class NewComponentReferenceOnCP_CPAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for NewComponentReferenceOnCP_CPAction.
	 */
	public NewComponentReferenceOnCP_CPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CP_CP_NewComponentReference(structuredSelection);
	...
	private void CP_CP_NewComponentReference(IStructuredSelection selection) {
		...
		try {
			...
			if ((!(v_package == null))) {
				...
				if (v_package != null) {
					v_package.Newimportedcomponent();
				} else {
...
} // end NewComponentReferenceOnCP_CPAction
