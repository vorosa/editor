...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnC_PPAction.java
//
...
public class MoveUpOnC_PPAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnC_PPAction.
	 */
	public MoveUpOnC_PPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_PP_MoveUp(structuredSelection);
	...
	private void C_PP_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Property Parameter Move Up");
		try {
			...
			CorePlugin.logError(
					"Transaction: Property Parameter Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnC_PPAction
