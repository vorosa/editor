//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/EventIgnoredCellProvider.java
//
...
public class EventIgnoredCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((EventIgnored_c) element).getDescrip()) )
            {
                ((EventIgnored_c) element).setDescrip(value.toString());
            }
        }
