...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveUpOnO_TPARMAction.java
//
...
public class MoveUpOnO_TPARMAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveUpOnO_TPARMAction.
	 */
	public MoveUpOnO_TPARMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_TPARM_MoveUp(structuredSelection);
	...
	private void O_TPARM_MoveUp(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Operation Parameter Move Up");
		try {
			...
			CorePlugin.logError(
					"Transaction: Operation Parameter Move Up failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveUpOnO_TPARMAction
