...
//====================================================================
//
// File:    SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1.java
//
...
public class SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1
		extends
	...
	/**
	 * Constructors for SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1.
	 */
	public SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1() {
		super("");
		init();
	}

	public SpecializedPackageIgnoreInStateOnSM_EVTWizardPage1(String name) {
		super(name);
		init();
	}
	...
	public void onPageEntry() {
		Ooaofooa modelRoot = Selection
				.getModelRoot((StructuredSelection) ((SpecializedPackageIgnoreInStateOnSM_EVTWizard) getWizard())
						.getSelection());

		// cache for context
		StateMachineEvent_c v_event = ((SpecializedPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_event;
	...
	public void updateSelectedState() {
		...
		((SpecializedPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_state = this.State;
	}
	...
	public IWizardPage getNextPage() {
		((SpecializedPackageIgnoreInStateOnSM_EVTWizard) getWizard()).v_state = State;
