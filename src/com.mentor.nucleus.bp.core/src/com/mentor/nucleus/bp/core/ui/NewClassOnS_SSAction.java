...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewClassOnS_SSAction.java
//
...
public class NewClassOnS_SSAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewClassOnS_SSAction.
	 */
	public NewClassOnS_SSAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		S_SS_NewClass(structuredSelection);
	...
	private void S_SS_NewClass(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("New Class");
		try {
			...
			CorePlugin.logError("Transaction: New Class failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end NewClassOnS_SSAction
