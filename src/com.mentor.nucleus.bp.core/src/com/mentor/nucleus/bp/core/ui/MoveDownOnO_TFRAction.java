...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MoveDownOnO_TFRAction.java
//
...
public class MoveDownOnO_TFRAction implements IObjectActionDelegate {

	/**
	 * Constructor for MoveDownOnO_TFRAction.
	 */
	public MoveDownOnO_TFRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		O_TFR_MoveDown(structuredSelection);
	...
	private void O_TFR_MoveDown(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Operation Move Down");
		try {
			...
			CorePlugin.logError("Transaction: Operation Move Down failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MoveDownOnO_TFRAction
