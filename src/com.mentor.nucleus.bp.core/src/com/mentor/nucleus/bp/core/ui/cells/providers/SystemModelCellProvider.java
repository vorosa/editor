//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/SystemModelCellProvider.java
//
...
public class SystemModelCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((SystemModel_c) element).getName()) )
            {
                ((SystemModel_c) element).setName(value.toString());
            }
        }
