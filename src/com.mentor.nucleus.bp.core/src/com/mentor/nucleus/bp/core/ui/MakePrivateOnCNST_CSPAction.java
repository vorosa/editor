...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/MakePrivateOnCNST_CSPAction.java
//
...
public class MakePrivateOnCNST_CSPAction implements IObjectActionDelegate {

	/**
	 * Constructor for MakePrivateOnCNST_CSPAction.
	 */
	public MakePrivateOnCNST_CSPAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CNST_CSP_MakePrivate(structuredSelection);
	...
	private void CNST_CSP_MakePrivate(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Constant Specification Make Private");
		try {
			...
			CorePlugin
					.logError(
							"Transaction: Constant Specification Make Private failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end MakePrivateOnCNST_CSPAction
