...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SpecializedPackageIgnoreEventOnSM_STATEAction.java
//
...
public class SpecializedPackageIgnoreEventOnSM_STATEAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for SpecializedPackageIgnoreEventOnSM_STATEAction.
	 */
	public SpecializedPackageIgnoreEventOnSM_STATEAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_STATE_SpecializedPackageIgnoreEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_STATE_SpecializedPackageIgnoreEvent(
			IStructuredSelection selection) {
		SpecializedPackageIgnoreEventOnSM_STATEWizard wizard = new SpecializedPackageIgnoreEventOnSM_STATEWizard();
...
} // end SpecializedPackageIgnoreEventOnSM_STATEAction
