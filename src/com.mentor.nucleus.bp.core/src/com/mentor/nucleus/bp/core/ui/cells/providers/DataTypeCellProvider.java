//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/DataTypeCellProvider.java
//
...
public class DataTypeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((DataType_c) element).getName()) )
            {
                ((DataType_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((DataType_c) element).getDescrip()) )
            {
                ((DataType_c) element).setDescrip(value.toString());
            }
        }
        if(data.getName().equals("DefaultValue"))
        {
            if ( ! value.toString().equals(((DataType_c) element).getDefaultvalue()) )
            {
                ((DataType_c) element).setDefaultvalue(value.toString());
            }
        }
