...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetToProviderOnC_IOAction.java
//
...
public class SetToProviderOnC_IOAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetToProviderOnC_IOAction.
	 */
	public SetToProviderOnC_IOAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_IO_SetToProvider(structuredSelection);
	...
	private void C_IO_SetToProvider(IStructuredSelection selection) {
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Interface Operation Set To Provider");
		try {
			...
			if (((v_io != null))) {
				...
				if (v_io != null) {
					v_io.setDirection(Ifdirectiontype_c.ClientServer);
				} else {
			...
			CorePlugin
					.logError(
							"Transaction: Interface Operation Set To Provider failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end SetToProviderOnC_IOAction
