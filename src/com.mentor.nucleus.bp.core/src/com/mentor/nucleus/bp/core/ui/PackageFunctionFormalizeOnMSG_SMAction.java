...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/PackageFunctionFormalizeOnMSG_SMAction.java
//
...
public class PackageFunctionFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for PackageFunctionFormalizeOnMSG_SMAction.
	 */
	public PackageFunctionFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_PackageFunctionFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_PackageFunctionFormalize(
...
} // end PackageFunctionFormalizeOnMSG_SMAction
