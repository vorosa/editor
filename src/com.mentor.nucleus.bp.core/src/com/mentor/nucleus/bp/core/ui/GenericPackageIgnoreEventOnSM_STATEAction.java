...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/GenericPackageIgnoreEventOnSM_STATEAction.java
//
...
public class GenericPackageIgnoreEventOnSM_STATEAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for GenericPackageIgnoreEventOnSM_STATEAction.
	 */
	public GenericPackageIgnoreEventOnSM_STATEAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = SM_STATE_GenericPackageIgnoreEvent(structuredSelection);
		wd.open();
	...
	public WizardDialog SM_STATE_GenericPackageIgnoreEvent(
			IStructuredSelection selection) {
		GenericPackageIgnoreEventOnSM_STATEWizard wizard = new GenericPackageIgnoreEventOnSM_STATEWizard();
...
} // end GenericPackageIgnoreEventOnSM_STATEAction
