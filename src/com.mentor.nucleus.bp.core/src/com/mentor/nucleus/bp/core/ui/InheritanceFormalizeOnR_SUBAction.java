...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/InheritanceFormalizeOnR_SUBAction.java
//
...
public class InheritanceFormalizeOnR_SUBAction implements IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for InheritanceFormalizeOnR_SUBAction.
	 */
	public InheritanceFormalizeOnR_SUBAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = R_SUB_InheritanceFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog R_SUB_InheritanceFormalize(
			IStructuredSelection selection) {
		InheritanceFormalizeOnR_SUBWizard wizard = new InheritanceFormalizeOnR_SUBWizard();
...
} // end InheritanceFormalizeOnR_SUBAction
