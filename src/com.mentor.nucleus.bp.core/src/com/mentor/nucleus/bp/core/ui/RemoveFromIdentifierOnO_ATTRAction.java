...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/RemoveFromIdentifierOnO_ATTRAction.java
//
...
// creates new Remove from Identifiers.
//
...
public class RemoveFromIdentifierOnO_ATTRAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for RemoveFromIdentifierOnO_ATTRAction.
	 */
	public RemoveFromIdentifierOnO_ATTRAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = O_ATTR_RemoveFromIdentifier(structuredSelection);
		wd.open();
	...
	public WizardDialog O_ATTR_RemoveFromIdentifier(
...
} // end RemoveFromIdentifierOnO_ATTRAction
