...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewEventOnSM_ASMAction.java
//
...
public class NewEventOnSM_ASMAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewEventOnSM_ASMAction.
	 */
	public NewEventOnSM_ASMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		SM_ASM_NewEvent(structuredSelection);
	...
	private void SM_ASM_NewEvent(IStructuredSelection selection) {
		...
		ClassStateMachine_c v_asm = (ClassStateMachine_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_asm
				.getModelRoot());
