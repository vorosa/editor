//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/PackageParticipantCellProvider.java
//
...
public class PackageParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("InformalName"))
        {
            if ( ! value.toString().equals(((PackageParticipant_c) element).getInformalname()) )
            {
                ((PackageParticipant_c) element).setInformalname(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((PackageParticipant_c) element).getDescrip()) )
            {
                ((PackageParticipant_c) element).setDescrip(value.toString());
            }
        }
