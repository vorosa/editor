...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/SetTypeOnCNST_LSCAction.java
//
...
public class SetTypeOnCNST_LSCAction implements IObjectActionDelegate {

	/**
	 * Constructor for SetTypeOnCNST_LSCAction.
	 */
	public SetTypeOnCNST_LSCAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		CNST_LSC_SetType(structuredSelection);
	}
	/**
	...
	public static void CNST_LSC_SetType(IStructuredSelection selection) {
    // Assign the context selection variables with the action context 
      ...
      LiteralSymbolicConstant_c v_element = (LiteralSymbolicConstant_c)context;
        // select related by where USER::selectExisting
DataType_c v_existingElement = DataType_c.getOneS_DTOnR1500(SymbolicConstant_c.getOneCNST_SYCOnR1502(LeafSymbolicConstant_c.getOneCNST_LFSCOnR1503(v_element)));
      ...
      PackageableElement_c pe = PackageableElement_c.getOnePE_PEOnR8001(ConstantSpecification_c.getOneCNST_CSPOnR1504(SymbolicConstant_c.getOneCNST_SYCOnR1502(LeafSymbolicConstant_c.getOneCNST_LFSCOnR1503(v_element))));
...
for(Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
	v_element = (LiteralSymbolicConstant_c) iterator.next();
	if ( (  (v_element != null)) )
{
...
SymbolicConstant_c v_syc = SymbolicConstant_c.getOneCNST_SYCOnR1502(LeafSymbolicConstant_c.getOneCNST_LFSCOnR1503(v_element));
...
if (v_element != null) {
v_element.Updatevaluetodefault(			    
v_selectedDT.getName() ) ;
}
else {
  Throwable t = new Throwable();
  t.fillInStackTrace();
  CorePlugin.logError("Attempted to call an operation on a null instance.", t);
	...
	public static DataType_c[] getElements(LiteralSymbolicConstant_c v_element) {
  ...
  } // end getElements(LiteralSymbolicConstant_c) 
} // end SetTypeOnCNST_LSCAction
