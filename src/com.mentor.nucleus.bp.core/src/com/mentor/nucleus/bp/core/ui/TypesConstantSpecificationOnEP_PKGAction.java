...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/TypesConstantSpecificationOnEP_PKGAction.java
//
...
// creates new Constant Specifications.
//
...
public class TypesConstantSpecificationOnEP_PKGAction
		implements
			IObjectActionDelegate {

	/**
	 * Constructor for TypesConstantSpecificationOnEP_PKGAction.
	 */
	public TypesConstantSpecificationOnEP_PKGAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		EP_PKG_TypesConstantSpecification(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"ConstantSpecification_c", false));
	}
	private void EP_PKG_TypesConstantSpecification(
		...
		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Types Constant Specification");
		boolean abortTransaction = false;
		try {
			// Ensure that actions take place between Verifier Activity executions
			Ooaofooa.beginSaveOperation();
			if (v_pkg != null) {
				v_pkg.Newconstantspecification();
			} else {
			...
			NonRootModelElement[] children = ConstantSpecification_c
			...
			CorePlugin.logError(
					"Transaction: Types Constant Specification failed", e);//$NON-NLS-1$
		}
		if ((!CorePlugin
				.getDefault()
				.getPreferenceStore()
...
} // end TypesConstantSpecificationOnEP_PKGAction
