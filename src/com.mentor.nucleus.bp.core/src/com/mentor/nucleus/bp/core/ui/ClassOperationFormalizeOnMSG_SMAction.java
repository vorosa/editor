...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/ClassOperationFormalizeOnMSG_SMAction.java
//
...
public class ClassOperationFormalizeOnMSG_SMAction
		implements
			IObjectActionDelegate {
	private IWorkbenchPart m_part;

	/**
	 * Constructor for ClassOperationFormalizeOnMSG_SMAction.
	 */
	public ClassOperationFormalizeOnMSG_SMAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		WizardDialog wd = MSG_SM_ClassOperationFormalize(structuredSelection);
		wd.open();
	...
	public WizardDialog MSG_SM_ClassOperationFormalize(
...
} // end ClassOperationFormalizeOnMSG_SMAction
