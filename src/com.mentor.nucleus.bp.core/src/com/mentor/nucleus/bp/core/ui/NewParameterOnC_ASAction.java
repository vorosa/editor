...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/NewParameterOnC_ASAction.java
//
...
public class NewParameterOnC_ASAction implements IObjectActionDelegate {

	/**
	 * Constructor for NewParameterOnC_ASAction.
	 */
	public NewParameterOnC_ASAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		C_AS_NewParameter(structuredSelection);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		action.setImageDescriptor(CorePlugin.getImageDescriptorFor(
				"PropertyParameter_c", false));
	}
	private void C_AS_NewParameter(IStructuredSelection selection) {
		...
		try {
			...
			NonRootModelElement[] children = PropertyParameter_c
					.getManyC_PPsOnR4006(ExecutableProperty_c
							.getManyC_EPsOnR4004(v_signal))
