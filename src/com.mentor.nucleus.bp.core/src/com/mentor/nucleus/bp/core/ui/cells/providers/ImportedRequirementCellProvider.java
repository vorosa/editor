//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ImportedRequirementCellProvider.java
//
...
public class ImportedRequirementCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ImportedRequirement_c) element).getDescrip()) )
            {
                ((ImportedRequirement_c) element).setDescrip(value.toString());
            }
        }
