//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ActorParticipantCellProvider.java
//
...
public class ActorParticipantCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Name"))
        {
            if ( ! value.toString().equals(((ActorParticipant_c) element).getName()) )
            {
                ((ActorParticipant_c) element).setName(value.toString());
            }
        }
        if(data.getName().equals("Descrip"))
        {
            if ( ! value.toString().equals(((ActorParticipant_c) element).getDescrip()) )
            {
                ((ActorParticipant_c) element).setDescrip(value.toString());
            }
        }
