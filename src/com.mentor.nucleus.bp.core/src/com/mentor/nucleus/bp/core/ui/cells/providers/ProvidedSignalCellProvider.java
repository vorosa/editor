//========================================================================
//
// File: src/com/mentor/nucleus/bp/core/ui/cells/ProvidedSignalCellProvider.java
//
...
public class ProvidedSignalCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Suc_Pars"))
        {
            ...
            if ( new_val != ((ProvidedSignal_c) element).getSuc_pars() )
            {
                ((ProvidedSignal_c) element).setSuc_pars(new_val);
            }
        }
