...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/ui/UnformalizeOnCOMM_LNKAction.java
//
...
public class UnformalizeOnCOMM_LNKAction implements IObjectActionDelegate {

	/**
	 * Constructor for UnformalizeOnCOMM_LNKAction.
	 */
	public UnformalizeOnCOMM_LNKAction() {
		super();
	}
	/**
	...
	public void run(IAction action) {
		...
		COMM_LNK_Unformalize(structuredSelection);
	...
	private void COMM_LNK_Unformalize(IStructuredSelection selection) {
		...
		CommunicationLink_c v_link = (CommunicationLink_c) context;
		PersistableModelComponent.ensureCoreDataTypesAvailable(v_link
				.getModelRoot());

		TransactionUtil.TransactionGroup transactionGroup = TransactionUtil
				.startTransactionsOnSelectedModelRoots("Communication Link Unformalize");
		try {
			...
			CorePlugin.logError(
					"Transaction: Communication Link Unformalize failed", e);//$NON-NLS-1$
		}
		TransactionUtil.endTransactions(transactionGroup);

	}
} // end UnformalizeOnCOMM_LNKAction
