...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/ClassStateMachinesAdapter.java
//
...
// class ClassStateMachine_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'ClassStateMachine_c'
 ...
 * </p>
 */
public class ClassStateMachinesAdapter implements ITreeContentProvider {
	static ClassStateMachinesAdapter classstatemachinesadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static ClassStateMachinesAdapter getInstance() {
		if (classstatemachinesadapter == null) {
			classstatemachinesadapter = new ClassStateMachinesAdapter();
		}
		return classstatemachinesadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		ModelClass_c result19 = ModelClass_c
				.getOneO_OBJOnR519((ClassStateMachine_c) arg);
		if (result19 != null) {
			return result19;
		}
		return null;
	...
	public Object[] getChildren(Object arg) {
		...
		StateMachineState_c[] states_517_1 = StateMachineState_c
				.getManySM_STATEsOnR501(StateMachine_c
						.getManySM_SMsOnR517((ClassStateMachine_c) arg));
