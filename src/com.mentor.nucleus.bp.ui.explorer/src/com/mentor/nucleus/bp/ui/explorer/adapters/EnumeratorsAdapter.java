...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/EnumeratorsAdapter.java
//
...
// class Enumerator_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'Enumerator_c'
 ...
 * </p>
 */
public class EnumeratorsAdapter implements ITreeContentProvider {
	static EnumeratorsAdapter enumeratorsadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static EnumeratorsAdapter getInstance() {
		if (enumeratorsadapter == null) {
			enumeratorsadapter = new EnumeratorsAdapter();
		}
		return enumeratorsadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		EnumerationDataType_c result43 = EnumerationDataType_c
				.getOneS_EDTOnR27((Enumerator_c) arg);
		if (result43 != null) {
			return result43;
		}
		return null;
