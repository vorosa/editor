...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/DeliveredEventsAdapter.java
//
 ...
 * </p>
 */
public class DeliveredEventsAdapter implements ITreeContentProvider {
	static DeliveredEventsAdapter deliveredeventsadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static DeliveredEventsAdapter getInstance() {
		if (deliveredeventsadapter == null) {
			deliveredeventsadapter = new DeliveredEventsAdapter();
		}
		return deliveredeventsadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		InstanceStateMachine_c result17 = InstanceStateMachine_c
				.getOneSM_ISMOnR517(StateMachine_c.getOneSM_SMOnR502(StateMachineEvent_c.getOneSM_EVTOnR525(PolymorphicEvent_c
						.getOneSM_PEVTOnR525((StateMachineEvent_c) arg))));
		if (result17 != null) {
			return result17;
		}
		return null;
