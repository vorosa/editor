...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/OperationParametersAdapter.java
//
...
// class OperationParameter_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'OperationParameter_c'
 ...
 * </p>
 */
public class OperationParametersAdapter implements ITreeContentProvider {
	static OperationParametersAdapter operationparametersadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static OperationParametersAdapter getInstance() {
		if (operationparametersadapter == null) {
			operationparametersadapter = new OperationParametersAdapter();
		}
		return operationparametersadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		Operation_c result10 = Operation_c
				.getOneO_TFROnR117((OperationParameter_c) arg);
		if (result10 != null) {
			return result10;
		}
		return null;
