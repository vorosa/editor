...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/EventMessageArgumentsAdapter.java
//
 ...
 * </p>
 */
public class EventMessageArgumentsAdapter implements ITreeContentProvider {
	static EventMessageArgumentsAdapter eventmessageargumentsadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static EventMessageArgumentsAdapter getInstance() {
		if (eventmessageargumentsadapter == null) {
			eventmessageargumentsadapter = new EventMessageArgumentsAdapter();
		}
		return eventmessageargumentsadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		AsynchronousMessage_c result62 = AsynchronousMessage_c
				.getOneMSG_AMOnR1019(EventMessage_c.getOneMSG_EOnR1019(AsynchronousMessage_c
