...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/ObjectnodesAdapter.java
//
...
// class ObjectNode_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'ObjectNode_c'
 ...
 * </p>
 */
public class ObjectnodesAdapter implements ITreeContentProvider {
	static ObjectnodesAdapter objectnodesadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static ObjectnodesAdapter getInstance() {
		if (objectnodesadapter == null) {
			objectnodesadapter = new ObjectnodesAdapter();
		}
		return objectnodesadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		Activity_c result148 = Activity_c.getOneA_AOnR1101(ActivityNode_c
				.getOneA_NOnR1105((ObjectNode_c) arg));
		if (result148 != null) {
			return result148;
		}
		Package_c result149 = Package_c
				.getOneEP_PKGOnR8000(PackageableElement_c
						.getOnePE_PEOnR8001(ActivityNode_c
								.getOneA_NOnR1105((ObjectNode_c) arg)));
		if (result149 != null) {
			return result149;
		}
