...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/FunctionMessageArgumentsAdapter.java
//
 ...
 * </p>
 */
public class FunctionMessageArgumentsAdapter implements ITreeContentProvider {
	static FunctionMessageArgumentsAdapter functionmessageargumentsadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static FunctionMessageArgumentsAdapter getInstance() {
		if (functionmessageargumentsadapter == null) {
			functionmessageargumentsadapter = new FunctionMessageArgumentsAdapter();
		}
		return functionmessageargumentsadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		SynchronousMessage_c result63 = SynchronousMessage_c
				.getOneMSG_SMOnR1020(FunctionMessage_c.getOneMSG_FOnR1020(SynchronousMessage_c
