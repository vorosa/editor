...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/CoreDataTypesAdapter.java
//
...
// class CoreDataType_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'CoreDataType_c'
 ...
 * </p>
 */
public class CoreDataTypesAdapter implements ITreeContentProvider {
	static CoreDataTypesAdapter coredatatypesadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static CoreDataTypesAdapter getInstance() {
		if (coredatatypesadapter == null) {
			coredatatypesadapter = new CoreDataTypesAdapter();
		}
		return coredatatypesadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		DataTypePackage_c result44 = DataTypePackage_c
				.getOneS_DPKOnR39(DataType_c
						.getOneS_DTOnR17((CoreDataType_c) arg));
		if (result44 != null) {
			return result44;
		}
		Package_c result45 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c
