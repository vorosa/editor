...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/explorer/adapters/AttributesAdapter.java
//
...
// class Attribute_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'Attribute_c'
 ...
 * </p>
 */
public class AttributesAdapter implements ITreeContentProvider {
	static AttributesAdapter attributesadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static AttributesAdapter getInstance() {
		if (attributesadapter == null) {
			attributesadapter = new AttributesAdapter();
		}
	...
	public Object getParent(Object arg) {
		ModelClass_c result8 = ModelClass_c
				.getOneO_OBJOnR102((Attribute_c) arg);
		if (result8 != null) {
			return result8;
		}
		return null;
