//======================================================================
//
// File: ComponentPackageNameValidator.java
//
...
public class ComponentPackageNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof ComponentPackage_c) ) {
            return "Can't happen: Component Packages not selected";
        }
        ComponentPackage_c element = null;
        if (context instanceof ComponentPackage_c) {
            element = (ComponentPackage_c) context;
        }
