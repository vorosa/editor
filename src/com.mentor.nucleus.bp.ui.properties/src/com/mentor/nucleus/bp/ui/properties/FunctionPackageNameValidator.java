//======================================================================
//
// File: FunctionPackageNameValidator.java
//
...
public class FunctionPackageNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof FunctionPackage_c) ) {
            return "Can't happen: Function Package not selected";
        }
        FunctionPackage_c element = null;
        if (context instanceof FunctionPackage_c) {
            element = (FunctionPackage_c) context;
        }
