//======================================================================
//
// File: AssociationI_LIPPropertySource.java
//
...
public class AssociationI_LIPPropertySource implements IPropertySource {
	private LinkParticipation_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public AssociationI_LIPPropertySource(LinkParticipation_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if (m_propertyDescriptors == null || 1 != m_propertyDescriptors.length) {
			...
			m_propertyDescriptors[0] = new PropertyDescriptor("Label", "");
