//======================================================================
//
// File: AssociativeOneEndR_AONEPropertySource.java
//
...
public class AssociativeOneEndR_AONEPropertySource implements IPropertySource {
	private ClassAsAssociatedOneSide_c m_inst;
	...
	public AssociativeOneEndR_AONEPropertySource(ClassAsAssociatedOneSide_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		ModelClass_c[] v_classRelated = ModelClass_c
				.getManyO_OBJsOnR201(ClassInAssociation_c.getManyR_OIRsOnR203(ReferredToClassInAssoc_c
						.getManyR_RTOsOnR204((ClassAsAssociatedOneSide_c) m_inst)));
		...
		try {
			if (id.equals("Mult")) {
				...
				if (new_val != m_inst.getMult()) {
					trans_name = "Change in property: 'Mult' of Class As Associated One Side";//$NON-NLS-1$
				...
				if (new_val != m_inst.getCond()) {
					trans_name = "Change in property: 'Cond' of Class As Associated One Side";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
				...
				if (!value.toString().equals(m_inst.getTxt_phrs())) {
					trans_name = "Change in property: 'Txt_Phrs' of Class As Associated One Side";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
