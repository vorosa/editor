//======================================================================
//
// File: FormalEventMSG_EPropertySource.java
//
...
public class FormalEventMSG_EPropertySource implements IPropertySource {
	private EventMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalEventMSG_EPropertySource(EventMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
