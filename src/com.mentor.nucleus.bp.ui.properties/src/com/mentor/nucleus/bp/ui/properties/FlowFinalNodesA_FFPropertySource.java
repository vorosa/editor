//======================================================================
//
// File: FlowFinalNodesA_FFPropertySource.java
//
...
public class FlowFinalNodesA_FFPropertySource implements IPropertySource {
	private FlowFinalNode_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FlowFinalNodesA_FFPropertySource(FlowFinalNode_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if (m_propertyDescriptors == null || 1 != m_propertyDescriptors.length) {
			...
			m_propertyDescriptors[0] = new DescriptionPropertyDescriptor(
					"Descrip", "Final Flow Description", m_inst);
		...
		try {
			if (id.equals("Descrip")) {
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Flow Final Node";//$NON-NLS-1$
