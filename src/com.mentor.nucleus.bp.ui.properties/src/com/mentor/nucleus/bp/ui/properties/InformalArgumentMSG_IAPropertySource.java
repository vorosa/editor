//======================================================================
//
// File: InformalArgumentMSG_IAPropertySource.java
//
...
public class InformalArgumentMSG_IAPropertySource implements IPropertySource {
	private InformalArgument_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public InformalArgumentMSG_IAPropertySource(InformalArgument_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
