//======================================================================
//
// File: PackageNameValidator.java
//
...
public class PackageNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof Package_c) ) {
            return "Can't happen: Packages not selected";
        }
        Package_c element = null;
        if (context instanceof Package_c) {
            element = (Package_c) context;
        }
