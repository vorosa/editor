//======================================================================
//
// File: ExternalEntityEventDataS_EEEDTPropertySource.java
//
...
public class ExternalEntityEventDataS_EEEDTPropertySource
		implements
			IPropertySource {
	private ExternalEntityEventData_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public ExternalEntityEventDataS_EEEDTPropertySource(
			ExternalEntityEventData_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
