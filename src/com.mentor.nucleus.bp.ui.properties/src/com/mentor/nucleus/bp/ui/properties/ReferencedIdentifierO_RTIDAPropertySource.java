//======================================================================
//
// File: ReferencedIdentifierO_RTIDAPropertySource.java
//
...
public class ReferencedIdentifierO_RTIDAPropertySource
		implements
			IPropertySource {
	private ReferredToIdentifierAttribute_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public ReferencedIdentifierO_RTIDAPropertySource(
			ReferredToIdentifierAttribute_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
