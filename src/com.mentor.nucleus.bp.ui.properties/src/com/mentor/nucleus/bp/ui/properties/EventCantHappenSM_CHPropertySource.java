//======================================================================
//
// File: EventCantHappenSM_CHPropertySource.java
//
...
public class EventCantHappenSM_CHPropertySource implements IPropertySource {
	private CantHappen_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public EventCantHappenSM_CHPropertySource(CantHappen_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
		...
		try {
			if (id.equals("Descrip")) {
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Cant Happen";//$NON-NLS-1$
