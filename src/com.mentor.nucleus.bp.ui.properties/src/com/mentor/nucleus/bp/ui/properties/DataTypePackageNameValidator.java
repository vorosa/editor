//======================================================================
//
// File: DataTypePackageNameValidator.java
//
...
public class DataTypePackageNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof DataTypePackage_c) ) {
            return "Can't happen: Data Type Package not selected";
        }
        DataTypePackage_c element = null;
        if (context instanceof DataTypePackage_c) {
            element = (DataTypePackage_c) context;
        }
