//======================================================================
//
// File: SubsystemNameValidator.java
//
...
public class SubsystemNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof Subsystem_c) ) {
            return "Can't happen: Subsystem not selected";
        }
        Subsystem_c element = null;
        if (context instanceof Subsystem_c) {
            element = (Subsystem_c) context;
        }
