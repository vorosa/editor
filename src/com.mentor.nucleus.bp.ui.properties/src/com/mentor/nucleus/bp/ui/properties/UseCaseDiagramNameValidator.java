//======================================================================
//
// File: UseCaseDiagramNameValidator.java
//
...
public class UseCaseDiagramNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof UseCaseDiagram_c) ) {
            return "Can't happen: Use Case Diagrams not selected";
        }
        UseCaseDiagram_c element = null;
        if (context instanceof UseCaseDiagram_c) {
            element = (UseCaseDiagram_c) context;
        }
