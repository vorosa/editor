//======================================================================
//
// File: ActionSM_ACTPropertySource.java
//
...
public class ActionSM_ACTPropertySource implements IPropertySource {
	private Action_c m_inst;
	...
	public ActionSM_ACTPropertySource(Action_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if (m_propertyDescriptors == null || 3 != m_propertyDescriptors.length) {
			...
			m_propertyDescriptors[0] = new EnumPropertyDescriptor("Suc_Pars",
			...
			m_propertyDescriptors[1] = new ActivityPropertyDescriptor(
		...
		try {
			if (id.equals("Suc_Pars")) {
				...
				if (new_val != m_inst.getSuc_pars()) {
					trans_name = "Change in property: 'Suc_Pars' of Action";//$NON-NLS-1$
				...
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Action";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
