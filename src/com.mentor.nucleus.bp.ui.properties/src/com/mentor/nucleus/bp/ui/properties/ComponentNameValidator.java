//======================================================================
//
// File: ComponentNameValidator.java
//
...
public class ComponentNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof Component_c) ) {
            return "Can't happen: Components not selected";
        }
        Component_c element = null;
        if (context instanceof Component_c) {
            element = (Component_c) context;
        }
