//======================================================================
//
// File: UseCaseDiagramsUC_UCCPropertySource.java
//
...
public class UseCaseDiagramsUC_UCCPropertySource implements IPropertySource {
	private UseCaseDiagram_c m_inst;
	...
	public UseCaseDiagramsUC_UCCPropertySource(UseCaseDiagram_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		UseCaseDiagram_c[] v_usecasediagrams = UseCaseDiagram_c
				.getManyUC_UCCsOnR1209(UseCaseInUseCase_c
						.getManyUC_UIUsOnR1208((UseCaseDiagram_c) m_inst));
		...
		UseCaseParticipant_c[] v_usecases = UseCaseParticipant_c
				.getManyIA_UCPsOnR930(InteractionParticipant_c.getManySQ_PsOnR1203(ParticipantInUseCase_c
						.getManyUC_PIUCsOnR1203((UseCaseDiagram_c) m_inst)));
		...
		if (m_propertyDescriptors == null
			...
			m_propertyDescriptors[1] = new DescriptionPropertyDescriptor(
					"Descrip", "Use Case Diagram Description", m_inst);
		...
		if (m_propertyDescriptors.length > 0)
			m_propertyDescriptors[0]
					.setValidator(new UseCaseDiagramNameValidator());
		...
		try {
			if (id.equals("Name")) {
				if (!value.toString().equals(m_inst.getName())) {
					trans_name = "Change in property: 'Name' of Use Case Diagram";//$NON-NLS-1$
				...
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Use Case Diagram";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
