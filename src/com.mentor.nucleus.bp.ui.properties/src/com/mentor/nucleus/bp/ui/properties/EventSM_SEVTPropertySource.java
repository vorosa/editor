//======================================================================
//
// File: EventSM_SEVTPropertySource.java
//
...
public class EventSM_SEVTPropertySource implements IPropertySource {
	private SemEvent_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public EventSM_SEVTPropertySource(SemEvent_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
