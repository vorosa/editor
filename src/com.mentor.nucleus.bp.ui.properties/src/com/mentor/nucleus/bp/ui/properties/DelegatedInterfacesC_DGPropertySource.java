//======================================================================
//
// File: DelegatedInterfacesC_DGPropertySource.java
//
...
public class DelegatedInterfacesC_DGPropertySource implements IPropertySource {
	private Delegation_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public DelegatedInterfacesC_DGPropertySource(Delegation_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
