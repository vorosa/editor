//======================================================================
//
// File: InstanceStateMachineNameValidator.java
//
...
public class InstanceStateMachineNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof InstanceStateMachine_c) ) {
            return "Can't happen: Instance State Chart not selected";
        }
        InstanceStateMachine_c element = null;
        if (context instanceof InstanceStateMachine_c) {
            element = (InstanceStateMachine_c) context;
        }
