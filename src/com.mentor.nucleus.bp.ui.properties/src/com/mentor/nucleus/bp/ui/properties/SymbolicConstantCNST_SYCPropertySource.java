//======================================================================
//
// File: SymbolicConstantCNST_SYCPropertySource.java
//
...
public class SymbolicConstantCNST_SYCPropertySource implements IPropertySource {
	private SymbolicConstant_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public SymbolicConstantCNST_SYCPropertySource(SymbolicConstant_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
		...
		try {
			if (id.equals("Name")) {
				if (!value.toString().equals(m_inst.getName())) {
					trans_name = "Change in property: 'Name' of Symbolic Constant";//$NON-NLS-1$
				...
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Symbolic Constant";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
