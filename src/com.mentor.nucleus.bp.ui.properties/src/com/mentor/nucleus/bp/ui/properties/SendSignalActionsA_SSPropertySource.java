//======================================================================
//
// File: SendSignalActionsA_SSPropertySource.java
//
...
public class SendSignalActionsA_SSPropertySource implements IPropertySource {
	private SendSignal_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public SendSignalActionsA_SSPropertySource(SendSignal_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
		...
		try {
			if (id.equals("Name")) {
				if (!value.toString().equals(m_inst.getName())) {
					trans_name = "Change in property: 'Name' of Send Signal";//$NON-NLS-1$
				...
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Send Signal";//$NON-NLS-1$
					tr = tm.startTransaction(trans_name,
							Ooaofooa.getDefaultInstance());
					value_changed = true;
