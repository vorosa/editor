//======================================================================
//
// File: SupertypeR_SUPERPropertySource.java
//
...
public class SupertypeR_SUPERPropertySource implements IPropertySource {
	private ClassAsSupertype_c m_inst;
	...
	public SupertypeR_SUPERPropertySource(ClassAsSupertype_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		ModelClass_c[] v_classRelated = ModelClass_c
				.getManyO_OBJsOnR201(ClassInAssociation_c.getManyR_OIRsOnR203(ReferredToClassInAssoc_c
						.getManyR_RTOsOnR204((ClassAsSupertype_c) m_inst)));
