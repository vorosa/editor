//======================================================================
//
// File: InterfaceNameValidator.java
//
...
public class InterfaceNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof Interface_c) ) {
            return "Can't happen: Interfaces not selected";
        }
        Interface_c element = null;
        if (context instanceof Interface_c) {
            element = (Interface_c) context;
        }
