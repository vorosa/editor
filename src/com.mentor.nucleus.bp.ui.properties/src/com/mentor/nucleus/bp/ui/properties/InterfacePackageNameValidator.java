//======================================================================
//
// File: InterfacePackageNameValidator.java
//
...
public class InterfacePackageNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof InterfacePackage_c) ) {
            return "Can't happen: Interface Packages not selected";
        }
        InterfacePackage_c element = null;
        if (context instanceof InterfacePackage_c) {
            element = (InterfacePackage_c) context;
        }
