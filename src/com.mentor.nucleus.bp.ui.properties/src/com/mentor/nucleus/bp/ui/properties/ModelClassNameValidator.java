//======================================================================
//
// File: ModelClassNameValidator.java
//
...
public class ModelClassNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof ModelClass_c) ) {
            return "Can't happen: Class not selected";
        }
        ModelClass_c element = null;
        if (context instanceof ModelClass_c) {
            element = (ModelClass_c) context;
        }
