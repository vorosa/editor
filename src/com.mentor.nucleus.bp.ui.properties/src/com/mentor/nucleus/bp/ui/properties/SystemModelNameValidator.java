//======================================================================
//
// File: SystemModelNameValidator.java
//
...
public class SystemModelNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof SystemModel_c) ) {
            return "Can't happen: System not selected";
        }
        SystemModel_c element = null;
        if (context instanceof SystemModel_c) {
            element = (SystemModel_c) context;
        }
