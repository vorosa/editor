//======================================================================
//
// File: FormalFunctionMSG_FPropertySource.java
//
...
public class FormalFunctionMSG_FPropertySource implements IPropertySource {
	private FunctionMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalFunctionMSG_FPropertySource(FunctionMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
