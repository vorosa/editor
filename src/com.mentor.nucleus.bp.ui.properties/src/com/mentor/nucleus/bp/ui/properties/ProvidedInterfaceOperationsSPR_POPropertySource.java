//======================================================================
//
// File: ProvidedInterfaceOperationsSPR_POPropertySource.java
//
...
public class ProvidedInterfaceOperationsSPR_POPropertySource
		implements
			IPropertySource {
	private ProvidedOperation_c m_inst;
	...
	public ProvidedInterfaceOperationsSPR_POPropertySource(
			ProvidedOperation_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		PropertyParameter_c[] v_parameters = PropertyParameter_c
				.getManyC_PPsOnR4006(ExecutableProperty_c.getManyC_EPsOnR4501(ProvidedExecutableProperty_c
						.getManySPR_PEPsOnR4503((ProvidedOperation_c) m_inst)));
		...
		if (m_propertyDescriptors == null
			...
			m_propertyDescriptors[1] = new PropertyDescriptor("Descrip",
					"Provided Operation Description");
		...
		try {
			if (id.equals("Suc_Pars")) {
				...
				if (new_val != m_inst.getSuc_pars()) {
					trans_name = "Change in property: 'Suc_Pars' of Provided Operation";//$NON-NLS-1$
