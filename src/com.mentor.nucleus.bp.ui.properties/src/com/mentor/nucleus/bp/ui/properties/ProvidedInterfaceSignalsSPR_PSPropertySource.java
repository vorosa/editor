//======================================================================
//
// File: ProvidedInterfaceSignalsSPR_PSPropertySource.java
//
...
public class ProvidedInterfaceSignalsSPR_PSPropertySource
		implements
			IPropertySource {
	private ProvidedSignal_c m_inst;
	...
	public ProvidedInterfaceSignalsSPR_PSPropertySource(ProvidedSignal_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		PropertyParameter_c[] v_parameters = PropertyParameter_c
				.getManyC_PPsOnR4006(ExecutableProperty_c.getManyC_EPsOnR4501(ProvidedExecutableProperty_c
						.getManySPR_PEPsOnR4503((ProvidedSignal_c) m_inst)));
		...
		try {
			if (id.equals("Suc_Pars")) {
				...
				if (new_val != m_inst.getSuc_pars()) {
					trans_name = "Change in property: 'Suc_Pars' of Provided Signal";//$NON-NLS-1$
