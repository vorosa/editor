//======================================================================
//
// File: InformalMessageMSG_ISMPropertySource.java
//
...
public class InformalMessageMSG_ISMPropertySource implements IPropertySource {
	private InformalSynchronousMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public InformalMessageMSG_ISMPropertySource(
			InformalSynchronousMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
