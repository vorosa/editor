//======================================================================
//
// File: PolymorphicEventSM_PEVTPropertySource.java
//
...
public class PolymorphicEventSM_PEVTPropertySource implements IPropertySource {
	private PolymorphicEvent_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public PolymorphicEventSM_PEVTPropertySource(PolymorphicEvent_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
