//======================================================================
//
// File: RequiredInterfaceSignalsSPR_RSPropertySource.java
//
...
public class RequiredInterfaceSignalsSPR_RSPropertySource
		implements
			IPropertySource {
	private RequiredSignal_c m_inst;
	...
	public RequiredInterfaceSignalsSPR_RSPropertySource(RequiredSignal_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		PropertyParameter_c[] v_parameters = PropertyParameter_c
				.getManyC_PPsOnR4006(ExecutableProperty_c.getManyC_EPsOnR4500(RequiredExecutableProperty_c
						.getManySPR_REPsOnR4502((RequiredSignal_c) m_inst)));
		...
		try {
			if (id.equals("Suc_Pars")) {
				...
				if (new_val != m_inst.getSuc_pars()) {
					trans_name = "Change in property: 'Suc_Pars' of Required Signal";//$NON-NLS-1$
