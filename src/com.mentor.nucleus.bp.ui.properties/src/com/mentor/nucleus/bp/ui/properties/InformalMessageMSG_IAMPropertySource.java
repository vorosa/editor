//======================================================================
//
// File: InformalMessageMSG_IAMPropertySource.java
//
...
public class InformalMessageMSG_IAMPropertySource implements IPropertySource {
	private InformalAsynchronousMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public InformalMessageMSG_IAMPropertySource(
			InformalAsynchronousMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
