//======================================================================
//
// File: FormalSignalMSG_SIGPropertySource.java
//
...
public class FormalSignalMSG_SIGPropertySource implements IPropertySource {
	private SignalMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalSignalMSG_SIGPropertySource(SignalMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
