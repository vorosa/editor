//======================================================================
//
// File: FormalInterfaceOperationMSG_IOPPropertySource.java
//
...
public class FormalInterfaceOperationMSG_IOPPropertySource
		implements
			IPropertySource {
	private InterfaceOperationMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalInterfaceOperationMSG_IOPPropertySource(
			InterfaceOperationMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
