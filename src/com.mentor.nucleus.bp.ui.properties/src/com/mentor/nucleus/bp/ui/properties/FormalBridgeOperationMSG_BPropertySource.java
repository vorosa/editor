//======================================================================
//
// File: FormalBridgeOperationMSG_BPropertySource.java
//
...
public class FormalBridgeOperationMSG_BPropertySource
		implements
			IPropertySource {
	private BridgeMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalBridgeOperationMSG_BPropertySource(BridgeMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
