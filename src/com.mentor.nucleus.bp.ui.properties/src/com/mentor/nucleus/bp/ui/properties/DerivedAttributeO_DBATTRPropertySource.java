//======================================================================
//
// File: DerivedAttributeO_DBATTRPropertySource.java
//
...
public class DerivedAttributeO_DBATTRPropertySource implements IPropertySource {
	private DerivedBaseAttribute_c m_inst;
	...
	public DerivedAttributeO_DBATTRPropertySource(DerivedBaseAttribute_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if (m_propertyDescriptors == null || 2 != m_propertyDescriptors.length) {
			...
			m_propertyDescriptors[0] = new ActivityPropertyDescriptor(
			...
			m_propertyDescriptors[1] = new EnumPropertyDescriptor("Suc_Pars",
		...
		try {
			if (id.equals("Suc_Pars")) {
				...
				if (new_val != m_inst.getSuc_pars()) {
					trans_name = "Change in property: 'Suc_Pars' of Derived Base Attribute";//$NON-NLS-1$
