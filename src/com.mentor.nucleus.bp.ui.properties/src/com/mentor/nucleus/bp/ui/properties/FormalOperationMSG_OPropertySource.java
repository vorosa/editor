//======================================================================
//
// File: FormalOperationMSG_OPropertySource.java
//
...
public class FormalOperationMSG_OPropertySource implements IPropertySource {
	private OperationMessage_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public FormalOperationMSG_OPropertySource(OperationMessage_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
