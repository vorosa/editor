//======================================================================
//
// File: ActivityFinalNodesA_AFPropertySource.java
//
...
public class ActivityFinalNodesA_AFPropertySource implements IPropertySource {
	private ActivityFinalNode_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public ActivityFinalNodesA_AFPropertySource(ActivityFinalNode_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if (m_propertyDescriptors == null || 1 != m_propertyDescriptors.length) {
			...
			m_propertyDescriptors[0] = new DescriptionPropertyDescriptor(
					"Descrip", "Final Activity Description", m_inst);
		...
		try {
			if (id.equals("Descrip")) {
				if (!value.toString().equals(m_inst.getDescrip())) {
					trans_name = "Change in property: 'Descrip' of Activity Final Node";//$NON-NLS-1$
