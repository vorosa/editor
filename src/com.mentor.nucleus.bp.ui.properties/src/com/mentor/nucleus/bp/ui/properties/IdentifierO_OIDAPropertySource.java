//======================================================================
//
// File: IdentifierO_OIDAPropertySource.java
//
...
public class IdentifierO_OIDAPropertySource implements IPropertySource {
	private ClassIdentifierAttribute_c m_inst;
	private PropertyDescriptor[] m_propertyDescriptors;

	MetadataSortingManager sorter = MetadataSortingManager.createDefault();

	public IdentifierO_OIDAPropertySource(ClassIdentifierAttribute_c inst) {
		m_inst = inst;
	}
	/* (non-Javadoc)
