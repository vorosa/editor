...
public class DomainNameValidator implements ICellEditorValidator {
    ...
    public String isValid(Object value) {
        ...
        if (!(context instanceof Domain_c) ) {
            return "Can't happen: xtUML Model not selected";
        }
        Domain_c element = null;
        if (context instanceof Domain_c) {
            element = (Domain_c) context;
        }
