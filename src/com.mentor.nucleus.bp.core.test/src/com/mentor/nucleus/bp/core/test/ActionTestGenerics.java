...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/test/ActionTestGenerics.java
//
...
public class ActionTestGenerics extends CoreTest {
	...
	public void testNewC_IOParameter() throws Exception {
		...
		t1.relateAcrossR4008To(DataType_c
				.DataTypeInstances(SystemDatatypePackage_c
						.getOneSLD_SDPOnR4400(m_sys).getModelRoot())[0]);
