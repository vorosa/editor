//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/LayerCellProvider.java
//
...
public class LayerCellProvider implements ICellProvider {

    
	@Override
	public CellEditor getCellEditor(final NonRootModelElement element,
			Composite parent, ObjectElement data) {
                if(data.getName().equals("Layer_Name")) {
	                CellEditor editor = new TextCellEditor(parent);
	                return editor;
	            }
                if(data.getName().equals("visible")) {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("Layer_Name"))
        {
            if ( ! value.toString().equals(((Layer_c) element).getLayer_name()) )
            {
                ((Layer_c) element).setLayer_name(value.toString());
            }
        }
        if(data.getName().equals("visible"))
        {
            boolean new_val = ((Boolean)value).booleanValue();
            if ( new_val != ((Layer_c) element).getVisible() )
            {
                ((Layer_c) element).setVisible(new_val);
            }
        }
