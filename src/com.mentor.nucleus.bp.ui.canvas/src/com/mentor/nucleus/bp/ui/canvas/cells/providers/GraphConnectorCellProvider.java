//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/GraphConnectorCellProvider.java
//
...
public class GraphConnectorCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("positionX"))
        {
            ...
            if ( new_val != ((Graphconnector_c) element).getPositionx() )
            {
                ((Graphconnector_c) element).setPositionx(new_val);
            }        
        }
        if(data.getName().equals("positionY"))
        {
            float new_val = Float.parseFloat(value.toString());
            if ( new_val != ((Graphconnector_c) element).getPositiony() )
            {
                ((Graphconnector_c) element).setPositiony(new_val);
            }        
        }
