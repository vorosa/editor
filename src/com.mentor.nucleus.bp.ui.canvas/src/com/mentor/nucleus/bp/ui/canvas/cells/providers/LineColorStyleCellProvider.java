//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/LineColorStyleCellProvider.java
//
...
public class LineColorStyleCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("red"))
        {
            ...
            if ( new_val != ((Linecolorstyle_c) element).getRed() )
            {
                ((Linecolorstyle_c) element).setRed(new_val);
            }
        }
        if(data.getName().equals("green"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Linecolorstyle_c) element).getGreen() )
            {
                ((Linecolorstyle_c) element).setGreen(new_val);
            }
        }
        if(data.getName().equals("blue"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Linecolorstyle_c) element).getBlue() )
            {
                ((Linecolorstyle_c) element).setBlue(new_val);
            }
        }
