//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/GraphElementCellProvider.java
//
...
public class GraphElementCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("positionX"))
        {
            ...
            if ( new_val != ((Graphelement_c) element).getPositionx() )
            {
                ((Graphelement_c) element).setPositionx(new_val);
            }        
        }
        if(data.getName().equals("positionY"))
        {
            float new_val = Float.parseFloat(value.toString());
            if ( new_val != ((Graphelement_c) element).getPositiony() )
            {
                ((Graphelement_c) element).setPositiony(new_val);
            }        
        }
