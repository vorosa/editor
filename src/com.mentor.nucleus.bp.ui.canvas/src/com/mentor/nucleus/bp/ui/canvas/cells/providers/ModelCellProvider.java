//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/ModelCellProvider.java
//
...
public class ModelCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("represents"))
        {
        }
        if(data.getName().equals("version"))
        {
            if ( ! value.toString().equals(((Model_c) element).getVersion()) )
            {
                ((Model_c) element).setVersion(value.toString());
            }
        }
