//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/FillColorStyleCellProvider.java
//
...
public class FillColorStyleCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("red"))
        {
            ...
            if ( new_val != ((Fillcolorstyle_c) element).getRed() )
            {
                ((Fillcolorstyle_c) element).setRed(new_val);
            }
        }
        if(data.getName().equals("green"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Fillcolorstyle_c) element).getGreen() )
            {
                ((Fillcolorstyle_c) element).setGreen(new_val);
            }
        }
        if(data.getName().equals("blue"))
        {
            int new_val = Integer.parseInt(value.toString());
            if ( new_val != ((Fillcolorstyle_c) element).getBlue() )
            {
                ((Fillcolorstyle_c) element).setBlue(new_val);
            }
        }
