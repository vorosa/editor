//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/GraphNodeCellProvider.java
//
...
public class GraphNodeCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("width"))
        {
            ...
            if ( new_val != ((Graphnode_c) element).getWidth() )
            {
                ((Graphnode_c) element).setWidth(new_val);
            }        
        }
        if(data.getName().equals("height"))
        {
            float new_val = Float.parseFloat(value.toString());
            if ( new_val != ((Graphnode_c) element).getHeight() )
            {
                ((Graphnode_c) element).setHeight(new_val);
            }        
        }
