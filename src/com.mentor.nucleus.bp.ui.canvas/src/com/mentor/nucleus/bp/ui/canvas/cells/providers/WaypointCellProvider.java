//========================================================================
//
// File: src/com/mentor/nucleus/bp/ui/canvas/cells/WaypointCellProvider.java
//
...
public class WaypointCellProvider implements ICellProvider {
	...
	public void setValue(NonRootModelElement element, ObjectElement data, Object value) {
        if(data.getName().equals("positionX"))
        {
            ...
            if ( new_val != ((Waypoint_c) element).getPositionx() )
            {
                ((Waypoint_c) element).setPositionx(new_val);
            }        
        }
        if(data.getName().equals("positionY"))
        {
            float new_val = Float.parseFloat(value.toString());
            if ( new_val != ((Waypoint_c) element).getPositiony() )
            {
                ((Waypoint_c) element).setPositiony(new_val);
            }        
        }
